                    ...
                    <table  cellpadding="5" cellspacing="1" class="common">
                      ...
                      <tr>
                        ...
                        <td class="input">
                          ...
                          <input class="input" s name="prpLpropCurrencyName" value="人民币" class="codecode"
                        ...
                        <td class="input">
                          ...
                          <input type="hidden" name="feeTypeCode" class="codecode" 
                              ondblclick= "code_CodeSelect(this,'ChargeCode');"
                              onkeyup= "code_CodeSelect(this,'ChargeCode');">   
                          <input type="hidden" name="prpLpropFeeTypeName" class="codename" 
                      ...
                      <tr>
                        ...
                        <td class="input">
                          <input class="input" s name="prpLpropUnitPrice" onblur="calPropLoss();">
                        </td>
                        <td class="title">受损数量：</td>   
                        <td class="input">
                          <input class="input" s name="prpLpropLossQuantity" onblur="calPropLoss();">
                        </td>
                      </tr>   
                      ...
                      <tr>
                        ...
                        <td class="input"><input class="input" s name="prpLpropSumReject" onblur="calPropLoss();"></td>
                      </tr>  
                      
                      <tr>
                        <td class="title">损失率：</td>
                        <td class="input">
                          <input class="input" s name="prpLpropLossRate" onblur="calPropLoss();">%
                        </td>
                  ...
                  <td class="subformtitle"  >
                    <table  cellpadding="0" cellspacing="1" class="common">
                      ...
                      <tr>
                        ...
                        <td class="input">
                          <input type="input" style='width:30px' name="prpLpropCurrency"  value="<bean:write name='prpLpropDto1' property='currency'/>"  class="codecode"
                            ondblclick= "code_CodeSelect(this,'Currency');"
                            onkeyup= "code_CodeSelect(this,'Currency');">      
                          <input type="input" s name="prpLpropCurrencyName"  value="<bean:write name='prpLpropDto1' property='currencyName'/>" class="codename"
          			             ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');"
          			             onkeyup= "code_CodeSelect(this, 'Currency','-1','always','none','post');">  
                          </td> 
                        <td class="title">&nbsp;</td>   
                        <td class="input">                       
                          <input type="hidden" name="feeTypeCode" class="codecode"   value="<bean:write name='prpLpropDto1' property='feeTypeCode'/>"
                              ondblclick= "code_CodeSelect(this,'ChargeCode');"
                              onkeyup= "code_CodeSelect(this,'ChargeCode');">   
                          <input type="hidden" name="prpLpropFeeTypeName" class="codename"   value="<bean:write name='prpLpropDto1' property='feeTypeName'/>"
                                 ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');"
                                 onkeyup= "code_CodeSelect(this, 'ChargeCode','-1','always','none','post');">  
                      ...
                      <tr>
                        <td class="title">单价：</td>
                        <td class="input">
                          <input class="input" s name="prpLpropUnitPrice" value="<bean:write name='prpLpropDto1' property='unitPrice'/>" onblur="calPropLoss();">
                        </td>
                        <td class="title">受损数量：</td>   
                        <td class="input">
                          <input class="input" s name="prpLpropLossQuantity" value="<bean:write name='prpLpropDto1' property='lossQuantity'/>" onblur="calPropLoss();">
                        </td>
                      </tr>   
                      <tr>
                        <td class="title">折旧率：</td>
                      ...
                      <tr>
                        ...
                        <td class="title">剔除金额：</td>   
                        <td class="input"><input class="input" s name="prpLpropSumReject" value="<bean:write name='prpLpropDto1' property='sumReject'/>" onblur="calPropLoss();"></td>
                      </tr>  
                      
                      <tr>
                        <td class="title">损失率：</td>
                        <td class="input">
                          <input class="input" s name="prpLpropLossRate" value="<bean:write name='prpLpropDto1' property='lossRate'/>" onblur="calPropLoss();">%
                        </td>
                        <td class="title">核定标的损失：</td>   
