     ...
     <td width="30%">  
       <table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tr> 
          ...
          <td><input type="button" name="prpLmessageSave" value="撰写留言" class="bigbutton" onclick="openWinSave1();return false;"></td>
     <td><input type="button" name="prpLmessageView" value="查看留言" class="bigbutton" onClick="openWinQuery();return false;"></td>
...
<table  border="0" align="center" cellpadding="4" cellspacing="1"  class="title" width="100%">
  ...
  <tr> 
    ...
    <td class="input"  ><input type="text" name="prpLclaimClaimNo" title="立案号" class="readonly" style="width:160px" readonly="true" value="<bean:write name='prpLclaimDto' property='claimNo' filter='true'/>"> 
    </td>
  ...
  <tr> 
    ...
    <td class="input"> 
      <input type="text" name="prpLclaimPolicyNo" class="readonly" readonly="true"  value="<bean:write name='prpLclaimDto' property='policyNo' filter='true' />">
  ...
  <tr> 
    <td class="title"> 估损金额：<input type="text" name="prpLclaimCurrency"  class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='currency' filter='true' />"></td>
    <td class="title">
    ...
    <td class="title">赔付金额：<input type="text" name="prpLclaimCurrency"  class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='currency' filter='true' />"></td>
