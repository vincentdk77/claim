...
<table  border="0" align="center" cellpadding="4" cellspacing="1"  class="title" width="100%">
  ...
  <tr> 
    ...
    <td class="input"> 
      <input name="prpLprepayCurrency" class="codecode"  value="<bean:write name='prpLprepayDto' property='currency' filter='true' />"
          ondblclick="code_CodeSelect(this, 'Currency');"
          onkeyup= "code_CodeSelect(this, 'Currency');"> 
      <input name="prpLprepayCurrencyName" class="codename"  value="<bean:write name='prpLprepayDto' property='currencyName' filter='true' />"
