...
if (intstartHour==0){
 ...
 //取核心系统的地址
 String strCoreWebUrl = (String)AppConfig.get("sysconst.Core_URL");
%>
<!--modify by liuyanmei add 20051114 end-->
	...
	<tr>
	   ...
	   <td>
	       <input type="button" name="message" value="理赔沟通" class="bigbutton" onclick="return openWinSaveQuery('<bean:write name='prpLclaimDto' property='registNo' filter='true' />',fm.prpLclaimPolicyNo.value,'<bean:write name='prpLclaimDto' property='riskCode' />','claim','<bean:write name='prpLclaimDto' property='claimNo' />','registNo','<bean:write name='prpLclaimDto' property='registNo' filter='true' />');">
	   </td>
	   <td>
    ...
    <table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" style="width:100%">
      <tr>
        <td class="title" colspan="2">立案登记
          ...
          <!-- modify by wuxiaodong 050905 begain reasion 格式不正确导致JS取不到数，从而结果错误 -->
          <!--
          ...
          <input type="hidden" name="prpLclaimReportDate1"   value="<bean:write name='registDate' filter='true' />">
...
<!--         <td class="title">语种:</td>
        <td class="input">
          ...
          <input type="text"   name="prpLclaimLanguageName"  class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='languageName' />">   
        </td> 
 -->      </tr>
      ...
      <tr>
       ...
       <logic:equal name='prpLclaimDto' property="customerType" value="1">
        ...
        <td class="input" >       
          <input type=text name="prpLextSalvor" title="货主名称" style="width:200px" class="input" value="<bean:write name='prpLextDto' property='salvor' filter='true' />">
        </td>
        ...
        <td class="title"><bean:message key="db.prpLclaim.insuredName" />:</td>
        <td class="input">
          <input type=hidden class="readonly"  name="prpLclaimInsuredCode" title="被保险人代码" value="<bean:write name='prpLclaimDto' property='insuredCode' filter='true' />">
          <input type=text name="prpLclaimInsuredName" title="被保险人" class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='insuredName' filter='true' />">
        </td> 
        -->  
     ...
     <tr>
        ...
        <td class="input" >       
          ...
          <input type="hidden" name="prpLclaimEndDate"   title="终保日期" class="readonly" style="width:80px" readonly="true"   value="<bean:write name='prpLclaimDto' property='endDate' filter='true' />">
        </td>
        <td class="title">卸货日期</td>
        <td class="input" >       
          <input type=text name="prpLextUnloadDate" title="卸货日期" style="width:80px"  class="readonly" readonly="true" value="<bean:write name='prpLextDto' property='unloadDate' filter='true' />">
 ...
 <%--     
      <tr> 
        ...
        <td class="input" ><bean:write name='prpCmainCargoDto' property='BLNo'/></td>  
        <td class="title" >车次/航次/航班号/车号/船名:</td>
        <td class="input" ><bean:write name='prpCmainCargoDto' property='voyageNo'/></td>
      </tr> 
--%>         
      <tr>
        <td class="title">出险时间:</td>
        <td class="input">
          <input type=text name="prpLclaimDamageStartDate" title="出险时间" class="input"  maxlength="10" style="width:80px" onchange="isValidateDateField(this,schemaColumn)" value="<bean:write name='prpLclaimDto' property='damageStartDate' filter='true' />"> <img src="/claim/images/bgMarkMustInput.jpg">
          <%--
        ...
        <td class="title"><bean:message key="db.prpLclaim.damageName" />:
        ...
        <td class="input">
            <input type=hidden class="codecode" name="prpLclaimDamageCode"  style="width:15%" title="出险原因" value="<bean:write name='prpLclaimDto' property='damageCode' filter='true' />"
           ...
           <input type=text class="codecode" name="prpLclaimDamageName"  title="出险原因" style="width:120px" value="<bean:write name='prpLclaimDto' property='damageName' filter='true' />"
      ...
      <tr>
        ...
        <td class="input" colspan='3'>
          <input  name="prpLclaimDamageAddress" title="出险地点"  class="class"  readonly="true"  value="<bean:write name='prpLclaimDto' property='damageAddress' filter='true' />"> <img src="/claim/images/bgMarkMustInput.jpg">
        </td>
      </tr>
