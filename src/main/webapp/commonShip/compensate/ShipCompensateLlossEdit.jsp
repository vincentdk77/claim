    ...
    <tr>
      <td class="subformtitle" colspan="4" style="text-align:left">
                 ...
                 <div align="center">
                   <input class="readonlyNo" readonly name="prpLlossDtoSerialNo" description="序号">
                    ...
                    <input type="hidden" name="prpLlossDtoIndemnityDutyRate">
		             ...
		             <td class="input" style="width:4%">
		                <input type='text' name='prpLlossDtoItemKindNo' class="readonly" readonly="readonly">    
		             </td>
                        ...
                        <td class="input" style="width:8%">
                          <input name="prpLlossDtoSumLoss" class="common"  onblur="calRealpay(this);calLoss();">
                        </td>

                        <td class="input" style="width:8%">
                          <input name="prpLlossDtoSumRest" class="common" value="0.00" onblur="calRealpay(this);calLoss();">
                        </td>

                        <td class="input" style="width:7%">
                          <input name="prpLlossDtoClaimRate"  class="common" value="100" onblur="calRealpay(this);calLoss();">
                        </td>

                        <td class="input" style="width:8%">
                          <input name="prpLlossDtoDeductible" class="common" value="0.00" onblur="calRealpay(this);calLoss();">
                        </td>

                        <td class="input" style="width:7%">
                          <input name="prpLlossDtoDeductibleRate" class="common" value="0" onblur="calRealpay(this);calLoss();">
                        </td>
        ...
        <table id="lLoss" class="common" align="center" cellspacing="1" cellpadding="3">
          ...
          <tfoot>
            <tr>
              <td class="title" colspan=12 style="width:96%">(按"+"号键增加险别信息，按"-"号键删除信息)</td>
                 ...
                 <div align="center">
                   ...
                   <!--是否超过保单中的限额标志域-->
                    ...
                    <input type="hidden" name="prpLlossDtoIndemnityDutyRate" value="<bean:write name='lloss' property='indemnityDutyRate'/>"> 
                        ...
                        <td class="input" style="width:12%">
                           <input type="hidden" name="prpLlossDtoItemCode" class="codecode" style="width:30%"   value="<bean:write name='lloss' property='itemCode'/>"
                            ondblclick="code_CodeSelect(this, 'PolicyItemKindCode','1,2,3,4,5');"
                            onblur="checkRepeatItemCode(this);"
                            onkeyup= "code_CodeSelect(this, 'PolicyItemKindCode','1,2,3,4,5');"> 
                          <input name="prpLlossDtoLossName" class="codename"  style="width:98%"  value="<bean:write name='lloss' property='lossName'/>"
                        ...
                        <td class="input" style="width:8%">
                          <input name="prpLlossDtoSumRealPay" class="common" value="<bean:write name='lloss' property='sumRealPay' format='##0.00'/>"  onblur="calRealpay(this);calLoss();" onchange="setFlagDanger();">
                        </td>
                        <td class="input" style='width:4%'>
                          <div align="center">
