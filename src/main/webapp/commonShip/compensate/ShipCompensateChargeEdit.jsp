            ...
            <tbody>
              <tr>
                ...
                <td class="input" style="width:15%" align="center"> 
                  <input name="prpLchargeChargeAmount" class="input" style="width:100%" onchange="calFund()";>
                </td>
                <td class="input" style="width:15%" align="center">
                  <input name="prpLchargeSumRealPay" class="input" style="width:100%" onchange="calFund()";>
                </td>
                <td class="input" align="center"  style="width:4%"  onchange="setFlagDanger();">
                <div>
          ...
          <thead>
            <tr>
              <!-- 
                ...
                <td class="centertitle"  style="width:12%">代查勘机构</td>
