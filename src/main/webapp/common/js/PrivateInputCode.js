    ...
    function setMultiFieldValue(){
    	var idx = 0;
    	for(var j = 0;j<fm.codeselect.options.length;j++){
    		if(fm.codeselect.options[j].selected){
    		 parent.fraInterface.insertRow('Ear');
    	        ...
    	        try
    	        {
    	            codevalue = fm.codeselect.options[j].value;
    	        ...
    	        {
    	            parent.fraRight.rows = "100%,0%,0%";
    	            var index = parseInt(fm.codeindex.value)+fm.rowlength.value*idx;
    	            var tempIndex = 0;
    	            var arrCodeValue;
