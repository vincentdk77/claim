...
<form name="fm" action="/claim/EndCaseSumQuery.do?"  method="post" onsubmit="return validateForm(this);">
    ...
    <tr><td colspan=4 class="formtitle">已决赔案查询</td></tr>
      <tr>
     ...
     <tr>
      ...
      <td class=input>
        <select class=tag  name="CaseStartDateSign">
          ...
          <option value=">=" SELECTED>&gt;=</option>
          <option value="<="  >&lt;=</option>
        </select> <input name="CaseStartDate" class="Wdate" onfocus="WdatePicker()" maxlength="21"> <!-- <img align="absmiddle" style='cursor: hand' src="/claim/images/bgcalendar.gif" onclick="TogglePopupCalendarWindow('document.fm.CaseStartDate', '2007', '2017')"> --></td>
      <td class=title>结案截至日期：</td>
      <td class=input>
        <select class=tag   name="CaseEndDateSign">
          ...
          <option value=">=">&gt;=</option>
          <option value="<="  SELECTED>&lt;=</option>
        </select> <input name="CaseEndDate" class="Wdate" onfocus="WdatePicker()" maxlength="21" > <!-- <img align="absmiddle" style='cursor: hand' src="/claim/images/bgcalendar.gif" onclick="TogglePopupCalendarWindow('document.fm.CaseEndDate', '2007', '2017')"> --></td>
    </tr>
