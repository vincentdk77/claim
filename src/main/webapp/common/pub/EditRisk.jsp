...
<script language="javascript">
  function submitForm()
  {
    opener.EditPolicy(fm.type.value,fm.classcode.value,fm.riskcode.value,fm.noticeno.value);
    window.close();
  }
</script>
</head>
...
<table width="510" border="0" cellpadding="0" cellspacing="0" align="center"> 
    <tr> 
       <td width="172" height="24" align="center" background="/claim/images/bgBarBig.gif" class="button"><font color="#FFFFFF" style='font-family宋体;font-size:12px'><b>修 改 保 单</b></font></td>
