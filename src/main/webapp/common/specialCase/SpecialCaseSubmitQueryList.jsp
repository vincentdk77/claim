...
<body  >
	...
	<tr><td colspan=4 class="formtitle"><bean:message key="title.registBeforeEdit.titleName" /></td></tr>
	   <tr>
	      <td class="centertitle" >已提交<bean:message key="db.prpLregist.registNo"/></td>
...
%>
<tr class=common>
	      <td > <a href="/claim/registSubmitQueryList.do?prpLregistRegistNo=<bean:write name='prpLregist1' property='registNo'/>&editType=<bean:write name='prpLregistDto' property='editType'/>"> <bean:write name="prpLregist1" property="registNo"/></a></td>
