...
<head>
  ...
  <script language="javascript">
	...
	array[8] = new Array("cancel","registCancel","报案注销");
	array[9] = new Array("cancel","claimCancel","立案注销申请");
	array[17] = new Array("cancel","claimApprov","立案注销审批");
...
<form name="fm" action="/claim/medicalReupload.do"  method="post">
    ...
    <table  border="0" align="center" cellpadding="5" cellspacing="1"  class="common">
      ...
      <tr>
        ...
        <td class="input" >
        	<input type=text name="interId" class="query" >
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="input" rowspan="2">
        	<input type=text name="outId" class="query" >
        </td>
        <td class="title" >补传节点类型：</td>
        <td colspan="3" class="input" >
        <select name="nodeType" style="width:60%" onchange="buildNodeSelect(fm.nodeType, fm.reuploadNode);">
        	<option value ="">请选择</option>
        	<option value ="claim">自动理赔</option>
        	<option value ="cancel">注销</option>
        	<option value ="recase">重开赔案</option>
        	<option value ="pay">三方支付</option>
        	<option value ="payDelete">三方支付删除</option>
        </select>
        </td>
      </tr>
