		...
		if(returnValue!=undefined && typeof(returnValue)!='string'  &&  returnValue[0] == "true"){
			...
			for(var ls = 0;ls<loopSize ;ls++){
				...
				if(addFlag){
					...
					//"</td> "+
					//"<td  class='input'  align='center'> "+
					"   <a href='#' onclick=\"logstore('"+returnValue[ls*14+2]+"','apay')\">"+returnValue[ls*15+2]+"</a> "+
	...
	<table class="common" id="mainInfo" cellpadding="0" cellspacing="0" border="1" bordercolor="#3A81C8">
		...
		<tr>
			...
			<td class="input"  align="center">
				...
				<input type="hidden" name="fkSerialNo" value="${prpLpayShowDto.fkSerialNo }">
			<!-- </td>
			<td  class="input"  align="center"> -->
			...
			<td  class="input"  align="center">
				<input type="hidden" name="paidMaxValue"  value="<fmt:formatNumber type='number' value='${prpLpayShowDto.billPaid-prpLpayShowDto.billHavPay }' pattern='#.00' maxFractionDigits='2'/>" />
				...
				<input type="text" style="width: 99%;text-align:right;"  readOnly class="readOnly" name="paidPay"  value="<fmt:formatNumber type='number' value='${prpLpayShowDto.billPaid-prpLpayShowDto.billHavPay }' pattern='#0.00' maxFractionDigits='2'/>" onblur="clearNoNumF(this);checkMaxVal(this);mergeFee(this);"/>
				</c:if>
		...
		<tr id="addBtnTR">		
			...
			<td class="input">
				<input type="text" style="width: 99%;text-align: right;" readOnly class="readonly" name="payAmount" <c:if test="${editType eq 'ADD' }">value=""</c:if><c:if test="${editType ne 'ADD' }">value="${nowPay}"</c:if> />
			</td>
			<td class="input" align="center">
				<div id="showDivMany">
