...
<script type="text/javascript">
 ...
 function accountData(receiverTypeOther){
	...
	//debugger;
	    ...
	    var strURL ="/claim/getPayeeInfo.do?receiverFullName="+receiverFullName+"&"+curTime;
		...
		if(returnValue!=undefined && typeof(returnValue)!='string'  &&  returnValue[0] == "true"){
			...
			$("input[name='bank']").val(returnValue[6]);
...
<!--  
			...
			<td class="input">
				...
				<input type="hidden" id="receiverFullNameCheck" name="receiverFullNameCheck" value="${prpLpayGatherDto.receiverFullName}" maxlength="100" onblur="return checkMaxlength(this);"/>
		...
		<tr>
			...
			<td class="input" width="20%" colspan="2">
				...
				<input type="hidden"id="certifNoCheck" name="certifNoCheck" value="${prpLpayGatherDto.certifNo}" maxlength="20" onblur="return checkMaxlength(this);"/>
			</td>
