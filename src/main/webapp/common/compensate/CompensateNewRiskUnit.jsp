  ...
  <table class="common" id="NewDangerUnitTable" style="display: none">
      <tr>
        <td class="subformtitle" style="text-align:left;" colspan="11" >
           <input type=button class="bigbutton" style="cursor: hand" name="creatDangerUnit" value="生成危险单位" onclick="CompensatechangFlagDanger();" <%=disabledFlag %>>
            ...
            <tr>
              <td> 
                 ...
                 <input type="hidden"  name="prpLdangerRiskCode" /> 
			      ...
			      <td align="center">
			          <input  class="readonly" type="text" name="prpLdangerCurrency" title="币别"  readonly="readonly" style="text-align: left;width: 30%" >
        ...
        <table id="NewDangerUnit" class="common" >
          <thead>
             <tr>
	          ...
	          <td class="centertitle" style="width: 10%">实赔金额</td>
