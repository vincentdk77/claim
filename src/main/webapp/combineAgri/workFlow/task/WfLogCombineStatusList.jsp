...
<%
  ...
  if (funcName.equals("specialApply")) funcDesc="(特殊赔案申请)";
  }
  ...
  int colNumber=6;         //基本的列数 基本显示是6列 增加并案号列
      ...
      <tr>
        <td class='title'>
           ...
           //-------------------------------------------------
              ...
              // added by 李杨 gyic 加入并案处理中对事故号（并案号）的查询 start! 20110803
              ...
              // added by 李杨 gyic 加入并案处理中对事故号（并案号）的查询 end!  20110803
...
<%        }%>
         <td class="centertitle" style="width:16%">并案号码</td>
...
%>
    <logic:notEqual name="com.sinosoft.type" value="acci">
     ...
     <logic:iterate id="claimCombineDtoList1"  name="claimCombineDto"  property="claimCombineDtoList">     
     	...
     	<%// 在这里swfLogList1是一个swfLogDto,这个是个命名上的错误 GYIC 李杨 20110803 %>
<%
     if(index %2== 0)
...
<%
      ...
      //reason:加入传进保单号码的过程
// 把事故号也加入到link中。 GYIC 李杨 20110803
