 ...
 //在下面加入本页自定义的JavaScript方法
      ...
      */
      ...
      function earnoCheck()
      {
	    ...
	    var bool  = true;
	    var nodetypelist = "check-certa";
	    if(nodetypelist.indexOf(nodeType) > -1){
	       bool = checkEarNoAndModify();}
	    if(nodeType=="regis"){
	      fm.prpLregistLossesNumber.value = count-1;
	    }   
	    if( bool != true)
	    return false;
	    alert( "耳标号检查通过");
...
function checkEarNoAndModify()
{
	var countEar = getElementCount("prplCompensateEarEarNo");
 	 var killQuantity = document.getElementsByName("prpLverifyLossKillQuantity")[0].value;
	 var deathQuantity = document.getElementsByName("prpLverifyLossDeathQuantity")[0].value;
     var lossNumber = document.getElementsByName("prpLverifyLossLossesNumber")[0].value;
	 document.getElementsByName("prpLverifyLossLossesNumber")[0].value = countEar -1;
	...
	var newArray=new Array();  
	 ...
	 //end
	var damageInsured = document.getElementsByName("prpLverifyLossDamageInsured")[0].value;
	document.getElementsByName("prpLverifyLossDamageInsured")[0].value = newArray.length;
	
	var countProp = getElementCount("prpLpropFamilyCode");
	if(countProp > 2){ 
	alert( "核定损清单不能有多条记录");
	return false;
	}	
	if(countEar >1){
		...
		else
		{
			...
			if(sum.toFixed(2) != parseFloat(document.getElementsByName("prpLpropSumLoss")[1].value)){
            ...
            <tbody>
              ...
              <td class="input" style="width:17%">              
                 ...
                 <td class="input" style="width:18%">          
                  ...
                  <td class="input" style="width:18%">
                  <input name="prplCompensateEarAccount" class=readonly readonly style='width:180px'  maxlength=24 >
                </td>
