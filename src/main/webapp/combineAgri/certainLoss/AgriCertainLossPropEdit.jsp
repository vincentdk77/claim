...
%>
    <input type="hidden" name= "prpLclaimPolicyNo_<%=idxProp%>"  value="<%=request.getParameter("policyNo")%>">
          ...
          <table class="common" style="display:none" id="Prop_<%=idxProp%>_Data" cellpadding="5" cellspacing="1">
            <tbody>
              <tr>
                ...
                <td class="input"> 
                    <input type="hidden"  name="temp1_<%=idxProp%>" description="存储多余的数值">  
                    <input type="hidden"  name="prpLpropSerialNo_<%=idxProp%>" description="序号">   
                    <input type="hidden" name="prpLpropKindCode_<%=idxProp%>" class="codecode" style='width:40px'>         
                    <input type="input" name="prpLpropKindName_<%=idxProp%>" class="codename" style='width:80px'
  			             ondblclick="code_CodeSelect(this, 'KindCodeVirturlItem','-1,1,-3,2,3','name','none','post','<%=idxProp%>');"
  			             onchange="code_CodeChange(this, 'KindCodeVirturlItem','-1,1,-3,2,3','name','none','post','<%=idxProp%>');"
  			             onkeyup= "code_CodeSelect(this, 'KindCodeVirturlItem','-1,1,-3,2,3','name','none','post','<%=idxProp%>');">         
  			        <input type="hidden" name="prpLpropItemKindNo_<%=idxProp%>">
                </td>
                <td class="input">
                  <input type="hidden" name="prpLpropItemCode_<%=idxProp%>">                
                  <input name="prpLpropLossItemName_<%=idxProp%>" class=common style='width:80px'  maxlength=40>
                </td>
              
                <td class="input">                
                  <input name="prpLpropSumLoss_<%=idxProp%>" class=common style='width:80px'  maxlength=40 onBlur="getSumPropDefLoss(this);initSet();">
                </td>
                <td class="input">                
                  <input name="prpLpropSumReject_<%=idxProp%>" class=common style='width:80px'  maxlength=40 onBlur="getSumPropDefLoss(this);initSet();">
                </td>
                <td class="input">                
                  <input name="prpLpropSumDefLoss_<%=idxProp%>" class=readonly readonly style='width:80px'  maxlength=40 onBlur="initSet();">
                </td>
                <td class="input">                
                  <input name="prpLpropRemark_<%=idxProp%>" class=common style='width:80px'  maxlength=40>
                </td>                
                ...
                <div>
                  ...
                  <input type="hidden" name="prpLpropLossItemCode_<%=idxProp%>">
...
<%
      ...
      flag = (String)request.getAttribute("flag_"+ idxProp);//flag=1说明是退回的
...
%>
              <tr>
                ...
                <td class="input" style="width:16%">
                  ...
                  <input type="input" class="codename" name="prpLpropFamilyName_<%=idxProp%>" title="事故者姓名" 
                ...
                <td class="input" style="width:12%">  
                    <input type="hidden"  name="temp2_<%=idxProp%>" description="存储多余的数值">   
                    <input type="hidden"  name="prpLpropSerialNo_<%=idxProp%>" description="序号"  value="<bean:write name='prpLpropDto1' property='serialNo'/>">   
                    <input type="hidden" name="prpLpropKindCode_<%=idxProp%>" class="codecode" style='width:40px<%=compensatebackStyleO%>' <%=compensatebackReadOnlyO%> value="<bean:write name='prpLpropDto1' property='kindCode'/>">     
                ...
                <td class="input" style="width:12%">                
                  <input name="prpLpropSumDefLoss_<%=idxProp%>" class=readonly readonly style='width:80px<%=compensatebackStyleO%>' <%=compensatebackReadOnlyO%> maxlength=40   value="<bean:write name='prpLpropDto1' property='sumDefLoss'/>" onBlur="initSet();">
                </td>
                <td class="input" style="width:12%">                   
                  <input name="prpLpropRemark_<%=idxProp%>" class=common style='width:80px<%=compensatebackStyleO%>'  maxlength=40  <%=compensatebackReadOnlyO%> value="<bean:write name='prpLpropDto1' property='remark'/>">
                </td>                
                <td class="input" style='width:4%'  align="center">
                <div>
                  <input type=button name="buttonPropDelete_<%=idxProp%>"  class=smallbutton onclick="combineDeleteRow(this,'Prop_<%=idxProp%>')"  <%=compensatebackDiasableO%> value="-" style="cursor: hand">
                </div>
                    
                  <input type="hidden" name="prpLpropLossItemCode_<%=idxProp%>"     value="<bean:write name='prpLpropDto1' property='lossItemCode'/>">  
...
%>  
              ...
              <tr>
                ...
                <td class="input">                
                  <input name="prpLpropVeriSumLoss_<%=idxProp%>" class="readonly" readonly style='width:80px'  maxlength=40 value="<bean:write name='prpLpropDto1' property='veriSumLoss'/>">
                </td>
                <td class="input">                
                  <input name="prpLpropVeriSumReject_<%=idxProp%>" class="readonly" readonly style='width:80px'  maxlength=40 value="<bean:write name='prpLpropDto1' property='veriSumReject'/>">
                </td>
                <td class="input">                
                  <input name="prpLpropVeriSumDefLoss_<%=idxProp%>" class="readonly" readonly style='width:80px'  maxlength=40 value="<bean:write name='prpLpropDto1' property='veriSumDefLoss'/>">
                </td>
                <td class="input">                   
                  <input name="prpLpropVeriRemark_<%=idxProp%>" class="readonly" readonly style='width:80px'  maxlength=40 value="<bean:write name='prpLpropDto1' property='veriRemark'/>">
                </td>                
