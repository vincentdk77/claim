...
function initMulLineFields(mulLineTableIdList){
  ...
  for(var indexOfRegist=0;indexOfRegist<countRegist;indexOfRegist++){
	    ...
	    for(var i=0;i<tableIdArray.length;i++)
	    {
	        ...
	        var tableId = "";
	        if(tableIdArray[i].indexOf("_")>-1)
	        	tableId = tableIdArray[i].substring(0,tableIdArray[i].indexOf("_"))+"_"+indexOfRegist+"_"+tableIdArray[i].substring(tableIdArray[i].indexOf("_")+1);
	        else tableId = tableIdArray[i]+"_"+indexOfRegist;
	        elements=getTableElements(tableId);
...
//            }
            ...
            schemaColumn = getSchemaColumn(fieldNameWithoutNumber);
...
function keypressHandler(evt)
{
    ...
    var schemaColumn = getSchemaColumn(fieldNameWithoutNumber);
    if(schemaColumn==null){
    ...
    try{
        var obj;
        obj = eval("this.onkeypress.prototype." + fieldNameWithoutNumber );
        if(obj != null)
        {
