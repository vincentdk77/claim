...
function changFlagDanger(){
  ...
  if("27,01,03,04,08,15,22,26,ZH".indexOf(fm.prpLclaimClassCode.value)>-1){
    if(checkExes()==true){
  	 fm.flagDangerUnit.value="1";
   }
  }
  if("3155,3196".indexOf(fm.prpLclaimRiskCode.value)>-1 ){
  	 fm.flagDangerUnit.value="1";
  }
...
function setFlagDanger(index){
   var eleFlagDangerUnit = document.getElementsByName("flagDangerUnit_"+index);
   eleFlagDangerUnit[0].value="0";
