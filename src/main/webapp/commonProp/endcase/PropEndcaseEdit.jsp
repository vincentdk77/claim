...
<head>
  ...
  <script src="/claim/commonProp/endcase/js/PropEndcaseEdit.js"></script>
</head>
...
%>
    ...
    <input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="<%= session.getAttribute("org.apache.struts.action.TOKEN") %>">
      ...
      <%-- 1.结案主信息 --%>
      <%@include file="/commonProp/endcase/PropEndcaseMainEdit.jsp" %>
      <%-- 4.结案文本信息 --%>
      <%@include file="/commonProp/endcase/PropEndcaseTextEdit.jsp"%>
      <%-- 保存通用按钮 --%>
      <%@include file="/commonProp/endcase/PropEndcaseSave.jsp"%>
      <%-- 案件互查返回按鈕--%>
