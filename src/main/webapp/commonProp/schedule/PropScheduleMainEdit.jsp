...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="common" >
  ...
  <table class=common cellpadding="5" cellspacing="1">
      ...
      <tr>  
        ...
        <td class="input" >
          <input class="readonly" readonly name="prpLregistEstimateLoss"  value="<bean:write name='prpLscheduleMainWFDto' property='estimateLoss' filter='true' format='0.00' />" >
        </td>
      
        <td class="title" style="display:none">报损费用CNY:</td>
        <td class="input" style="display:none" >
          <input class="readonly" readonly name="prpLcheckloss" value="<bean:write name='prpLscheduleMainWFDto' property='estimateFee' filter='true' format='0.00'  />" >
        </td>  
