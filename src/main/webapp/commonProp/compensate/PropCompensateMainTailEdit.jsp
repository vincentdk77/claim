...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  <tr> 
    <td class="title"  style="width:15%">赔款币种:</td>
    <td class="input"  style="width:35%"> 
      ...
      <td class="title"  style="width:50%" colspan="2"><input type="hidden" class="bigbutton" name="btnCurrencyTotle" value="分币别汇总" onclick="alert('分币别汇总');"></td>
  </tr>
  <tr> 
    <td class="title"  style="width:15%"> 赔款金额:</td>
    ...
    <td class="title"  style="width:15%"> 其它费用:</td>
  ...
  <tr> 
    ...
    <td class="title" style="display:none"> 残值:</td>
  ...
  <tr> 
    ...
    <td class="input"  >  
      <input name="prpLcompensateHandlerCode" class="readonly" readonly=true style="width:40%" value="<bean:write name='prpLcompensateDto' property='handlerCode' filter='true' />"
          ...
          onkeyup= "code_CodeSelect(this, 'HanderCode');"> <input name="prpLcompensateHandlerName" class="readonly" readonly=true style="width:50%"  title="经办人" value="<bean:write name='prpLcompensateDto' property='handlerName' filter='true' />"
