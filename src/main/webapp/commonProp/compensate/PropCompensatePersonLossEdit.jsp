          ...
          <tbody>  
            <tr>                
              <td class="inputsubsub">
                ...
                <input type="input" name="prpLpersonLossKindCode" class="codecode" style="width:30px"
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
                <input type="input" name="prpLpersonLossKindName" class="codename" style="width:80px"
              ...
              <td class="inputsubsub">
                ...
                <input class="input" style='width:60px' name="prpLpersonLossCurrencyName" class="codename"
...
%>                    
          <tr>   
              ...
              <td class="inputsubsub">
                  ...
                  <input type="input" name="prpLpersonLossKindCode" class="codecode" style="width:30px"  value="<%= PrpLpersonLossDto1.getKindCode() %>"
                        ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                        onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
                  <input type="input" name="prpLpersonLossKindName" class="codename" style="width:80px" value="<%= PrpLpersonLossDto1.getKindName() %>"
  			             ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
  			             onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">             
              </td>
