    ...
    <tr>
      ...
      <input type="hidden" name="preClaimNo" value="<bean:write name='prpLcompensateDto' property='claimNo' filter='true' />">
            ...
            <tbody>
              <tr>
        		<td class="input" align="center" style="width:10%">
                  ...
                  <input type="input" name="prpLchargeKindCode" class="codecode" style="width:60px"
                 ...
                 <td class="input" align="center" style="width:10%"> 
                  <input type="input" name="prpLchargeKindName" class="codename" style="width:120px"
                   ...
                   onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
                    onchange="setFlagDanger();setPrpLpreChargeAmount(this);">     
                    <input type='hidden'  description="标的序号" name='prpLlossDtoItemKindNoForCharge'  > 
         		</td>
                ...
                <div>
                  <input type=button name="buttonChargeDelete" class="smallbutton" onclick="deleteRow(this,'Charge'),calFund()" value="-" style="cursor: hand">
                  <input type="hidden" name="prpLchargeFlag">
                </div>
                </td>
              </tr>
        ...
        <table class="common" style="width:100%" id="Charge" border="0">
          ...
          <tfoot>
              <tr>
                <td class="title" colspan="11" style="width:96%">(按"+"号键增加单证信息，按"-"号键删除信息)</td>
...
<logic:iterate id="chargedtox" name="prpLchargeDto" property="prpLchargeList">
              ...
              <td class="input" align="center" style="width:10%">
                  ...
                  <input type="input"  name="prpLchargeKindCode" class="codecode" style="width:60px" value="<bean:write name='chargedtox' property='kindCode'/>"
                    ondblclick="code_CodeSelect(this, 'PolicyKindCode');"
                    onkeyup= "code_CodeSelect(this, 'PolicyKindCode');"
                    onchange="setPrpLpreChargeAmount(this);">
                </td>
                <td class="input" align="center" style="width:10%">    
                  <input type="input"  name="prpLchargeKindName" class="codename" style="width:120px" value="<bean:write name='chargedtox' property='kindName'/>"
                   ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
                   onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
                   onchange="setPrpLpreChargeAmount(this);">     
                 <input type='hidden'  description="标的序号" name='prpLlossDtoItemKindNoForCharge' value="<bean:write name='chargedtox' property='itemkindno'/>">      
               </td>
                <td class="input" align="center" style="width:8%">
