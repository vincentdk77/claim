...
<!--modify by liuyanmei add 20051114 end-->
    ...
    <table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title">
      ...
      <tr>
        ...
        <input type=text name="prpLregistInsuredNameshow" title="被保险人名称" class="readonly" readonly="true"  value="<bean:write name='prpLregistDto' property='insuredNameShow' filter='true' />">
                <%
        }
        else{
        %>
        ...
        <td class="input" colspan="3" >
        <input type=hidden name="prpLregistInsuredNameshow" title="被保险人名称" class="readonly" readonly="true"  value="<bean:write name='prpLregistDto' property='insuredNameShow' filter='true' />">
                        <%
        }
        %>
      ...
      <tr>
        ...
        <td class="input">
          <input type=text name="prpLregistDamageStartDate" title="出险时间" class="Wdate" onfocus="WdatePicker()" maxlength="10" style="width:80px" value="<bean:write name='prpLregistDto' property='damageStartDate' filter='true' />"onchange="flashPage();" >
      ...
      <tr>
        ...
        <td class="input">
          <input type=text name="prpLregistLinkerName" title="联系人" maxlength="20" class="input" style="width:120px" value="<bean:write name='prpLregistDto' property='linkerName' filter='true' />"/>
          <img src="/claim/images/bgMarkMustInput.jpg">
        </td>
      ...
      <tr>
        ...
        <td class="input" colspan='3'>
          <input type=text name="prpLregistAddressCode"  title="出险地邮政编码"  maxlength="6" class="input"  style="width:80px" value="<bean:write name='prpLregistDto' property='addressCode' filter='true' />">
        </td>
      </tr>
      <tr>
        <td class="title"><bean:message key="db.prpLregist.damageAddress" />:</td>
        <td class="input" colspan='3'>
          <input type=text name="prpLregistDamageAddress" title="出险地" maxlength="60" Class="input" style="width:350px" value="<bean:write name='prpLregistDto' property='damageAddress' filter='true' />">
         <img src="/claim/images/bgMarkMustInput.jpg">
        </td>
      </tr>
