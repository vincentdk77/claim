...
<script language="javascript">  
    ...
    <tr>
       ...
       <td><input type="button" name="message" value="理赔沟通" class="bigbutton" onclick="openWinSaveQuery(fm.prpLprepayClaimNo.value,fm.prpLprepayPolicyNo.value,fm.prpLprepayRiskCode.value,'prepa',fm.prpLprepayClaimNo.value,'claimNo',fm.prpLprepayClaimNo.value)"></td>
      为双击选择项。</font></td>
    </tr>
    </table>
