      <tr>  
        ...
        <td class="input" colspan="3">
          ...
          <input type="text" onblur="checkFullDate(this)" class="readonly" readonly  style="width:10%" name="prpLclaimClaimDate" description="立案日期" value="<bean:write name='prpLclaimDto' property='claimDate' filter='true' />">
