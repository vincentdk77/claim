...
--%> 
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
    <tr>
      ...
      <td><td width="70%" align="right"><font color="#666666">　注：“<font color="#FF0000">*</font>”为必选项，“<img src="/claim/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">”
      为双击选择项。</font>
      </td>
    </tr>
  </table> 
  ...
  <table border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" style="width:100%">
    <tr>
      <td class="title" colspan="4" style="width:100%">核损登记
    ...
    <tr>
     ...
     <logic:equal name="prpLverifyLossDto" property="riskCode" value="ZH03"> 
      ...
      <td class="input" colspan="3" >
        <bean:write name='prpLverifyLossDto' property='remark'/>
        <input type="hidden" name="FamilyNo" value="<bean:write name='prpLverifyLossDto' property='remark'/>">
      </td>
   		</tr>   
     </logic:equal> 
  </table>  
