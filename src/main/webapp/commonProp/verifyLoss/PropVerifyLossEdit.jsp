...
<%
   ...
   //end---------------------------------------------
    ...
    System.err.println("riskcodeorigin="+riskcodeorigin+";editType = "+editType+";nodestatusForTemp="+nodestatusForTemp);
...
<%} %>
  ...
  <input type="hidden" name="nodeType" value="propv">
  ...
  <input type="hidden" name="riskcodeStr" value="<%= riskcodeStr%>">
    ...
    <%-- 1核损主表的画面 --%>
      <%@include file="/commonProp/verifyLoss/PropVerifyLossMainEdit.jsp"%>
      
    <%-- 2.财产核定损清单页面 --%>
            <%@include file="/commonProp/verifyLoss/PropVerifyLossPropEdit.jsp"%>
      <%if(riskcodeorigin != null  && ("0310".equals(riskcodeorigin)||"0312".equals(riskcodeorigin) || riskcodeStr.indexOf(riskcodeorigin)>0 ) ){ %>
    <%-- 3. 定核损意见 --%>  
