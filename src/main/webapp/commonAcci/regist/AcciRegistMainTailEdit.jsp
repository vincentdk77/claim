   ...
   <tr>
      ...
      <td class="input">
        <input type=hidden name="prpLregistReceiverCode" class="codecode"  style="width:70px" title="接案人" value="<bean:write name='prpLregistDto' property='receiverCode' filter='true' />"
             ondblclick="code_CodeSelect(this, 'HanderCode');"
             onkeyup= "code_CodeSelect(this, 'HanderCode');">
        <input type=text readonly=true name="prpLregistReceiverName" class="readonly" style="width:180px" title="接案人" value="<bean:write name='prpLregistDto' property='receiverName' filter='true' />">
        <img src="/claim/images/bgDoubleClick1.gif" width="13" height="13" align="absmiddle">
        <img src="/claim/images/bgMarkMustInput.jpg">
      </td>
      <td class="title">是否呈报:</td>
      <td class="input">
            <%
                com.sinosoft.claim.dto.domain.PrpLregistDto prplregistDto = (com.sinosoft.claim.dto.domain.PrpLregistDto) request.getAttribute("prpLregistDto");
            %>
           <input type="radio" name="prplregistReportFlag" onclick = "changePrplregistReportFlag()" value="1"  <%= prplregistDto.getReportFlag().equals("1") ? "checked" : ""%>>是</option>
           <input type="radio" name="prplregistReportFlag" onclick = "changePrplregistReportFlag()" value="0"  <%= !prplregistDto.getReportFlag().equals("1") ? "checked" : ""%>>否</option>
      </td>
    </tr> 
