...
<input title="点击此处可获得已出险相关信息"  type=button ACCESSKEY="." value='...' name='button_Peril_Open_Context' onclick="buttonOnClick('span_Peril_Context');">
     ...
     <%-- <logic:notEmpty  name="prpLregistDto1"  property="registList"> 
      ...
      <tr>  
        <td colspan=14 class="prompttitle" >
          <input type=button name = 'button_Peril_Close_Context' value='(O)关闭'  ACCESSKEY="O" onclick="hideSubPage(this,'span_Peril_Context')">  
        </td> 
      </tr>
  </table>        
</span>
