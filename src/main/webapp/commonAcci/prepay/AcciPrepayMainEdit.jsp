...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  ...
  <tr> 
    ...
    <td class="input"> 
      <input name="prpLprepayCurrency" class="codecode" style="width:40px" value="<bean:write name='prpLprepayDto' property='currency' filter='true' />"
          ondblclick="code_CodeSelect(this, 'Currency');"
          onkeyup= "code_CodeSelect(this, 'Currency');"> 
      <input name="prpLprepayCurrencyName" class="codename" style="width:100px" value="<bean:write name='prpLprepayDto' property='currencyName' filter='true' />"
