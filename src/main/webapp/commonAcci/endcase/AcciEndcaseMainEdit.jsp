     ...
     <td width="30%">  
       <table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tr> 
          ...
          <td><input type="button" class="bigbutton" name="prpLmessageSave" value="撰写留言" onclick="openWinSave1();return false;"></td>
     <td><input type="button"  class="bigbutton" name="prpLmessageView" value="查看留言" onClick="openWinQuery('registNo',fm.prpLclaimRegistNo.value);return false;"></td>
...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  ...
  <tr style="display:none"> 
    ...
    <td class="title" colspan="3">
      <input type="hidden" name="prpLclaimLossName"  style="width:380px" class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='lossName' filter='true' />"> 
    </td>
  </tr>    
  <tr> 
