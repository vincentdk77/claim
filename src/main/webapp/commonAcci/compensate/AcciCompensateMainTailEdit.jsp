...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  <tr>
    <td class="title"  style="width:15%"> 责任赔款币种:</td>
    ...
    <td class="title"  style="width:50%" colspan="2"><input type="hidden" name="btnCurrencyTotle" value="分币别汇总" onclick="alert('分币别汇总');"></td>
  </tr>
 <!--
  <tr>
    ...
    <td class="title"  style="width:50%" colspan="2"></td>
  </tr>
 --> 
  <tr>
    <td class="title"  style="width:15%"> 责任赔款合计:</td>
    ...
    <td class="title"  style="width:15%"> 费用合计:</td>
 ...
 <tr>
  ...
  <tr>
    <td class="title"> 本次给付金额:</td>
    <td class="input" colspan=3> 
       <input class="common" type="text" name="prpLcompensateSumThisPaid" readonly="true"  style="width:150px" value="<bean:write name='prpLcompensateDto' property='sumThisPaid' filter='true'  format='##0.00'/>">
    </td>
  </tr>
  ...
  <tr>
    <td class="title"> 业务审核人:</td>
    <td class="input"  >
      <input name="prpLcompensateHandlerCode" class="codecode" style="width:40%"
          value="<bean:write name='prpLcompensateDto' property='handlerCode' filter='true' />"
          ondblclick="code_CodeSelect(this, 'HanderCode');"
          onkeyup= "code_CodeSelect(this, 'HanderCode');">
      <input name="prpLcompensateHandlerName" class="codename" style="width:50%"  title="审核人"
         value="<bean:write name='prpLcompensateDto' property='handlerName' filter='true' />"
 ...
 <tr style="display: none">
    <td class="title"> 理赔结论:</td>
    
    <td class="input" colspan="3"> 
		<html:select name="prpLcompensateDto" property="result" styleClass="three"  style="width:20%">
        	<html:options collection="compensateResultMap" property="value" labelProperty="label"/>
        </html:select>
    	<input style="width:78%" class="input" type=text name="prpLcompensateRemark"  value="<bean:write name='prpLcompensateDto' property='remark' filter='true' />">
    </td>
  </tr>
