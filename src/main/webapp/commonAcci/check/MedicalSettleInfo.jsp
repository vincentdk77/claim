...
<html:html lang="true">
  ...
  <head>
    ...
    <title>MedicalSettleInfo.jsp</title>
...
%>
  <body onLoad="initPage()" >
     <form name="fm" action="/claim/medicalsettleList.do" method="post">
...
%>
<tr>
 	<td colspan="9" align="center" class="formtitle">暂存清单出现如下错误：</td>
</tr>
<tr>
	<td colspan="9" align="center" ><%=(String)request.getAttribute("errorMessage1")%></td>
</tr>
<%} %>
<%
