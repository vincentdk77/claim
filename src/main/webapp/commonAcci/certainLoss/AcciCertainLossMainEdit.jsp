...
--%> 
      ...
      <td><input type="button" name="message" class="bigbutton" value="撰写留言" onclick="openWinSave()"></td>
      <td><input type="button" name="messageView" class="bigbutton" value="查看留言" onclick="openWinQuery()"></td>
    </tr>
  </table> 
