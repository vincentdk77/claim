      ...
      <td class="subformtitle" style="text-align:left">
        <img style="cursor:hand;" src="/claim/images/butCollapseBlue.gif"
          ...
          <table class="common" align="center" id="Ltext" style="display:none">
            <tbody>
              <tr>
                <td class="title" style="text-align:center;width:100%;align:center;"> 
<textarea style="wrap:hard;width:70%" rows="15" cols="80" name="prpLltextContextInnerHTML"><bean:write name="prpLltextDto" property="context"/></textarea>                              
                </td>
              </tr>
            </tbody>
          </table>  
