...
<%--多行输入自定义JavaScript方法域--%>
    <script language='javascript'>
      ...
      */
      ...
      <!--建立显示的录入条，可以收缩显示的-->   
        <table class="common" cellpadding="5" cellspacing="1" id="tabPersonTrace"> 
          <!--表示显示多行的-->  
          <tr>  
                    ...
                    <tr>
                      <td class="input" style="width:3%">
                        <div align="center">
                          ...
                          <input type="hidden" class="readonlyno"  name="prpLpersonTraceNewAddFlag" > <!--add by liyanjie 2005-12-18是否车辆标志 -->
                        </div>
                      </td>
                      <td class="common"  >
                        <table cellpadding="5" cellspacing="1" class="common">
                          <tr>
                            ...
                            <%//modify by caopeng start at 2005-12-21%>
                              ...
                              <input type="hidden" name="prpLpersonTraceJobCode" class="codename" style="width:50px"
                              ...
                              <input type="input" name="prpLpersonTraceJobName" class="codename" style="width:100px"
            		    ...
            		    <%//modify by caopeng start at 2005-12-21%>
                          ...
                          <%--
                          String strPersonTraceNodeType = (String)request.getAttribute("prpLnodeType"); 
                          ...
                          <tr>
                            ...
                            <td class="title" >损失金额</td>
                            <td class="input" colspan="3">
                              <input name="prpLpersonTraceLossFee" class="input" description="损失金额">
                            </td>
                          </tr>
                          <%
                          }
                          ...
                          <tr>
                            ...
                            <td class="input" colspan="3" >
                              <input name="prpLpersonTraceHospital" class="input" description="就诊医院"  maxLength="100" onblur="checkLength1(this);">
                              <input name="prpLpersonTraceIdentifyNumber"  type="hidden">
                              <input name="prpLpersonTraceRelatePersonNo"  type="hidden">
                              <%//delete by caopeng start at 2005-12-21%>
                      ...
                      <tr>
                        ...
                        <!--
                             <logic:equal name="prpLthirdPartyDto" property="nodeType" value="regis">
                              ...
                              <select name="personCheck" style="width:80px">
                              
                                   <logic:equal name='prpLpersonTraceDto' property='selectSend' value="1">
                                      <option value="1" selected>调度</option>
                                      <option value="0" >暂不调度</option>
                                   </logic:equal>
                                   
                                   <logic:notEqual name='prpLpersonTraceDto' property='selectSend' value="1">
                                       <option value="1" >调度</option>
                                       <option value="0" selected>暂不调度</option>
                                   </logic:notEqual>
                              </select> 
                              
                              <select name="prpLpersonTraceScheduleType" style="width:100px;" value="schel" >
                       ...
                       %>
                        <td class="input" style="width:4%">
                          ...
                          <input  name="prpLpersonTracePersonNo"  class="readonlyno" readonly="true" value="<bean:write name='personTrace' property='personNo'/>">
                              	<input type="hidden" class="readonlyno"  name="prpLpersonTraceNewAddFlag" value="old" > <!--add by liyanjie 2005-12-18是否新增标志 -->
                            ...
                            <tr>
                              ...
                              <!--<input name="prpLpersonTraceJobName" class="input" description="从事行业" style="width:100%"
                                value="<bean:write name='personTrace' property='jobName'/>" >-->
                                 <input type="hidden" name="prpLpersonTraceJobCode" class="codename" style="width:50px"
                                    value="<bean:write name='personTrace' property='jobCode'/>"
                                    ondblclick= "code_CodeSelect(this,'BusinessSource');"
                                    onchange="code_CodeChange(this, 'BusinessSource');"
                                    onkeyup= "code_CodeSelect(this,'BusinessSource');"> 
                                  <input type="input" name="prpLpersonTraceJobName" class="codename" style="width:100px"
            		    ...
            		    <%//modify by caopeng start at 2005-12-21%>
                            ...
                            <tr>
                              ...
                              <td class="title" >损失金额</td>
                              <td class="input" colspan="3" >
                                <input name="prpLpersonTraceLossFee" class="input" description="损失金额" value="<%=prpLcheckLossDto2.getLossFee()%>">
                              </td>
                            </tr> 
                            <%
                            }
                            ...
                            <tr>
                              ...
                              <td class="input" colspan="7" align=left >
<!--                               
                              <input name="prpLpersonTraceReferKind" class="input" description="涉及险种"
                                value="<bean:write name='personTrace' property='prpLpersonTraceReferKind'/>" >
 -->                                                 
                               <html:select name="personTrace" property="prpLpersonTraceReferKind"  style="width:50%">
                                  <html:options collection="referKindList" property="kindCode" labelProperty="kindName" />  
                                </html:select>
