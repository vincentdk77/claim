        ...
        %>  
         <td class=button style="width:33%" align="center">
          ...
          <logic:notEqual name="prpLverifyLossDto" property="status" value="4">
           ...
           <!--     
                <input type=text name="nextHandlerCode" class="codecode"  style="width:100px" maxlength="10" title="操作员" value=""
...
%>         
           <td class=button style="width:20%" align="center">
            <!--取消按钮-->
            <input type=button name=buttonCancel class='button' value="返 回" onclick="javascript:history.go(-1);" >
          </td>
<%
  }
%>          
