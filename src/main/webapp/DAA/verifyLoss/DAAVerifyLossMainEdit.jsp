  ...
  <table class=common cellpadding="5" cellspacing="1">
    <tr>
      <td class="centertitle" colspan="4" >核损登记
       ...
       <!-- 初次定损金额 -->
       <input type="hidden" name="prpLverifyLossFirstDefLoss" class="readonly" readonly style="width:140px"  value="<bean:write name='prpLverifyLossDto' property='firstDefLoss'  format='##0.00'/>">  
       <!-- 偏差定损金额 -->
       <input type="hidden" name="prpLverifyLossWarpDefLoss"  class='input' style="width:140px" value="<bean:write name='prpLverifyLossDto' property='warpDefLoss' format='##0.00'/>"> 
      </td>  
    </tr>      
    <tr>
      <td class="title" style="width:15%">保单号:</td>    
      <td class="input" style="width:35%">    
        <input type=text name="prplCheckPolicyNo" class="readonly" readonly="true" style="width:140px" value="<bean:write name='prpLregistDto' property='policyNo'/>">     
    ...
    <tr>
      ...
      <td class="input" style="width:35%" >  
        <input type=text name="prplCheckRegistNo" class="readonly" readonly="true" style="width:140px" value="<bean:write name='prpLregistDto' property='registNo'/>">     
