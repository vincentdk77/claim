...
%>
  ...
  <table cellpadding="5" cellspacing="1" class="common">
    <tr>
      <td class=button ><input type="button" class=bigbutton name="message" value="理赔沟通" onclick="openWinSaveQuery('<bean:write name='prpLregistDto' property='registNo' filter='true' />','<bean:write name='prpLregistDto' property='registNo' filter='true' />',fm.riskcode.value,'propc',fm.prpLverifyLossClaimNo.value,'registNo','<bean:write name='prpLregistDto' property='registNo' filter='true' />')"></td>
      <td class=button ><input type="button" class=bigbutton name="message" value="电子单证" onclick="openCertify('certifyFinishQueryList','prpLcertifyCertifyNo','<bean:write name='prpLregistDto' property='registNo' filter='true' />','certa');"></td>
