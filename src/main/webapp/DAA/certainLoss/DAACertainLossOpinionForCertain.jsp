  ...
  %>                          
          ...
          <logic:notEmpty name='prpLverifyLossDto' property='verifyOpinion'>                        
              ...
              <logic:equal name='prpLverifyLossDto' property='verifyOpinion' value="02">                        
                 <input name="verifyOpinionName" class="readOnly" readOnly value="核损退回(价格异议)">
              </logic:equal>   
              <logic:equal name='prpLverifyLossDto' property='verifyOpinion' value="03">                        
                 <input name="verifyOpinionName" class="readOnly" readOnly value="核损退回(信息不充分)">
              </logic:equal>   
              <logic:equal name='prpLverifyLossDto' property='verifyOpinion' value="04">                        
                 <input name="verifyOpinionName" class="readOnly" readOnly value="核损退回(出具检验报告)">
              </logic:equal>   
              <logic:equal name='prpLverifyLossDto' property='verifyOpinion' value="05">                        
                 <input name="verifyOpinionName" class="readOnly" readOnly value="核损退回(其它)">
              </logic:equal> 
              <logic:equal name='prpLverifyLossDto' property='verifyOpinion' value="10">                        
                 <input name="verifyOpinionName" class="readOnly" readOnly value="核价退回">
              </logic:equal>                           
          </logic:notEmpty>                        
