...
function relatePolicy(){	   
 ...
 <%
   String claimTypeName = (String)request.getAttribute("claimTypeName"); 
   String claimTypeCode = (String)request.getAttribute("claimTypeCode");
 %>   
    
    <tr>
      <td class="title" colspan="4">定损登记         本案为<%=claimTypeName%>

        <input type="hidden" name="prpLclaimTypeCode"                  value="<%=claimTypeCode%>">
    ...
    <tr>
      ...
      <td class="input" style="width:35%">    
        <input type=text name="prplCheckPolicyNoShow" class="readonly" readonly="true" style="width:140px" value="<bean:write name='prpLregistDto' property='policyNo'/>">
        <%--- 应车险部需求，暂时屏蔽保单信息
        <input type="button" name="btPolicyRelate" value="保单信息" class='bigbutton' onclick="relateBeforePolicyNo('<bean:write name='prpLregistDto' property='policyNo'/>','<bean:write name='prpLregistDto' property='riskCode'/>','<bean:write name='prpLregistDto' property='damageStartDate' filter='true' />');">    
        -------------%>
      </td>  
      <td class="title" style="width:15%" style="valign:bottom" >赔案号:</td>
      <td class="input" style="width:35%">   
  ...
  %>
   <tr>
      <td class="title" style="width:15%" style="valign:bottom" >关联保单号:</td>
      <td class="input" style="width:35%">   
...
%>         
    <tr>
      ...
      <td class="input" style="width:35%" >  
        <input type=text name="prplCheckRegistNoShow" class="readonly" readonly="true" style="width:140px" value="<bean:write name='prpLregistDto' property='registNo'/>"><input type="button" name="btRegistRelate" value="报案信息" class='bigbutton' onclick="relateRegist();return false;">    
      </td> 
...
<%if(request.getAttribute("handlerCode") != null){ %>
    <tr>
      <td class="title" style="width:15%">定损时间:</td>   
      <td class="common" style="width:35%">    
          <input name="prpLverifyLossDefLossDate"  description ="定损日期" class="input" style="width:140px"  value="<bean:write name='prpLverifyLossDto' property='defLossDate' />"  onKeyPress="pressFullDate(this)" onblur="checkFullDate(this)">         
      ...
      <td class="common" style="width:35%">   
        ...
        <input name="prpLverifyLossHandlerCode"  class="codecode" style="width:40%"  value="<%=(String)request.getAttribute("handlerCode") %>">         
        <input name="prpLverifyLossHandlerName"  class='codename' maxlength=60  style="width:45%" value="<%=(String)request.getAttribute("handlerName") %>"> 
      </td>  
    </tr> 
<%} %>
</logic:equal>
