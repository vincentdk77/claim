...
<!--%}%>
 ...
 %>
              <tr>
                ...
                <%if("0".equals(status) && indexCertainLossExt == verifyLossExtList.size()-1){%>
                <td class="input"  style="width:12%">
                  <input  type="text" name="prpLverifyLossExtOperatorName" class="readonly" readonly style="width:100%" value="<bean:write name='user' property='userName'/>">
                ...
                <td class="input"  style="width:15%">
                  <input  type="text" name="prpLverifyLossExtTitle" class="input"  style="width:100%" value="<%=verifyLossExt1.getTitle()%>">
                </td>
                <td class="input"  style="width:45%">
