 ...
 <%
  ...
  %>
     <tr>
       ...
       <td width="33%" align="center"class="input"> <input type="button" name=buttonPrint13 class='bigbutton' value="打印领取赔款通知书" onclick="return printForm1(this,'<%=strcompensateNoList[i]%>','Drawnotice');">  </td>
     </tr>
      <%
     }
      %>
