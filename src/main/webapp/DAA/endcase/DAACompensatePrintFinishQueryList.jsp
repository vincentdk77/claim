  ...
  <%
   ...
   %>
     <tr>
       ...
       <td width="33%" align="center"class="input"> <input type="button" name=buttonPrint13 class='button' value="打印 " onclick="return printForm1(this,'<%=strcompensateNoList[i]%>','Compensate');">  </td>
     </tr>
      <%
     }
      %>
