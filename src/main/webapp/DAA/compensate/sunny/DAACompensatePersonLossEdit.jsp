          ...
          <tbody>
            <tr>
              <td class="inputsubsub">
                ...
                <input name="prpLpersonLossLiabDetailCode" class="codecode" style="width:40px" title="费用代码"
                ...
                <input name="prpLpersonLossLiabDetailName" class="codename" style="width:150px" title="费用名称"  
...
<!--交强险赔款金额--><td class="inputsubsub" style="width:100px">
                              ...
                              <table id="PersonFeeLoss" name="PersonFeeLoss" class="common" align="center" cellspacing="1" cellpadding="0">
                                <thead>
                                  ...
                                  <tr>
                          	  		  ...
                          	  		  <td class="centertitle" id="tdTitleCISumRealPay">交强险赔款金额</td>   
                          	  		   <td class="centertitle">核定赔偿</td>
     ...
     <span  id="spanPerson" style="display:none">
       ...
       <table id="person" class="common" align="center" cellspacing="1" cellpadding="0">
         ...
         <tfoot>
           <tr>
             <td class="title" colspan=3 style="width:96%">(按"+"号键增加赔付人员信息，按"-"号键删除赔付人员信息)</td>
             <td class="title" align="right" style="width:4%">
               <div align="center">
 ...
 %>
                              <tr>
                                  <td class="inputsubsub">
                                    ...
                                    <input name="prpLpersonLossLiabDetailCode" class="codecode" style="width:40px" title="费用代码"  value="<%= PrpLpersonLossDto2.getLiabDetailCode() %>"
                                       ...
                                       onblur="calculateFee(this);">
                                    <input name="prpLpersonLossLiabDetailName" class="codename" style="width:150px" title="费用名称"  value="<%= PrpLpersonLossDto2.getLiabDetailName() %>"
