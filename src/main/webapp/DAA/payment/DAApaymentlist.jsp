   		...
   		<table class="easyui-datagrid" height="35%" width="95%" cellpadding="5" cellspacing="1">
   			<thead>
	   			<tr>
	   				...
	   				<th field="code1" align="center" class="centertitle" width="150" >报案号</th>
	   				<th field="code2" align="center" class="centertitle" width="150" >被保险人名称</th>
	   				</c:if>
	   				<th field="code3" align="center" class="centertitle" width="150" >收付编号</th>
	   				<th field="code4" align="center" class="centertitle" width="150" >领款人名称</th>
<%--	   				<th field="code3" align="center" class="centertitle" width="80" >赔款类型</th>--%>
	   				...
	   				<th field="code6" align="center" class="centertitle" width="80" >流入时长</th>
