...
<script type="text/javascript">
	...
	*/
	function checkMaxVal(obj){
		...
		var maxVal = $(obj).parent().find("input[name='sumamount']").val();
	...
	*/
	...
	function addRow(){
		...
		var returnValue = window.showModalDialog(url,window,"dialogWidth=760px;dialogHeight=400px");
		if(returnValue!=undefined && typeof(returnValue)!='string'  &&  returnValue[0] == "true"){
			var loopSize  = (returnValue.length-1)/14 ;//看返回了几个对象（即选中了几个号码）
			
			for(var ls = 0;ls<loopSize ;ls++){
				var k=1;
				var addFlag=true;//添加标志
				var certiNo = returnValue[ls*14+1];
				var payrefReason = returnValue[ls*14+13];
				...
				if(addFlag){
					...
					"	<input type='hidden' style='width: 99%;text-align: center;' readOnly class='readOnly' name='policyTypePay' value='"+returnValue[ls*14+12]+"' /> "+
					"	<input type='hidden' style='width: 99%' readOnly class='readOnly' name='policyNoPay' value='"+returnValue[ls*14+3]+"' /> "+
					"	<input type='hidden' style='width: 99%' readOnly class='readOnly' name='claimNoPay' value='"+returnValue[ls*14+4]+"' /> "+
					"	<input type='hidden' style='width: 99%' readOnly class='readOnly' name='payrefreason' value='"+returnValue[ls*14+13]+"' /> "+
					...
					//"</td> "+
					//"<td  class='input'  align='center'> "+
					"   <a href='#' onclick=\"logstore('"+returnValue[ls*14+2]+"','apay')\">"+returnValue[ls*14+2]+"</a> "+
					"	<input type='hidden' style='width: 99%;text-align: center;' readOnly class='readOnly' name='registNoPay' value='"+returnValue[ls*14+2]+"' /> "+
					"	<input type='hidden' style='width: 99%;text-align: center;' readOnly class='readOnly' name='classCode' value='"+returnValue[ls*14+14]+"' /> "+
					"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='hidden' style='width: 99%;text-align: center;' readOnly class='readOnly' name='insuredNamePay' value='"+returnValue[ls*14+5]+"' /> "+
					"		"+returnValue[ls*14+5]+
					"</td> "+
					//"<td  class='input'  align='center'> "+
					...
					//"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='text' style='width: 99%;text-align: center;' readOnly class='readOnly' name='certiNoPay' value='"+returnValue[ls*14+1]+"' /> "+
					"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='hidden' style='width: 99%' readOnly class='readOnly' name='comCodePay' value='"+returnValue[ls*14+9]+"' /> "+
					"	<input type='hidden' style='width: 99%;text-align: center;' readOnly class='readOnly' name='comCodeNamePay' value='"+returnValue[ls*14+10]+"' /> "+
					"	"+payrefReasonName+
					"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='text' style='width: 99%;text-align:right;' readOnly class='readOnly' name='sumPaidPay' value='"+returnValue[ls*14+7]+"' /> "+
					"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='text' style='width: 99%;text-align:right;' readOnly class='readOnly' name='havPaidPay' value='"+returnValue[ls*14+8]+"' /> "+
					"</td> "+
					"<td  class='input'  align='center'> "+
					"	<input type='hidden' name='paidMaxValue'  value='"+(returnValue[ls*14+7]-returnValue[ls*14+8]).toFixed(2)+"'/> "+
					"	<input type='text' style='width: 99%;text-align:right;'  class='input' name='paidPay'  value='"+(returnValue[ls*14+7]-returnValue[ls*14+8])+"' onblur='clearNoNumF(this);checkMaxVal(this);mergeFee(this);'/> "+
					"</td> "+
					//<td  class='input'  align='center'> "+
...
<div id="content_basic" style="width: 98%" name="mainInfoDiv">
	...
	<table class="common" id="mainInfo" cellpadding="0" cellspacing="0" border="1" bordercolor="#3A81C8">
		<tr>
			...
			<td class="title"  style="width:18%" align="center">被保险人</td>
			<td class="title"  style="width:10%" align="center">农户名称</td>
			<td class="title"  style="width:11%" align="center">理算书号</td>
			<td class="title"  style="width:9%" align="center">赔款类型</td>
			<td class="title"  style="width:10%" align="center">赔款金额</td>
		...
		<tr>
			...
			<td  class="input"  align="center">
				<input type="hidden" style="width: 99%;text-align: center;" readOnly class="readOnly" name="payName" value="${payName }" />
				${payName }
			</td>
			<td  class="input"  align="center">
			...
			<td  class="input"  align="center">
				...
				<input type="text" style="width: 99%;text-align:right;"  class="input" name="paidPay"  value="${prpLpayShowDto.nowPaid }" onblur="clearNoNumF(this);checkMaxVal(this);mergeFee(this);"/>
				</c:if>
				<c:if test="${prpLpayShowDto.exist ne '1' }">
					<input type="text" style="width: 99%;text-align:right;"  class="input" name="paidPay"  value="<fmt:formatNumber type='number' value='${sumamount }' pattern='##########.##' maxFractionDigits='2'/>" onblur="clearNoNumF(this);checkMaxVal(this);mergeFee(this);"/>
				</c:if>
...
<!--		<tr>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="policyType" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="registNo" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="insuredName" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="licenseNo" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="certiNo" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="comCodeName" value="1" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="sumPaid" value="25.66" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%" readOnly class="readOnly" name="havPaid" value="10.05" />-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="text" style="width: 99%"  class="input" name="paid" value="2.01" onblur="clearNoNumF(this);mergeFee(this);"/>-->
<!--			</td>-->
<!--			<td align="center">-->
<!--				<input type="checkbox" class="input" name="flag" value="1" onclick="mergeFee(this);"/>-->
<!--			</td>-->
<!--		</tr>-->
