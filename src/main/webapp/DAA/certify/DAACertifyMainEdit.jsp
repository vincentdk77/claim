...
%><table cellpadding="5" cellspacing="1" border="0"  class="common" >
  ...
  <tr>
    ...
    <td class="input" style="width:7%"><input class=button type="button" name="buttonView" value="查看"  onclick="doViewFile('<%= strEditTypeNew%>','<%= k %>','<%= no %>' );return false;"></td>
    <td class="input" style="width:16%" align="center">
		<input class="button" type="button" name="buttonDelete" value="已删除图片" onclick="doDeleteViewFile('<%= strEditTypeNew%>','<%= k %>','<%= no %>');return false;">
	</td>
    <td class="input" style="width:7%"><input class=button type="button" name="buttonUpload" value="上传" onclick="doUploadFile('<%= k %>','<%= no %>','<%= name %>','<%=strTitle%>','<%=strImageList%>');return false;"></td>
  </tr>
</table>
<%}}
...
<table cellpadding="5" cellspacing="1" border="0"  class="common">
  ...
  <tr>
    ...
    <td class="input" style="width:7%">
    	<input class=button type="button" name="buttonView" value="查看" onclick="doViewFile('<%= strEditTypeNew%>','99','99' );return false;">   	
    </td> 
    <td class="input" style="width:16%" align="center">
    	<input class="button" type="button" name="buttonDelete" value="已删除图片" onclick="doDeleteViewFile('<%= strEditTypeNew%>','99','99' );return false;">
    </td>
    <td class="input" style="width:7%"><input class=button type="button" name="buttonUpload" value="上传" onclick="doUploadFile('99','99','其它资料','其他资料','<%=strImageList%>');return false;"></td> 
  </tr>
</table>
