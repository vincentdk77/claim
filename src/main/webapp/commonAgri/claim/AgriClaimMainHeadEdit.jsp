	   ...
	   <td width="30%"> 
		...
		if(strHPflag != null && !strHPflag.equals("") && !strHPflag.equals("null")) {
			if(strHPflag.equals("Large")) {
				%> <td class="formtitle">规模经营主体系统立案登记
	            <logic:equal name ="prpLclaimDto" property="caseType" value='0'>（已拒赔）</logic:equal>
                <logic:equal name ="prpLclaimDto" property="caseType" value='1'>（已注销）</logic:equal>
	              </td><% 
			} else if(strHPflag.equals("Retaol")) {
				%> <td class="formtitle">扶贫系统立案登记
	            <logic:equal name ="prpLclaimDto" property="caseType" value='0'>（已拒赔）</logic:equal>
                <logic:equal name ="prpLclaimDto" property="caseType" value='1'>（已注销）</logic:equal>
	              </td><% 
			} else {
      ...
      <tr>
        ...
        <td class="input" colspan=3>
          ...
          <logic:equal value="1" name="IsDisplayGisViewInfo">
          	<input type=button class="bigbutton" name="GisViewInfo" value="地图信息" onclick="viewGis();">
          </logic:equal>
