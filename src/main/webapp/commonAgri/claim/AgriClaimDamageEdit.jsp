...
<tr>
        ...
        <td class="input" <%=strColspan %>>
           ...
           <input type=text class="codecode" name="prpLclaimDamageName"  title="出险原因" style="width:110px" value="<bean:write name='prpLclaimDto' property='damageName' filter='true' />"
