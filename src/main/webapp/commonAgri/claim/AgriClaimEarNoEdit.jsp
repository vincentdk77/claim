...
function checkEarNoAndModify()
{
	var countEar = getElementCount("prplCompensateEarEarNo");
 	 var killQuantity = document.getElementsByName("prpLclaimKillQuantity")[0].value;
	 var deathQuantity = document.getElementsByName("prpLclaimDeathQuantity")[0].value;
     var lossNumber = document.getElementsByName("prpLclaimLossesNumber")[0].value;
	 document.getElementsByName("prpLclaimLossesNumber")[0].value = countEar -1;
	...
	var newArray=new Array();  
	 ...
	 //end
	var damageInsured = document.getElementsByName("prpLclaimDamageInsured")[0].value;
	document.getElementsByName("prpLclaimDamageInsured")[0].value = newArray.length;
