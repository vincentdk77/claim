   ...
   <td class="common" colspan="4" style="text-align:left;">
         ...
         <tbody>
           <tr>
             <td class="input" align=left style="width:10%">
               <input type=text name="prpLclaimLossAcciName" title="牛号"  class="common" >
             </td>
             ...
             <td class="input" style="width:12%" align="center">
                 <input type="text" name="prpLclaimLossItemCode" value="" class="codecode" style="width:30%" title="保险责任"
                                    ondblclick="code_CodeSelect(this, 'PolicyItemCode2');"
                                    onkeyup= "code_CodeSelect(this, 'PolicyItemCode2');">
                  <input type=text name="prpLclaimLossItemName" class="codecode" style="width:60%" title="保险责任"  value=""
             ...
             <td class="input" style="width:10%">
                 <input name="prpLclaimLossInputDate"  onblur="checkFullDate(this)" style="width:85px" maxlength="10"
             ...
             <td class="input" style='width:4%' colspan="2" align="center">
                 <div>
                   <input type="button" class="smallbutton" name="buttonClaimLossDelete"  onclick="deleteRow(this,'ClaimLoss')" value="-" style="cursor: hand">
                 </div>
             </td>
           </tr>
         </tbody>
    ...
    <span  id="spanClaimLoss" style="display:" cellspacing="1" cellpadding="0">
     ...
     <table class="common" style="width:100%" id="ClaimLoss" >
       <thead>
         <tr>
              <td class="centertitle" style="width:10%">牛号</td>
              <td class="centertitle" style="width:28%">险别</td>
              <td class="centertitle" style="width:12%">责任</td>
       ...
       <logic:iterate id="prpLclaimLossDto"  name="claimDto"  property="prpLclaimLossDtoList">
         <tr>
            <td class="input" align=left style="width:10%">
              <input type=text name="prpLclaimLossAcciName"   value="<bean:write name='prpLclaimLossDto' property='remarkFlag' filter='true' />"
               class="common"  title="牛号">
           </td>
           <td class="input" style="width:20%" style="align:center">
           ...
           <td class="input" style="width:12%">
               <input name="prpLclaimLossSumClaim" class=common style="text-align:right" value="<bean:write name='prpLclaimLossDto' property='sumClaim' filter='true' format='##0.00'/>" onchange="return checkBeyondSumAmount(this)">
           </td>
           <td class="input"  style="width:10%">
             <select name="prpLclaimLossLossFeeType">
           ...
           <td class="input" style='width:4%' colspan="2" align="center">
               <div>
                 <input type="button" class="smallbutton" name="buttonClaimLossDelete"  onclick="deleteRow(this,'ClaimLoss')"  <%=buttonType%>  value="-" style="cursor: hand">
               </div>
           </td>
         </tr>
       </logic:iterate>
