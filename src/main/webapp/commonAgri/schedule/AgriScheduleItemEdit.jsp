...
%>
 ...
 <logic:equal name="prpLscheduleMainWFDto"  property="saveType" value="GETBACKEDIT">
   ...
   <input type="hidden" class="readonlyno" readonly name="prpLscheduleItemItemNo" value="<bean:write name='scheduleItem' property='itemNo'/>">
                 ...
                 <input type=text class="codecode" name="prpLscheduleItemScheduleObjectName"  title="具体单位" style="width:50%" maxLength="50" description="定损处理单位" value="<bean:write name='scheduleItem' property='scheduleObjectName' filter='true' />"
                   <% if (!ifreadonly.equals("readonly")){%>
            ...
            <input type="hidden" name="surveyType" value="<bean:write name='scheduleItem' property='surveyType'/>">
             ...
             <tr>   
                ...
                <td class="input" colspan=4>
                  <input  class="input"  <%=ifreadonly%> name="prpLscheduleItemFactoryEstimateLoss"  maxLength="30" onblur="checkLength1(this);" description="报损金额" value="<bean:write name='scheduleItem' property='factoryEstimateLoss'/>">
                </td>    
             </tr>
          ...
          <td class="input" colspan=6>
              ...
              <input  type=hidden name="prpLscheduleItemFlag" value="<bean:write name='scheduleItem' property='flag'/>">
                 ...
                 <td class="input" colspan=6 Style=""><%//边框的设置%>
                   ...
                   <input type=text name="nextHandlerCode" num=<%=index%> class="codecode"   style="width:100px" maxlength="10" description="操作员" title="操作员" value="<bean:write name='scheduleItem' property='nextHandlerCode'/>"
             <% if (!ifreadonly.equals("readonly")){%>
             ...
             <%=ifreadonly%>
             >
        <input type=text name="nextHandlerName" num=<%=index%> class="codecode" style="width:80px" title="操作员"  maxLength="30" description="操作员"   value="<bean:write name='scheduleItem' property='nextHandlerName'/>" 
             <% if (!ifreadonly.equals("readonly")){%>
