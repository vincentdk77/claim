...
<head>
  ...
  <script src="/claim/commonAgri/endcase/js/PropEndcaseEdit.js"></script>
</head>
...
%>
	...
	<input type="hidden" name="planFeeFlag" value="<%=request.getAttribute("planFeeFlag")%>">
      <%-- 1.结案主信息 --%>
      <%@include file="/commonAgri/endcase/PropEndcaseMainEdit.jsp" %>
      <%-- 4.结案文本信息 --%>
      <%@include file="/commonAgri/endcase/PropEndcaseTextEdit.jsp"%>
      <%-- 保存通用按钮 --%>
      <%@include file="/commonAgri/endcase/PropEndcaseSave.jsp"%>
      <%-- 案件互查返回按鈕--%>
