     ...
     <td width="30%">  
       <table width="100%" border="0" cellpadding="0" cellspacing="0">
         <tr> 
          ...
          <td><input type="button" name="prpLmessageSave" value="理赔沟通" class="bigbutton" onclick="openWinSave1Query();return false;"></td>
...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  ...
  <%@include file="/commonAgri/endcase/AgriEndcaseDamageEdit.jsp"%>
  <tr> 
