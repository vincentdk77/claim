...
%>
  <body onLoad="initPage()" >
     <form name="fm" action="/claim/settleList.do" method="post">
...
<tr>
	<td colspan="9" align="center" ><%=((StringBuffer)request.getAttribute("errorMessage")).toString()%></td><!-- 版本回退到StringBuffer -->
</td>
</tr>
