...
<body class=interface onload="initPage();initShow();" class="interface">
    ...
    <input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="<%= session.getAttribute("org.apache.struts.action.TOKEN") %>">
      <%-- 1.预赔主信息 --%>
      <%@include file="/commonProp/prepay/PropPrepayMainShow.jsp"%>
      <%-- 4.预赔备注信息 --%>
      <%@include file="/commonProp/prepay/PropPrepayTextShow.jsp"%>

      <%-- 保存通用按钮 --%>
        <table cellpadding="0" cellspacing="0" width="80%" style="display:">
          <tr>
            <td align="center"><input type="button" name="buttonApprove" class="button" value="复  核" onClick="approveSubmit();"></td>
          </tr>
        </table>
     </form>
</body>
