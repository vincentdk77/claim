...
<%@ page import="import com.sinosoft.claim.dto.domain.PrpPheadDto" %>
...
<input title="点击此处可获得已出险相关信息"  type=button ACCESSKEY="." value='...' class="smallbutton" name='button_Peril_Open_Context' onclick="buttonOnClick('perilInfoShow',fm.policyNo.value,fm.registNo.value);">
