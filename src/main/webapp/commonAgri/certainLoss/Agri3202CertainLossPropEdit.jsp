  ...
  <table class=common cellpadding="5" cellspacing="1">
        ...
        <span style="display:none"> 
          <table class="common" style="display:none" id="Prop_Data" cellpadding="5" cellspacing="1">
            <tbody>
              <tr>
                <td class="input">
                  <input type=text name="prpLclaimLossAcciName"   class="common"  title="牛号">
                ...
                <td class="input">    
                    ...
                    <input type="input" name="prpLpropKindName" class="codename" style='width:80px'
  			             ondblclick="code_CodeSelect(this, 'PolicyKindCode2','-1,1','name','none','post');"
  			             onchange="code_CodeChange(this, 'PolicyKindCode2','-1,1','name','none','post');"
  			             onkeyup= "code_CodeSelect(this, 'PolicyKindCode2','-1,1','name','none','post');">         
        ...
        <table class="common"  id="Prop" cellpadding="5" cellspacing="1">
          <thead>
            ...
            <tr>
              <td class="centertitle" style="width:16%">牛号</td>
...
%>
              <tr>
                ...
                <td class="input" style="width:16%">
                  <input type=text name="prpLclaimLossAcciName"  value="<bean:write name='prpLpropDto1' property='familyName'/>"
                ...
                <td class="input" style="width:12%">                
                  <input name="prpLpropSumDefLoss" class=readonly readonly style='width:80px<%=compensatebackStyleO%>' <%=compensatebackReadOnlyO%> maxlength=40   value="<bean:write name='prpLpropDto1' property='sumDefLoss'/>" onBlur="initSet();">
                </td>
                <td class="input" style="width:12%">                   
