          ...
          <tfoot>
           ...
           <logic:iterate id="prpLrelatePersonDto" name="prpLrelatePersonDtoList">
              <tr>
                ...
                <td class="input" style="width:15%">
                  <input name="prpLrelatePersonPersonName" class="common"  style="width:90%" value="<bean:write name='prpLrelatePersonDto' property='personName' />">
                </td>
                <td class="input" style="width:15%">
                    <input name="prpLrelatePersonPhoneNumber" class="common"  style="width:90%" value="<bean:write name='prpLrelatePersonDto' property='phoneNumber' />">
                </td>
                <td class="input" style="width:15%">
                  <input name="prpLrelatePersonMobile" class="input" style="width:90%" value="<bean:write name='prpLrelatePersonDto' property='mobile' />">
                </td>
                <td class="input" style="width:45%">
                  <input name="prpLrelatePersonRemark" class="input" style="width:90%" value="<bean:write name='prpLrelatePersonDto' property='remark' />">
                </td>
                <td class="input" style='width:4%'  align="center">
                  <div>
                    <input type=button name="buttonThirdPropDelete" class="smallbutton"  onclick="deleteRow(this,'ThirdProp')" value="-" style="cursor: hand">
