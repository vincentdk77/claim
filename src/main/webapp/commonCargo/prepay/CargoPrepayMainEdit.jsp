...
--%>
    ...
    <tr>
       ...
       <td><input type="button" name="message" value="讨论留言" class="bigbutton" onclick="openWinSave('<bean:write name='prpLprepayDto' property='registNo' />','<bean:write name='prpLprepayDto' property='policyNo' filter='true' />','<bean:write name='prpLprepayDto' property='riskCode' />','speci','<bean:write name='prpLprepayDto' property='claimNo' filter='true' />')"></td><td><input type="button" name="messageView" value="查看留言" class="bigbutton" onclick="openWinQuery('registNo',fm.prpLprepayRegistNo.value)"></td><td width="70%" align="right"><font color="#666666">　注:“<font color="#FF0000">*</font>”为必选项，“<img src="/claim/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">” 
      为双击选择项。</font></td>
    </tr>
    </table>
<table  border="0" align="center" cellpadding="4" cellspacing="1"  class="title" width="100%">
  <tr> 
    <td class="title" colspan="4" >预付赔款登记 
      <input type="hidden" name="prpLprepayRegistNo" value="<bean:write name='prpLprepayDto' property='registNo' />">
      <input type="hidden" name="registNo" value="<bean:write name='prpLprepayDto' property='registNo' />">
  ...
  <tr> 
    ...
    <td class="input"> 
      ...
      <input name="prpLprepayCurrencyName" class="codename" style="width:50%"  value="<bean:write name='prpLprepayDto' property='currencyName' filter='true' />"
