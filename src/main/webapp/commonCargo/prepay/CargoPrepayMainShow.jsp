...
--%>
       ...
       <td align=center><input type="button" name="message" value="讨论留言" class="bigbutton" onclick="openWinSave()"></td>
       <td align=center><input type="button" name="messageView"  class="bigbutton" value="查看留言" onclick="openWinQuery()"></td>
       
    </tr>
    </table>
<table  border="0" align="center" cellpadding="5" cellspacing="1"  class="common">
  <tr> 
    <td class="title" colspan="4" >预付赔款登记 
  ...
  <tr> 
    ...
    <td class="input"  > <input type=text name="prpLprepayPreCompensateNo" title="预付赔款号" maxlength="22" class="readonly" readonly="true" value="<bean:write name='prpLprepayDto' property='preCompensateNo' filter='true' />"> 
    </td>
    <td class="title"  > 立案号： </td>
    <td class="input"  > <input type=text name="prpLprepayClaimNo" title="立案号" maxlength="22" class="readonly" readonly="true"  value="<bean:write name='prpLprepayDto' property='claimNo' filter='true' />"> 
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td class="input"> 
      <input name="prpLprepayCurrency" class="readonly" readonly   value="<bean:write name='prpLprepayDto' property='currency' filter='true' />"> 
      <input name="prpLprepayCurrencyName" class="readonly" readonly  value="<bean:write name='prpLprepayDto' property='currencyName' filter='true' />">       
    </td>
