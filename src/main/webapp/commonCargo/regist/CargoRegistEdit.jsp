...
<head>
  ...
  <script src="/claim/commonCargo/regist/js/CargoRegistEdit.js"></script>
...
%>
    ...
    <input type="hidden" name="txtCoreWebUrl" value="<%=strCoreWebUrl%>">
        <%-- 1.报案主信息头 --%>
            <%@include file="/commonCargo/regist/CargoRegistMainHeadEdit.jsp" %>
        <%-- 2.报案主信息中 --%>
            <%@include file="/commonCargo/regist/CargoRegistMainMiddleEdit.jsp"%>
        <%-- 3.报案主信息结尾 --%>
            <%@include file="/commonCargo/regist/CargoRegistMainTailEdit.jsp"%>
      ...
      <%@include file="/DAA/regist/DAARegistPolicyRiskEdit.jsp"%>
        ...
        <%-- 保存通用按钮 --%>
            <%@include file="/commonCargo/regist/CargoRegistSave.jsp"%>
