        <%-- 保存通用按钮 --%>
          <table id="buttonArea" cellpadding="0" cellspacing="0" width="80%" style="display:">
            ...
            <tr>
              ...
              <td class=button style="width:25%" align="center">
                <!--已完成按钮-->
                <input type="button" name=buttonSaveFinish class='button' value="<bean:message key='button.finish.value'/>"  onclick="return saveForm(this,'3');" >
              </td>
         
              <td class=button style="width:25%" align="center">
                <!--已完成并提交按钮-->
                <input type="button" name=buttonSaveFinishSubmit class='button' value="<bean:message key='button.finishsubmit.value'/>" onclick="return saveForm(this,'4');" >
              </td>
           ...
           <logic:equal name="prpLregistDto" property="status" value="4">
             <td class=button style="width:33%" align="center">
              <!--返回按钮-->
              <input type=button name=buttonCancel class='button' value="<bean:message key='button.return.value'/>" onclick="history.back();"  >
            </td>
          </logic:equal>          
        </tr>
      </table>