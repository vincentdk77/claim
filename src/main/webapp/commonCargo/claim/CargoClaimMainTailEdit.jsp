      <tr>  
        ...
        <td class="input" colspan="3">
          ...
          <input type="common" onblur="checkFullDate(this)" class="readonly"  style="width:30%" name="prpLclaimClaimDate" description="立案日期" value="<bean:write name='prpLclaimDto' property='claimDate' filter='true' />">
