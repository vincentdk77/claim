     ...
     <tr>
        ...
        <td class="input" >       
         <!-- <input type=text name="prpLextUnloadDate" title="卸货日期" style="width:80px"  class="readonly" readonly="true" value="<bean:write name='prpLextDto' property='unloadDate' filter='true' />"> --> 
          <input type=text name="prpLclaimEndDate" title="卸货日期" style="width:80px"  class="readonly" readonly="true" value="<bean:write name='prpLclaimDto' property='endDate' filter='true' />">
