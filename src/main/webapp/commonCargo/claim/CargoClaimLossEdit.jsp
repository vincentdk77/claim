    ...
    function checkBeyondSumAmount(field)
     {
        ...
        var strSumAmount = fm.prpLclaimLossItemAmount[findex].value;
        strSumAmount = strSumAmount.replace(/(,)/g,"");
        sumAmount = parseFloat(strSumAmount);  
...
<%
      ...
      //reason:估损金额调整
      if(!prpLclaimDto.getRiskCode().equals("1003")&&!prpLclaimDto.getRiskCode().equals("1004")&&!prpLclaimDto.getRiskCode().equals("0908")&&!"11".equals(prpLclaimDto.getClassCode())){
%>
                 ...
                 <input type='input' name='prpLclaimLossItemCode' class="codecode" style="width:20%" title="标的代码"
                            ondblclick="code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','1,-3,2','code','none','post');" 
                            onkeyup= "code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','1,-3,2','code','none','post');" 
                 ...
                 <input type='input' name="prpLclaimLossItemDetailName" class="codename"  style="width:70%" title="标的名称"
                            ondblclick="code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','-1,-4,1','always','none','post');"
        		    		onkeyup= "code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','-1,-4,1','always','none','post');"
        		    		  onchange="setFlagDanger();" >                                                                        
<%
      }else{
%>
				 <input type="input" name="prpLclaimLossKindCode" class="codecode" style="width:20%" title="险别代码" value=<bean:write name='defaultKindCode'/>
                       ondblclick= "code_CodeSelect(this,'PolicyKindCode', '1,-1,4','code','none','post');" 
                       onkeyup= "code_CodeSelect(this,'PolicyKindCode', '1,-1,4','code','none','post');" 
                       onchange="judgeKindCode(this);setFlagDanger();">
                 <input type="input" name="prpLclaimLossKindName" class="codecode" style="width:70%" title="险别名称"
                        ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,-2,3','always','none','post');"
                        onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1,-2,3','always','none','post');"
                        onchange="judgeKindCode(this);setFlagDanger();">
            ...
            */%>
            ...
            <input name="prpLclaimLossFeeCategory" type="hidden" value="">
             ...
             <td class="input" style="width:16%">
                 <input name="prpLclaimLossSumClaim" class=common style="text-align:right" onchange="setFlagDanger();collectClaimLoss();return checkBeyondSumAmount(this);">
             </td>
...
%>
       <td class="input" style="width:4%" style="align:center">
           <input type="text" name="prpLclaimLossItemKindNo" readonly="readonly"  class="readonly" value="<bean:write name='claimLoss' property='itemKindNo'/>">
       </td>
       <td class="input" style="width:26%" style="align:center">
 <%
 			if(!prpLclaimDto.getRiskCode().equals("1003")&&!prpLclaimDto.getRiskCode().equals("1004")&&!prpLclaimDto.getRiskCode().equals("0908")&&!prpLclaimDto.getClassCode().equals("11")){
 %>
...
%>
				 <input type="input" name="prpLclaimLossKindCode" class="codecode" <%=displayType%> style="width:20%" title="险别代码"
                      <%if (editType.equals("ADD")||editType.equals("EDIT")){%>
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode', '1,-1,4','code','none','post');" 
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode', '1,-1,4','code','none','post');" 
                       onchange="setFlagDanger();"
                      <%}%>
                      value="<bean:write name='claimLoss' property='kindCode'/>">
                 <input type="input" name="prpLclaimLossKindName" class="codecode" <%=displayType%> style="width:70%" title="险别名称"
                      <%if (editType.equals("ADD")||editType.equals("EDIT")){%>
                      ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,-2,3','always','none','post');"
                      onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1,-2,3','always','none','post');"
                       onchange="setFlagDanger();"
                       <%}%>
                      value="<bean:write name='claimLoss' property='kindName'/>">
                 <input type='hidden' name='prpLclaimLossItemCode' class="codecode" style="width:20%" title="标的代码" value="<bean:write name='claimLoss' property='itemCode' filter='true'/>"
                            ondblclick="code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','1,2,3');"
                            onkeyup= "code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','1,2,3');">
               <input type='hidden' name="prpLclaimLossItemDetailName" class="codename"  style="width:70%" title="标的名称" value="<bean:write name='claimLoss' property='itemDetailName' filter='true'/>"
                            ondblclick="code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','-1,1,2','always','none','post');"
        		    onkeyup= "code_CodeSelect(this, 'PolicyItemKindCodeNoRisk','-1,1,2','always','none','post');">
<% 				
 			}
%>        
         ...
         */%>
         ...
         <td class="input" style="width:16%">
             <input name="prpLclaimLossSumClaim" class="<%=strReadonly%>" <%=displayType%> style="text-align:right" value="<bean:write name='claimLoss' property='sumClaim' format="0.00" />"  onblur=" collectClaimLoss();return checkBeyondSumAmount(this);"
              onchange="setFlagDanger();">
         </td>
         ...
         <td class="input" style="width:8%">                
                  <input name="prpLclaimLossKindRest" class="<%=strReadonly%>" style="width:50px" value="<bean:write name='claimLoss' property='kindRest' format="0.00" />">
          </td> 
         
         <td class="input" style="width:10%">
             <input name="prpLclaimLossInputDate" class="readonly" readonly onblur="checkFullDate(this)" style="width:85px" maxlength="10" value="<bean:write name='claimLoss' property='inputDate' />">
         </td>
         <td class="input" style="width:10%;display:none">
