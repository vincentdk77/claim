...
<input title="点击此处可获得已出险相关信息"  type=button ACCESSKEY="." value='...' class="button" name='button_Peril_Open_Context' onclick="buttonOnClickAgriCheck('perilInfoShow',fm.policyno.value,fm.registno.value);">
     ...
     <%-- <logic:notEmpty  name="prpLregistDto1"  property="registList"> 
      ...
      <tr>  
        <td colspan=14 class="prompttitle" >
          <input type=button name = 'button_Peril_Close_Context'  class="button" value='(O)关闭'  ACCESSKEY="O" onclick="hideSubPage(this,'span_Peril_Context')">  
        </td> 
      </tr>
  </table>        
</span>
