...
<!--modify by liuyanmei add 20051114 end-->
	...
	<tr>
	   ...
	   <!--modify by wangwei update start 2005-06-21-->
	   <!--原因：向函数中添加参数-->
	   <td>
	   ...
	   <td width="70%" align="right"><font color="#666666">　
	       注：“<font color="#FF0000">*</font>”为必选项，“<img src="/claim/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">” 
	      为双击选择项。</font>
	   </td>
	   <!--modify by wangwei update end 2005-06-21-->
     ...
     <tr>
      ...
      <tr>
        ...
        <td class="input">
          ...
          <input  name="prpLclaimDamageStartHour" title="出险小时" class="readonly"  readonly="true" maxlength="2" style="width:20px" value="<bean:write name='prpLclaimDto' property='damageStartHour' filter='true' />">时
