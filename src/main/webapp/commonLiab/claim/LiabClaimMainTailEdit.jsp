      <tr>  
        ...
        <td class="input" colspan="3">
          ...
          <input type="text" onblur="checkFullDate(this)"   style="width:30%" name="prpLclaimClaimDate" description="立案日期" value="<bean:write name='prpLclaimDto' property='claimDate' filter='true' />">
        </td> 
      </tr>
      <tr>        
      ...
      <tr>
        ...
        <td class='input' >
          ...
          <input name="prpLclaimHandlerName" class="readonly" readonly style="width:35%"  title="经办人" value="<bean:write name='prpLclaimDto' property='handlerName' filter='true' />">
        </td>
      </tr>
