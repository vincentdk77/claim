...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  ...
  <tr> 
    ...
    <td class="title"  style="width:15%"> 费用:</td>
  ...
  <tr> 
    ...
    <td class="input"> <input class="readonly" type=text readonly="true"  style="width:150px" name="prpLcompensateSumRest" value="<bean:write name='prpLcompensateDto' property='sumRest' format='##0.00'/>"> 
    </td>
  </tr>
