...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  <tr> 
    <td class="title" colspan="2" style="width:100%">赔款计算书 
      ...
      <!--modify by qinyongli 2005-07-21 start 增加股东业务-->
  ...
  if(recaseFlag.equals("0")||editType.equals("SHOW")){%>
    ...
    <td class="input" colspan="3">
    <input type="radio" onclick="changePrpLcompensateFinallyFlag()"  name="prpLcompensateFinallyFlag" value="1" >是 
    <input type="radio" disabled onclick="changePrpLcompensateFinallyFlag()"  name="prpLcompensateFinallyFlag" value="0" checked>否 
    </td>
    </tr>
    <%}%>
<logic:notEmpty name="coinsFlag"  >
