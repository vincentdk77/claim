        ...
        <tr >
          <td class="common" colspan="4">
            <img style="cursor:hand;" src="/claim/images/butCollapseBlue.gif"
                 name="PersonImg" onclick="showPage(this,spanPerson)">人员伤亡赔付信息<br>
            <span style="display:none"> 
            ...
            <tbody> 
                <tr>
                  ...
                  <td class="input" style="width:35%">
                    <input type=text class='codecode' style="width:160px" name="prpLpersonLossPersonName" value=""
                    maxlength=20 description="人员姓名"
                     ondblclick="code_CodeSelect(this, 'prpCinsuredVirturlItem','0,1,2','name','post','clear');"
                   onkeyup= "code_CodeSelect(this, 'prpCinsuredVirturlItem','0,1,2','name','post','clear');"
                   onblur= "code_CodeChange(this, 'prpCinsuredVirturlItem','0,1,2','name','post','clear');">
