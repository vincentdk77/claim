...
<head>
  ...
  <script src="/claim/commonLiab/endcase/js/LiabEndcaseEdit.js"></script>
</head>
...
%>
    ...
    <input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="<%= session.getAttribute("org.apache.struts.action.TOKEN") %>">
      ...
      <%-- 1.结案主信息 --%>
      <%@include file="/commonLiab/endcase/LiabEndcaseMainEdit.jsp" %>
      <%-- 4.结案文本信息 --%>
      <%@include file="/commonLiab/endcase/LiabEndcaseTextEdit.jsp"%>
      <%-- 保存通用按钮 --%>
      <%@include file="/commonLiab/endcase/LiabEndcaseSave.jsp"%>
      <%-- 案件互查返回按鈕--%>
