...
--%>
    ...
    <tr>
       ...
       <td><input type="button" name="message" value="讨论留言"  class="bigbutton" onclick="openWinSave()"></td><td><input type="button" name="messageView" class="bigbutton" value="查看留言" onclick="openWinQuery()"></td><td width="70%" align="right"><font color="#666666">　注：“<font color="#FF0000">*</font>”为必选项，“<img src="/claim/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">” 
      为双击选择项。</font></td>
    </tr>
    </table>
