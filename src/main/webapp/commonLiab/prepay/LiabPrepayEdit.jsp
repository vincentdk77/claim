...
%>
  <form name=fm action="/claim/prepaySave.do" method="post" onsubmit="return validateForm(this);">
    ...
    <%-- 1.预赔主信息 --%>
    <%@include file="/commonLiab/prepay/LiabPrepayMainEdit.jsp" %>
    <%-- 4.预赔备注信息 --%>
    <%@include file="/commonLiab/prepay/LiabPrepayTextEdit.jsp"%>
    <%-- 保存通用按钮 --%>
    <%@include file="/commonLiab/prepay/LiabPrepaySave.jsp"%>
  </form>
</body>
