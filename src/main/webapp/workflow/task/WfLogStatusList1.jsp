...
<%   
String riskCodeOld=(String)request.getAttribute("riskCode");
String riskClaimTypeOld=(String)request.getAttribute("RiskClaimType");
...
%> 
<%@page import="com.sinosoft.claim.dto.custom.WorkFlowQueryDto"%>
...
<head>
  ...
  //  }
  //}
       if(fm.RiskClaimType!=null&&fm.RiskClaimType.value=="")
       {
           alert("请选择险类");
           return false;
       }
       if(fm.RiskCode!=null&&fm.RiskCode.value=="")
       {
           alert("险种不能为空");
           return false;
       }
    ...
    <tr>  <td colspan=4 class="formtitle">查询条件</td></tr>
      <tr>
        ...
        <td class='input' >
          ...
          <select name="RiskClaimType" class="query" style="width: 70%" onchange="buildRiskCodeSelect(fm.RiskClaimType, fm.RiskCode);">
      ...
      var  count = fm.RiskClaimType.length;
        ...
        <td class='input' >
          <select class=tag name="PolicyNoSign"  value="<%=searchContentSign2%>">
            <option value="*">*</option>
            <option value="=" <%=signselect%>>=</option>
          </select> <input type=text name="PolicyNo" class="query"  style="width:70%"   value="<%=searchContent2%>">
        </td>
       <td class='title' rowspan="3">险种：</td>
        <td class="input" rowspan="3">
            ...
            <select class="common" name="RiskCode" size="7" >
            </select>
        </td>
          </tr>
      <!--------------------增加被保险人，报案号查询-start---------------------------------------------->
...
%>        
      ...
      <% if (searchLabel.equals("compensateNo") && nodeType.equals("compp") ) { %>
         ...
         <td class='input'>
          <select class=tag name="ComppRegistNoSign"  value="<%=searchContentSign6%>">
            <option value="*">*</option>
            <option value="=" <%=signselect%>>=</option>
          </select> <input type=text name="ComppRegistNo" class="query"  style="width:70%"   value="<%=searchContent6%>">
        </td>
       ...
       <% }else if (searchLabel.equals("claimNo") && nodeType.equals("claim") ) { %>
         ...
         <td class='input'>
          <select class=tag name="ClaimRegistNoSign"  value="<%=searchContentSign4%>">
            <option value="*">*</option>
            <option value="=" <%=signselect%>>=</option>
          </select> <input type=text name="ClaimRegistNo" class="query"  style="width:70%"   value="<%=searchContent4%>">
        </td>
       ...
       <% } else if (searchLabel.equals("claimNo") && nodeType.equals("endca") ) {  %>
         ...
         <td class='input'>
          <select class=tag name="EndcaRegistNoSign"  value="<%=searchContentSign7%>">
            <option value="=" <%=signselect%>>=</option>
          </select> <input type=text name="EndcaRegistNo" class="query"  style="width:70%"   value="<%=searchContent7%>">
        </td>
      ...
      <tr>
         ...
         <td class='title'><%=subTitleTime%>:</td>
         <td class='input' >
 ...
 <%
  ...
  <script language="javascript">
    ...
    for(var i=0; i<riskCategory.length; i++){
        if(riskCategory.item(i).value=="<%=riskClaimTypeOld%>"){
            riskCategory.item(i).selected = true;
        }
    }
    fm.RiskClaimType.onchange();
    var riskCodeField = fm.RiskCode;
    for(var i=0; i<riskCodeField.length; i++){
        if(riskCodeField.item(i).value=="<%=riskCodeOld%>"){
