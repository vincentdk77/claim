...
%>
     <tr class=common>   <td align="center"> <a href="/claim/swfModelCondStep2Query.do?editType=SHOW&modelNo=<bean:write name='modelMainList1' property='modelNo'/>"><bean:write name='modelMainList1' property='modelNo'/></a></td>
