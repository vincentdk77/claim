 ...
 * 这是TEMBLORENDORCHGDETAIL的数据传输对象基类<br>
 */
public class TemblorendorchgdetailDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorendorchgdetailDtoBase对象
     */
    public TemblorendorchgdetailDtoBase(){
    }
