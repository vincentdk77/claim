 ...
 * 这是NYXPOLICYLISTORIGIN的数据传输对象基类<br>
 */
public class NyxpolicylistoriginDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的NyxpolicylistoriginDtoBase对象
     */
    public NyxpolicylistoriginDtoBase(){
    }
