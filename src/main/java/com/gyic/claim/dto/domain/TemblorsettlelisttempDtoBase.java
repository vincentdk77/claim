 ...
 * 这是TEMBLORSETTLELISTTEMP的数据传输对象基类<br>
 */
public class TemblorsettlelisttempDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorsettlelisttempDtoBase对象
     */
    public TemblorsettlelisttempDtoBase(){
    }
