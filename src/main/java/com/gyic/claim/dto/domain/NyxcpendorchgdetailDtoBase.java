 ...
 * 这是NYXCPENDORCHGDETAIL的数据传输对象基类<br>
 */
public class NyxcpendorchgdetailDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的NyxcpendorchgdetailDtoBase对象
     */
    public NyxcpendorchgdetailDtoBase(){
    }
