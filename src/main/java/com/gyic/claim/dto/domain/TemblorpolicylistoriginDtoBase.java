 ...
 * 这是TEMBLORPOLICYLISTORIGIN的数据传输对象基类<br>
 */
public class TemblorpolicylistoriginDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorpolicylistoriginDtoBase对象
     */
    public TemblorpolicylistoriginDtoBase(){
    }
