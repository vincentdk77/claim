 ...
 * 这是NYXENDORCHGDETAIL的数据传输对象基类<br>
 */
public class NyxendorchgdetailDtoBase implements Serializable{
    ...
    /** 属性CHGINSUREAREA */
    private double chginsurearea = 0D;
    /** 属性CHGSUMAMOUNT */
    private double chgsumamount = 0D;
    /** 属性CHGSUMPREMIUM */
    private double chgsumpremium = 0D;
    /** 属性CHGAREANUMBER */
    private double chgareanumber = 0D;
    /** 属性CHGINSURENUMBER */
    private long chginsurenumber = 0L;
    /** 属性FLAG */
    private String flag = "";
    /** 属性AREANUMBER */
    ...
    /**
     *  默认构造方法,构造一个默认的NyxendorchgdetailDtoBase对象
     */
    public NyxendorchgdetailDtoBase(){
    }
    ...
    /**
     * 设置属性CHGINSUREAREA
     * @param chginsurearea 待设置的属性CHGINSUREAREA的值
     */
    ...
    /**
     * 设置属性CHGSUMAMOUNT
     * @param chgsumamount 待设置的属性CHGSUMAMOUNT的值
     */
    ...
    /**
     * 设置属性CHGSUMPREMIUM
     * @param chgsumpremium 待设置的属性CHGSUMPREMIUM的值
     */
    ...
    /**
     * 设置属性CHGAREANUMBER
     * @param chgareanumber 待设置的属性CHGAREANUMBER的值
     */
    ...
    /**
     * 设置属性CHGINSURENUMBER
     * @param chginsurenumber 待设置的属性CHGINSURENUMBER的值
     */
    public void setChginsurenumber(long chginsurenumber){
        this.chginsurenumber = chginsurenumber;
    }

    /**
     * 获取属性CHGINSURENUMBER
     * @return 属性CHGINSURENUMBER的值
     */
    public long getChginsurenumber(){
