 ...
 * 这是NYXINSURANCELIST的数据传输对象基类<br>
 */
public class NyxinsurancelistDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的NyxinsurancelistDtoBase对象
     */
    public NyxinsurancelistDtoBase(){
    }
