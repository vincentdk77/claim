 ...
 * 这是ZH03PolicyList的数据传输对象基类<br>
 */
public class Zh03PolicyListDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的Zh03PolicyListDtoBase对象
     */
    public Zh03PolicyListDtoBase(){
    }
