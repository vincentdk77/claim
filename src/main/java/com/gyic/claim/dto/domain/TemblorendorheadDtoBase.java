 ...
 * 这是TEMBLORENDORHEAD的数据传输对象基类<br>
 */
public class TemblorendorheadDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorendorheadDtoBase对象
     */
    public TemblorendorheadDtoBase(){
    }
