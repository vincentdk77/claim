 ...
 * 这是TEMBLORINSURANCELIST的数据传输对象基类<br>
 */
public class TemblorinsurancelistDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorinsurancelistDtoBase对象
     */
    public TemblorinsurancelistDtoBase(){
    }
