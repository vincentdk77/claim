 ...
 * 这是TEMBLORCPENDORCHGDETAIL的数据传输对象基类<br>
 */
public class TemblorcpendorchgdetailDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的TemblorcpendorchgdetailDtoBase对象
     */
    public TemblorcpendorchgdetailDtoBase(){
    }
