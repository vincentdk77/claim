...
public class BLSwfLogActionBase{
     ...
     * @author qianxiantao
     */
    public SwfLogDto findByRegistNo(DBManager dbManager,String registNo) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        //声明DTO
        SwfLogDto swfLogDto = null;
        //查询数据,赋值给DTO
        swfLogDto = dbSwfLog.findByRegistNo(registNo);
        return swfLogDto;
    }
     ...
     * @throws Exception
     */
    public PageRecord findByPolicyNo(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        ...
        int count = dbSwfLog.getComBineCount(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findByPolicyNo(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
    /**
     ...
     * @throws Exception
     */
    public PageRecord findByComBineNo(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        int count = dbSwfLog.getComBineCountByComBineNo(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findEditeByComBineNo(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
    /**
     ...
     * @throws Exception
     */
    public PageRecord findByRegistNo(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        int count = dbSwfLog.getComBineCountByRegistNo(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findEditeByRegistNo(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
    /**
    ...
    public PageRecord findBypolicyNo(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        int count = dbSwfLog.getComBineCountByPolicyNo(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findEditeByPolicyNo(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
    /**
     ...
     * @throws Exception
     */
    public PageRecord findCompensateListByConditions(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        int count = dbSwfLog.getcompensateCount(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findCompensateListByConditions(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
    /**
     ...
     * @throws Exception
     */
    public PageRecord findComBineListByCondition(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        DBSwfLog dbSwfLog = new DBSwfLog(dbManager);
        Collection collection = new ArrayList();
        int count = dbSwfLog.getComBineCountByConditions(SqlUtils.getWherePartForGetCount(conditions));
        int maxQueryCount = Integer.parseInt(DataUtils.nullToZero(AppConfig
				.get("sysconst.MaxQueryCount")));
        ...
        collection = dbSwfLog.findEditeByConditions(conditions,pageNo,rowsPerPage);
        PageRecord pageRecord = new PageRecord(count,pageNo,1,rowsPerPage,collection);
        return pageRecord;
    }
}
