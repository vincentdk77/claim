...
public class UIPlanting31SettleImportAction extends Action
{
	public ActionForward execute(ActionMapping actionMapping,
		...
		try {
			...
			UIClaimPlanting31SettleLoadFacade uiPlanting31SettleLoadFacade = new UIClaimPlanting31SettleLoadFacade();
