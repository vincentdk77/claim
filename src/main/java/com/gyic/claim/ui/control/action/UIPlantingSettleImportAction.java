...
public class UIPlantingSettleImportAction extends Action
{
	public ActionForward execute(ActionMapping actionMapping,
		...
		try {
			...
			UIClaimPlantingSettleLoadFacade uiPlantingSettleLoadFacade = new UIClaimPlantingSettleLoadFacade();
			mappingRes= uiPlantingSettleLoadFacade.plantingLoadAct(httpServletRequest, rootPath,loadForm);
