 ...
 */
public class AgriCombineRegistViewHelper extends RegistViewHelper {
//	private static Log log = LogFactory.getLog(DAARegistViewHelper.class);
	 ...
	 * 默认构造方法
	 */
	public AgriCombineRegistViewHelper() {
	}
	...
	public RegistDto viewToDto(HttpServletRequest httpServletRequest)
		...
		if ("I".equals(strRiskType)|| "Q".equals(strRiskType)|| "Z".equals(strRiskType)|| "Y".equals(strRiskType)) {
