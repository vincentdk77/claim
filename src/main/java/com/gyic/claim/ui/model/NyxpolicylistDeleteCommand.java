 ...
 */
public class NyxpolicylistDeleteCommand extends BaseCommand{
    ...
    /**
     * 构造方法,构造一个NyxpolicylistDeleteCommand对象
     ...
     * @throws Exception
     */
    public NyxpolicylistDeleteCommand(String inusrelistcode ,String businessno ,String kindcode ,String itemcode)
            throws Exception{
