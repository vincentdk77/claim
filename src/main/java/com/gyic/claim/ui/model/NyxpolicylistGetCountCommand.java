 ...
 */
public class NyxpolicylistGetCountCommand extends BaseCommand{
    private String stringConditions;
    /**
     * 构造方法,构造一个NyxpolicylistGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public NyxpolicylistGetCountCommand(String conditions)
            throws Exception{
