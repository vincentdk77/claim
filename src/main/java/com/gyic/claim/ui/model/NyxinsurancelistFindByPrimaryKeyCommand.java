 ...
 */
public class NyxinsurancelistFindByPrimaryKeyCommand extends BaseCommand{
    ...
    /**
     * 构造方法,构造一个NyxinsurancelistFindByPrimaryKeyCommand对象
     ...
     * @throws Exception
     */
    public NyxinsurancelistFindByPrimaryKeyCommand(String inusrelistcode ,String businessno ,String kindcode ,String itemcode)
            throws Exception{
