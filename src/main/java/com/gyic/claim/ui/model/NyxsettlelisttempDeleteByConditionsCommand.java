 ...
 */
public class NyxsettlelisttempDeleteByConditionsCommand extends BaseCommand{
    private String stringConditions;
    /**
     * 构造方法,构造一个NyxsettlelisttempDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public NyxsettlelisttempDeleteByConditionsCommand(String conditions)
            throws Exception{
