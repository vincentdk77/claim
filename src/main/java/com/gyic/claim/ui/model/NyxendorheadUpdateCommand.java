 ...
 */
public class NyxendorheadUpdateCommand extends BaseCommand{
    private NyxendorheadDto nyxendorheadDtoNyxendorheadDto;
    /**
     * 构造方法,构造一个NyxendorheadUpdateCommand对象
     * @param nyxendorheadDto 参数nyxendorheadDto
     * @throws Exception
     */
    public NyxendorheadUpdateCommand(NyxendorheadDto nyxendorheadDto)
            throws Exception{
    ...
    private Object executeCommandNyxendorheadDtoImpl()
        ...
        facade.update(nyxendorheadDtoNyxendorheadDto);
        return null;
    }
    /**
