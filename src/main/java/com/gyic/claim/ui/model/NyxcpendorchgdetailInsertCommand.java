 ...
 */
public class NyxcpendorchgdetailInsertCommand extends BaseCommand{
    private NyxcpendorchgdetailDto nyxcpendorchgdetailDtoNyxcpendorchgdetailDto;
    /**
     * 构造方法,构造一个NyxcpendorchgdetailInsertCommand对象
     * @param nyxcpendorchgdetailDto 参数nyxcpendorchgdetailDto
     * @throws Exception
     */
    public NyxcpendorchgdetailInsertCommand(NyxcpendorchgdetailDto nyxcpendorchgdetailDto)
            throws Exception{
    ...
    private Object executeCommandNyxcpendorchgdetailDtoImpl()
        ...
        facade.insert(nyxcpendorchgdetailDtoNyxcpendorchgdetailDto);
        return null;
    }
    /**
