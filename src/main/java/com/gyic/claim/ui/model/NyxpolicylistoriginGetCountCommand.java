 ...
 */
public class NyxpolicylistoriginGetCountCommand extends BaseCommand{
    private String stringConditions;
    /**
     * 构造方法,构造一个NyxpolicylistoriginGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public NyxpolicylistoriginGetCountCommand(String conditions)
            throws Exception{
