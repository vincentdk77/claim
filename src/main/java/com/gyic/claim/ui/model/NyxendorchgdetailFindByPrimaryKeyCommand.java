 ...
 */
public class NyxendorchgdetailFindByPrimaryKeyCommand extends BaseCommand{
    ...
    /**
     * 构造方法,构造一个NyxendorchgdetailFindByPrimaryKeyCommand对象
     ...
     * @throws Exception
     */
    public NyxendorchgdetailFindByPrimaryKeyCommand(String inusrelistcode ,String businessno ,String endorseno ,String kindcode ,String itemcode)
            throws Exception{
    ...
    private Object executeCommandStringStringStringStringStringImpl()
        ...
        return facade.findByPrimaryKey(stringInusrelistcode ,stringBusinessno ,stringEndorseno ,stringKindcode ,stringItemcode);
    }
    /**
