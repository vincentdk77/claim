 ...
 */
public class NyxcpendorchgdetailDeleteByConditionsCommand extends BaseCommand{
    private String stringConditions;
    /**
     * 构造方法,构造一个NyxcpendorchgdetailDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public NyxcpendorchgdetailDeleteByConditionsCommand(String conditions)
            throws Exception{
