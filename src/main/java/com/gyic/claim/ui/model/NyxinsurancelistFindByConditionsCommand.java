 ...
 */
public class NyxinsurancelistFindByConditionsCommand extends BaseCommand{
    private String type; //用于标识方法类型
    private int intRowsPerPage;
    private int intPageNo;
    private String stringConditions;
    /**
     * 构造方法,构造一个NyxinsurancelistFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public NyxinsurancelistFindByConditionsCommand(String conditions)
            throws Exception{
     ...
     * @throws Exception
     */
    public NyxinsurancelistFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage)
            throws Exception{
