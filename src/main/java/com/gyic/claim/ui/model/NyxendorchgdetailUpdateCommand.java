 ...
 */
public class NyxendorchgdetailUpdateCommand extends BaseCommand{
    private NyxendorchgdetailDto nyxendorchgdetailDtoNyxendorchgdetailDto;
    /**
     * 构造方法,构造一个NyxendorchgdetailUpdateCommand对象
     * @param nyxendorchgdetailDto 参数nyxendorchgdetailDto
     * @throws Exception
     */
    public NyxendorchgdetailUpdateCommand(NyxendorchgdetailDto nyxendorchgdetailDto)
            throws Exception{
    ...
    private Object executeCommandNyxendorchgdetailDtoImpl()
        ...
        facade.update(nyxendorchgdetailDtoNyxendorchgdetailDto);
        return null;
    }
    /**
