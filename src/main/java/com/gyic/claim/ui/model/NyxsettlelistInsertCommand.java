 ...
 */
public class NyxsettlelistInsertCommand extends BaseCommand{
    private NyxsettlelistDto nyxsettlelistDtoNyxsettlelistDto;
    /**
     * 构造方法,构造一个NyxsettlelistInsertCommand对象
     * @param nyxsettlelistDto 参数nyxsettlelistDto
     * @throws Exception
     */
    public NyxsettlelistInsertCommand(NyxsettlelistDto nyxsettlelistDto)
            throws Exception{
    ...
    private Object executeCommandNyxsettlelistDtoImpl()
        ...
        facade.insert(nyxsettlelistDtoNyxsettlelistDto);
        return null;
    }
    /**
