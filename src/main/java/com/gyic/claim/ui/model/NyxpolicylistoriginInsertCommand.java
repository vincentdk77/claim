 ...
 * 这是BLNyxpolicylistoriginFacade的UI Command类，用于集中式部署<br>
 */
public class NyxpolicylistoriginInsertCommand extends BaseCommand{
    private NyxpolicylistoriginDto nyxpolicylistoriginDtoNyxpolicylistoriginDto;
    /**
     * 构造方法,构造一个NyxpolicylistoriginInsertCommand对象
     * @param nyxpolicylistoriginDto 参数nyxpolicylistoriginDto
     * @throws Exception
     */
    public NyxpolicylistoriginInsertCommand(NyxpolicylistoriginDto nyxpolicylistoriginDto)
            throws Exception{
    ...
    private Object executeCommandNyxpolicylistoriginDtoImpl()
        ...
        facade.insert(nyxpolicylistoriginDtoNyxpolicylistoriginDto);
        return null;
    }
    /**
