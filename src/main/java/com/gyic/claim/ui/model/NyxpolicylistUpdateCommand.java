 ...
 */
public class NyxpolicylistUpdateCommand extends BaseCommand{
    private NyxpolicylistDto nyxpolicylistDtoNyxpolicylistDto;
    /**
     * 构造方法,构造一个NyxpolicylistUpdateCommand对象
     * @param nyxpolicylistDto 参数nyxpolicylistDto
     * @throws Exception
     */
    public NyxpolicylistUpdateCommand(NyxpolicylistDto nyxpolicylistDto)
            throws Exception{
    ...
    private Object executeCommandNyxpolicylistDtoImpl()
        ...
        facade.update(nyxpolicylistDtoNyxpolicylistDto);
        return null;
    }
    /**
