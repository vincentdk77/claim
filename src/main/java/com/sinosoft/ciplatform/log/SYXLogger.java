package com.sinosoft.ciplatform.log;
...
public class SYXLogger {
	public static String logPath = AppConfig.get("sysconst.SYXLOGPATH");
	...
	public static synchronized void error(Exception e){
		...
		try{
			...
			pw.flush();
			in = new RandomAccessFile(filePath + File.separator + "syx.log", "rw");
		    in.seek(in.length());
