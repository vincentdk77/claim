 ...
 */
public class PrpTaskUpdateCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpTaskUpdateCommand对象
     * @param prpTaskDto 参数prpTaskDto
     * @throws Exception
     */
    public PrpTaskUpdateCommand(PrpTaskDto prpTaskDto) throws Exception {
