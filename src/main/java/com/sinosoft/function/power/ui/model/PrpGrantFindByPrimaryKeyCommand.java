 ...
 */
public class PrpGrantFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpGrantFindByPrimaryKeyCommand对象
     ...
     * @throws Exception
     */
    public PrpGrantFindByPrimaryKeyCommand(String userCode ,String groupCode ,String taskCode ,String checkCode ,DateTime grantStartDate ,DateTime grantEndDate) throws Exception {
