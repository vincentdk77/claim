 ...
 * 创建于 2004-11-09 10:40:57.903<br>
 * JToolpad(1.2.14) Vendor:zhouxianli@sinosoft.com.cn
 */
public class PrpGrantFindByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpGrantFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @param pageNo 参数pageNo
     * @param rowsPerPage 参数rowsPerPage
     * @throws Exception
     */
    public PrpGrantFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage) throws Exception {
     ...
     * @throws Exception
     */
    public PrpGrantFindByConditionsCommand(String conditions) throws Exception {
