 ...
 */
public class UtiGroupDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个UtiGroupDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public UtiGroupDeleteByConditionsCommand(String conditions) throws Exception {
