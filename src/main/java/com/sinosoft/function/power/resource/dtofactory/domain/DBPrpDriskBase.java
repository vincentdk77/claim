...
public class DBPrpDriskBase{
    ...
    public void insert(PrpDriskDto prpDriskDto) throws Exception{
        ...
        dbManager.setString(5,prpDriskDto.getGroupCode());
        dbManager.setDouble(6,prpDriskDto.getCalculator());
        dbManager.setString(7,prpDriskDto.getEndDateFlag());
        dbManager.setString(8,prpDriskDto.getRiskFlag());
        dbManager.setDouble(9,prpDriskDto.getStartHour());
        ...
        dbManager.setString(14,prpDriskDto.getSettleType());
        dbManager.setString(15,prpDriskDto.getFlag());
    ...
    public void update(PrpDriskDto prpDriskDto) throws Exception{
        ...
        if(logger.isDebugEnabled()){
            String debugStatement = "Update PrpDrisk Set " + 
                           ...
                           " GroupCode = '" + prpDriskDto.getGroupCode() + "'," + 
                           ...
                           " SettleType = '" + prpDriskDto.getSettleType() + "'," + 
        ...
        dbManager.setString(4,prpDriskDto.getGroupCode());
        dbManager.setDouble(5,prpDriskDto.getCalculator());
        dbManager.setString(6,prpDriskDto.getEndDateFlag());
        dbManager.setString(7,prpDriskDto.getRiskFlag());
        dbManager.setDouble(8,prpDriskDto.getStartHour());
        ...
        //设置条件字段;
        dbManager.setString(15,prpDriskDto.getRiskCode());
        dbManager.executePreparedUpdate();
    ...
    public PrpDriskDto findByPrimaryKey(String riskCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDriskDto.setGroupCode(dbManager.getString(resultSet,5));
            prpDriskDto.setCalculator(dbManager.getDouble(resultSet,6));
            prpDriskDto.setEndDateFlag(dbManager.getString(resultSet,7));
            prpDriskDto.setRiskFlag(dbManager.getString(resultSet,8));
            prpDriskDto.setStartHour(dbManager.getDouble(resultSet,9));
            prpDriskDto.setNewRiskCode(dbManager.getString(resultSet,10));
            prpDriskDto.setValidStatus(dbManager.getString(resultSet,11));
            prpDriskDto.setArticleCode(dbManager.getString(resultSet,12));
            prpDriskDto.setManageFlag(dbManager.getString(resultSet,13));
            prpDriskDto.setSettleType(dbManager.getString(resultSet,14));
            prpDriskDto.setFlag(dbManager.getString(resultSet,15));
        }
        resultSet.close();
