...
import com.sinosoft.function.power.bl.action.domain.BLPrpDriskAction;
 ...
 * 创建于 2004-11-09 10:40:55.470<br>
...
public class BLPrpDriskFacadeBase{
    ...
    public Collection findByConditions(String conditions) throws Exception{
        ...
        try{
            dbManager.open(AppConfig.get("sysconst.DBJNDI")); //打开连接池
            collection = blPrpDriskAction.findByConditions(dbManager,conditions);
        }catch(Exception exception){
            throw exception;
        }finally{
            dbManager.close();
