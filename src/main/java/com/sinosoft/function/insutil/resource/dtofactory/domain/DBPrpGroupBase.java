...
public class DBPrpGroupBase{
     ...
     * @throws Exception
     */
    public Collection findByConditionsByPrepered(String conditions,int pageNo,int rowsPerPage,String GroupNo) throws Exception{
        String statement = "Select GroupNo," + 
                           " SubGroupNo," + 
                           " Flag From PrpGroup Where " + conditions;
        log.debug(statement);
