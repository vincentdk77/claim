...
public class DBPrpDshipBase{
    ...
    public void insert(PrpDshipDto prpDshipDto) throws Exception{
        ...
        dbManager.setDateTime(8,prpDshipDto.getBuildDate());
    ...
    public void update(PrpDshipDto prpDshipDto) throws Exception{
        ...
        dbManager.setDateTime(7,prpDshipDto.getBuildDate());
    ...
    public PrpDshipDto findByPrimaryKey(String shipCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDshipDto.setBuildDate(dbManager.getDateTime(resultSet,DateTime.YEAR_TO_DAY,8));
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(*) from PrpDship Where " + conditions;
        log.debug(statement);
        ResultSet resultSet = dbManager.executeQuery(statement);
        resultSet.next();
