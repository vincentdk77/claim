...
public class DBPrpDlimitBase{
    ...
    public void insert(PrpDlimitDto prpDlimitDto) throws Exception{
        ...
        dbManager.setString(6,prpDlimitDto.getKindCode());
        dbManager.setString(7,prpDlimitDto.getItemCode());
        dbManager.setString(8,prpDlimitDto.getModeCode());
        dbManager.setDouble(9,prpDlimitDto.getLimitFee());
    ...
    public void update(PrpDlimitDto prpDlimitDto) throws Exception{
        ...
        dbManager.setString(4,prpDlimitDto.getKindCode());
        dbManager.setString(5,prpDlimitDto.getItemCode());
        dbManager.setString(6,prpDlimitDto.getModeCode());
        dbManager.setDouble(7,prpDlimitDto.getLimitFee());
    ...
    public PrpDlimitDto findByPrimaryKey(String riskCode,String limitCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDlimitDto.setKindCode(dbManager.getString(resultSet,6));
            prpDlimitDto.setItemCode(dbManager.getString(resultSet,7));
            prpDlimitDto.setModeCode(dbManager.getString(resultSet,8));
            prpDlimitDto.setLimitFee(dbManager.getDouble(resultSet,9));
