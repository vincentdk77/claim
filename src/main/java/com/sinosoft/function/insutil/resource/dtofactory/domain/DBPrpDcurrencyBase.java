...
public class DBPrpDcurrencyBase{
    ...
    public void insert(PrpDcurrencyDto prpDcurrencyDto) throws Exception{
        ...
        dbManager.setString(5,prpDcurrencyDto.getAccBookCode());
        dbManager.setString(6,prpDcurrencyDto.getValidStatus());
        dbManager.setString(7,prpDcurrencyDto.getFlag());
    ...
    public void update(PrpDcurrencyDto prpDcurrencyDto) throws Exception{
        ...
        dbManager.setString(4,prpDcurrencyDto.getAccBookCode());
        dbManager.setString(5,prpDcurrencyDto.getValidStatus());
        dbManager.setString(6,prpDcurrencyDto.getFlag());
        //设置条件字段;
        dbManager.setString(7,prpDcurrencyDto.getCurrencyCode());
        dbManager.executePreparedUpdate();
    ...
    public PrpDcurrencyDto findByPrimaryKey(String currencyCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDcurrencyDto.setAccBookCode(dbManager.getString(resultSet,5));
            prpDcurrencyDto.setValidStatus(dbManager.getString(resultSet,6));
            prpDcurrencyDto.setFlag(dbManager.getString(resultSet,7));
        }
        resultSet.close();
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(*) from PrpDcurrency Where " + conditions;
        log.debug(statement);
        ResultSet resultSet = dbManager.executeQuery(statement);
        resultSet.next();
