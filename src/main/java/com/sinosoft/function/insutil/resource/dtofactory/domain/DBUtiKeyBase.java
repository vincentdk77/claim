...
public class DBUtiKeyBase{
    ...
    public void insert(UtiKeyDto utiKeyDto) throws Exception{
        ...
        dbManager.setString(4,utiKeyDto.getHeadID());
        dbManager.setInt(5,utiKeyDto.getColLength());
        dbManager.setString(6,utiKeyDto.getFlag());
    ...
    public void update(UtiKeyDto utiKeyDto) throws Exception{
        ...
        dbManager.setString(3,utiKeyDto.getHeadID());
        dbManager.setInt(4,utiKeyDto.getColLength());
        dbManager.setString(5,utiKeyDto.getFlag());
        //设置条件字段;
        dbManager.setString(6,utiKeyDto.getTableName());
        dbManager.executePreparedUpdate();
    ...
    public UtiKeyDto findByPrimaryKey(String tableName) throws Exception{
        ...
        if(resultSet.next()){
            ...
            utiKeyDto.setHeadID(dbManager.getString(resultSet,4));
            utiKeyDto.setColLength(dbManager.getInt(resultSet,5));
            utiKeyDto.setFlag(dbManager.getString(resultSet,6));
        }
        resultSet.close();
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(*) from UtiKey Where " + conditions;
        log.debug(statement);
        ResultSet resultSet = dbManager.executeQuery(statement);
        resultSet.next();
