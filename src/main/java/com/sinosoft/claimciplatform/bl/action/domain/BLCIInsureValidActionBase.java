...
import com.sinosoft.claimciplatform.resource.dtofactory.domain.DBCIInsureValid;
...
public class BLCIInsureValidActionBase{
    private static Log logger = LogFactory.getLog(BLCIInsureValidActionBase.class);
