 ...
 */
public class AgriClaimUploadLogFindByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个AGRICLAIMUPLOADLOGFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public AgriClaimUploadLogFindByConditionsCommand(String conditions)
            throws Exception{
     ...
     * @throws Exception
     */
    public AgriClaimUploadLogFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage)
            throws Exception{
