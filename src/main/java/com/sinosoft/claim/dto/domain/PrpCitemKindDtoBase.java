...
/**
 * 这是prpcitemkind标的子险信息的数据传输对象基类<br>
 * 创建于 2004-4-5 15:32:05<br>
 * JToolpad(1.2.3) Vendor:zhouxianli@sinosoft.com.cn
 */
public class PrpCitemKindDtoBase implements Serializable{
    /** 属性保单号码 */
    ...
    private String flag = "";
    /** 属性全损起赔点 */
    private double totalLossRatio =  0d;
    /** 属性起赔点 */
    private double triggerPoint =  0d;

    /**
     *  默认构造方法,构造一个默认的PrpCitemKindDtoBase对象
     */
    public PrpCitemKindDtoBase(){
    }
    ...
    /**
     * 设置属性全损起赔点
     * @param totalLossRate 待设置的属全损起赔点的值
     */
    ...
    /**
     * 设置属性起赔点
     * @param totalLossRate 待设置的属起赔点的值
     */
