 ...
 */
public class PrpLclaimStatustgDto extends PrpLclaimStatustgDtoBase implements Serializable{
  /**
     *  默认构造方法,构造一个默认的PrpLclaimStatustgDto对象
     */
    public PrpLclaimStatustgDto(){
    	 this.setBusinessNo("");
         this.setPolicyNo("") ;
         this.setNodeType ( "");
         this.setStatus("");
