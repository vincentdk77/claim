 ...
 */
public class PrpLcompensateDto extends PrpLcompensateDtoBase implements Serializable{
     ...
     * 免赔条件信息
     */
    private ArrayList prpLdeductCondDtoList;
	...
	public ArrayList getPrpLdeductCondDtoList() {
		return prpLdeductCondDtoList;
	}

	public void setPrpLdeductCondDtoList(ArrayList prpLdeductCondDtoList) {
		this.prpLdeductCondDtoList = prpLdeductCondDtoList;
	}

	/**
     *  默认构造方法,构造一个默认的PrpLcompensateDto对象
     */
    public PrpLcompensateDto(){
    }
  ...
  */
  ...
  //modify by luqin 2005-04-08 end
	...
	/**
	 * @return Returns the turnPageDto.
	 */
