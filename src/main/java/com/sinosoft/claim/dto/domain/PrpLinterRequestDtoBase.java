 ...
 * 这是大病医疗接口参数中间表主表的数据传输对象基类<br>
 */
public class PrpLinterRequestDtoBase implements Serializable{
    ...
    /** 属性报案接口交互标识(1成功0未) */
    private String registAutoFlag = "";
    /** 属性立案接口交互标识(1成功0未) */
    private String compeAutoFlag = "";
    /** 属性核赔结案接口交互标识(1成功0未) */
    private String claimAutoFlag = "";
    /** 属性报案时间 */
    private DateTime registTime = new DateTime();
    /** 属性立案时间 */
    private DateTime compeTime = new DateTime();
    /** 属性核赔时间 */
    ...
    /** 属性报案输入时间 */
    private DateTime inputRegistDate = new DateTime();
    /** 属性理算输入时间 */
    private DateTime inputCompeDate = new DateTime();
     ...
     */
    public PrpLinterRequestDtoBase(){
    }
    ...
    /**
     * 设置属性事故经过及事故现状
     * @param context 待设置的属性事故经过及事故现状的值
     */
    ...
    /**
     * 设置属性报损金额CNY
     * @param estimateLoss 待设置的属性报损金额CNY的值
     */
    ...
    /**
     * 设置属性调度查勘处理单位
     * @param scheduleObjectId 待设置的属性调度查勘处理单位的值
     */
    ...
    /**
     * 设置属性查勘人代码
     * @param nextHandlerCode 待设置的属性查勘人代码的值
     */
    ...
    /**
     * 设置属性查勘人名称
     * @param nextHandlerName 待设置的属性查勘人名称的值
     */
    ...
    /**
     * 设置属性查勘类型(查勘L代查D)
     * @param checkType 待设置的属性查勘类型(查勘L代查D)的值
     */
    ...
    /**
     * 设置属性查勘日期(yyyy-MM-dd)
     * @param checkDate 待设置的属性查勘日期(yyyy-MM-dd)的值
     */
    ...
    /**
     * 设置属性查勘性质(现场1其他9)
     * @param checkNature 待设置的属性查勘性质(现场1其他9)的值
     */
    ...
    /**
     * 设置属性查勘预估金额CNY
     * @param checkEstimateLoss 待设置的属性查勘预估金额CNY的值
     */
    ...
    /**
     * 设置属性预估费用
     * @param estimateFee 待设置的属性预估费用的值
     */
    ...
    /**
     * 设置属性查勘处理单位(内1，外0)
     * @param unitType 待设置的属性查勘处理单位(内1，外0)的值
     */
    ...
    /**
     * 设置属性查勘备注
     * @param checkRemark 待设置的属性查勘备注的值
     */
    ...
    /**
     * 设置属性查勘报告
     * @param checkContext 待设置的属性查勘报告的值
     */
    ...
    /**
     * 设置属性币别（默认CNY）
     * @param currency 待设置的属性币别（默认CNY）的值
     */
    ...
    /**
     * 设置属性事故类型名称
     * @param damageTypeName 待设置的属性事故类型名称的值
     */
    ...
    /**
     * 设置属性是否可能追偿(是1，否0)
     * @param replevyFlag 待设置的属性是否可能追偿(是1，否0)的值
     */
    ...
    /**
     * 设置属性是否其他理赔中介:是1否0
     * @param thirdComFlag 待设置的属性是否其他理赔中介:是1否0的值
     */
    ...
    /**
     * 设置属性案件类型代码
     * @param claimType 待设置的属性案件类型代码的值
     */
    ...
    /**
     * 设置属性申请预赔赔案类型选择
     * @param caseType 待设置的属性申请预赔赔案类型选择的值
     */
    ...
    /**
     * 设置属性预赔申请原因
     * @param payAppContext 待设置的属性预赔申请原因的值
     */
    ...
    /**
     * 设置属性预赔金额，默认0.00
     * @param sumPrePaid 待设置的属性预赔金额，默认0.00的值
     */
    ...
    /**
     * 设置属性预赔报告
     * @param prepayReport 待设置的属性预赔报告的值
     */
    ...
    /**
     * 设置属性单证案件处理意见
     * @param certifyContext 待设置的属性单证案件处理意见的值
     */
	...
	public String getRegistAutoFlag() {
		return registAutoFlag;
	}

	public void setRegistAutoFlag(String registAutoFlag) {
		this.registAutoFlag = registAutoFlag;
	}

	public String getCompeAutoFlag() {
		return compeAutoFlag;
	}

	public void setCompeAutoFlag(String compeAutoFlag) {
		this.compeAutoFlag = compeAutoFlag;
	}

	public String getClaimAutoFlag() {
		return claimAutoFlag;
	}

	public void setClaimAutoFlag(String claimAutoFlag) {
		this.claimAutoFlag = claimAutoFlag;
	}
	...
	public DateTime getCompeTime() {
		return compeTime;
	}

	public void setCompeTime(DateTime compeTime) {
	...
	public DateTime getInputRegistDate() {
		return inputRegistDate;
	}

	public void setInputRegistDate(DateTime inputRegistDate) {
		this.inputRegistDate = inputRegistDate;
	}

	public DateTime getInputCompeDate() {
		return inputCompeDate;
	}

	public void setInputCompeDate(DateTime inputCompeDate) {
		this.inputCompeDate = inputCompeDate;
	}
