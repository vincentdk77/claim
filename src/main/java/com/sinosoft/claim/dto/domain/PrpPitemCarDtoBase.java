...
/**
 * 这是prppitem_car机动车险标的信息的数据传输对象基类<br>
 * 创建于 2004-11-22 15:24:12.984<br>
 * JToolpad(1.2.14) Vendor:zhouxianli@sinosoft.com.cn
 */
public class PrpPitemCarDtoBase implements Serializable{
    /** 属性批单号码 */
    ...
    /**
     *  默认构造方法,构造一个默认的PrpPitem_carDtoBase对象
     */
    public PrpPitemCarDtoBase(){
    }
