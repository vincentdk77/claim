...
/**
 * 这是PrpLQs_Dslist地市通赔结算明细清单表的数据传输对象基类<br>
...
public class PrpLQsDslistDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的PrpLQs_DslistDtoBase对象
     */
    ...
    /**
     * 设置属性代赔/被代赔赔案号
     * @param claimAgntNo 待设置的属性代赔/被代赔赔案号的值
     */
    ...
    /**
     * 设置属性本地结算操作员
     * @param operatorCode 待设置的属性本地结算操作员的值
     */
    ...
    /**
     * 设置属性本地结算单位代码
     * @param comCode 待设置的属性本地结算单位代码的值
     */
