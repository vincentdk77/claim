 ...
 */
public class PrpLclaimBillManagertgDto extends PrpLclaimBillManagertgDtoBase implements Serializable{

    private static final long serialVersionUID = 1L;
    /**
     *  默认构造方法,构造一个默认的PrpLclaimBillManagertgDto对象
     */
    public PrpLclaimBillManagertgDto(){
    }
