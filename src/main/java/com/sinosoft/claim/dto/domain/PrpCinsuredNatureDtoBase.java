...
/**
 * 这是prpcinsurednature自然人信息表的数据传输对象基类<br>
 * 创建于 2004-4-5 15:32:06<br>
 * JToolpad(1.2.3) Vendor:zhouxianli@sinosoft.com.cn
 */
public class PrpCinsuredNatureDtoBase implements Serializable{
    /** 属性保单号码 */
    ...
    /** 属性配偶出生年月 */
    private DateTime spouseBornDate = new DateTime();
    /** 属性配偶身份证号码 */
     ...
     */
    public PrpCinsuredNatureDtoBase(){
    }
     ...
     * @return 属性配偶出生年月的值
     */
    public DateTime getSpouseBornDate(){
