 ...
 * 这是交互信息关联表------轨迹历史表的数据传输对象基类<br>
 */
public class PrpLinterPayDetailHisDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的PrpLinterPayDetailHisDtoBase对象
     */
    public PrpLinterPayDetailHisDtoBase(){
    }
