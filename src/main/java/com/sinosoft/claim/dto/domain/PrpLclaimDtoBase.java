 ...
 */
public class PrpLclaimDtoBase implements Serializable{

    private static final long serialVersionUID = PrpLclaimDtoBase.class.getName().hashCode();
    /** 属性赔案号码 */
...
--** 需还原到本次理赔时的金额 */
    ...
    /**
     *  默认构造方法,构造一个默认的PrpLclaimDtoBase对象
     */
    public PrpLclaimDtoBase(){
    }
