 ...
 */
public class PrpLclaimtgDto extends PrpLclaimtgDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的PrpLclaimtgDto对象
     */
     public PrpLclaimtgDto(){
...
//modify by liuyanmei add 
	...
	public TurnPageDto getTurnPagetgDto() {
		return turnPageDto;
	}

	public void setTurnPagetgDto(TurnPageDto turnPagetgDto) {
		this.turnPageDto = turnPagetgDto;
	}
