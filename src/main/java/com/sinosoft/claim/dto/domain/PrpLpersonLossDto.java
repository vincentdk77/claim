 ...
 */
public class PrpLpersonLossDto extends PrpLpersonLossDtoBase implements Serializable{


  /**
     *  默认构造方法,构造一个默认的PrpLpersonLossDto对象
     */
    public PrpLpersonLossDto(){
    }
    /** 属性显示列表*/
    private Collection<PrpLpersonLossDto> prpLpersonLossList ;
    /** 属性显示列表*/
    private Collection<PrpLpersonLossDto> personLossList ;
   ...
   * */
	...
	public Collection<PrpLpersonLossDto> getPrpLpersonLossList() {
		return prpLpersonLossList;
	}

	public void setPrpLpersonLossList(
			Collection<PrpLpersonLossDto> prpLpersonLossList) {
		this.prpLpersonLossList = prpLpersonLossList;
	}

	public Collection<PrpLpersonLossDto> getPersonLossList() {
		return personLossList;
	}

	public void setPersonLossList(Collection<PrpLpersonLossDto> personLossList) {
