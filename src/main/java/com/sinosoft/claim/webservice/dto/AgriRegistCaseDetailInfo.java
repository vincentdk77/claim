...
public class AgriRegistCaseDetailInfo implements Serializable{
	...
	/** 耳标号清单 养殖险专用 */
	private EarLabelDto[] earNoList;
	
	
	public AgriRegistCaseDetailInfo() {
		super();
	}
	...
	public EarLabelDto[] getEarNoList() {
		return earNoList;
	}
	public void setEarNoList(EarLabelDto[] earNoList) {
