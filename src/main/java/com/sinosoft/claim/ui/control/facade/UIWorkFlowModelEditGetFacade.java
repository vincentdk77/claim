...
public class UIWorkFlowModelEditGetFacade  extends Action
{
    ...
    throws Exception
  {
    ...
    try
    {
        ...
        if(editType.equals("ADD"))
        {
          ...
          workFlowModelViewHelper.intDtoToView(httpServletRequest) ;
        }
        else if(editType.equals("EDIT"))
        {
          modelNo=Integer.parseInt(httpServletRequest.getParameter("modelNo")) ;
          workFlowModelViewHelper.dtoToView(httpServletRequest,modelNo);
        }
