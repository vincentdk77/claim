...
//		
	...
	public void setPrpLregistDtoToView(HttpServletRequest httpServletRequest,
		...
		//添加区分新农险标识
		conditions = conditions +" and (a.registno in (select registno from swflog where (systemflag is null or systemflag <> 'agri') and nodetype='regis') ";
        conditions = conditions +" or a.registno in (select registno from swflogstore where (systemflag is null or systemflag <> 'agri') and nodetype='regis')) ";
	...
	public void policyListToView(HttpServletRequest httpServletRequest,
		...
		if(strHPflag != null && !strHPflag.equals("") && !strHPflag.equals("null")) {
			if(strHPflag.equals("Large"))
				conditions = conditions + " and a.policytype in ('H24','I28','E2','Q2') ";
			if(strHPflag.equals("Retaol"))
				conditions = conditions + " and a.policytype in ('H23','I27','E1','Q1') ";
		}
