...
public class UIVerifyPriceQueryFacade  extends Action
{
    ...
    throws Exception
  {
    ...
    String conSignType    = httpServletRequest.getParameter("conSignType");//委托类型
...
//  add by miaowenjun 20060412
	...
	workFlowQueryDto.setConSignType(conSignType);
