...
public class UIPrprlfiscalpaybackSearchFacade extends Action{
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
            ...
            conditions += " and prplfiscalpaydetail.vflag = 'ct' and prplfiscalpaydetail.payamount > (select  Nvl(Sum(Payamount),0) from prplpay where receiverfullname = prplfiscalpaydetail.receiverfullname  and compensateno = prplfiscalpaydetail.compensateno )";
            ...
            Collection fiscalpaymainList  = new ArrayList();
              PageRecord pr= new BLPrplfiscalpaymainFacade().findPaybackByConditions(conditions, pageNo, rowsPerPage);
    ...
    public String getConditions(PrplFiscalPayForm fiscalPayForm, HttpServletRequest request) throws Exception{
        ...
        String policynoSign = request.getParameter("fiscalnoSign");
