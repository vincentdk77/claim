 ...
 */
public class EdaUserGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个EdaUserGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public EdaUserGetCountCommand(String conditions) throws Exception {
