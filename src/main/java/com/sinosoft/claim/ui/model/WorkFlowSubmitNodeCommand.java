 ...
 */
public class WorkFlowSubmitNodeCommand extends BaseCommand{
     ...
     * @throws Exception
     */
    public WorkFlowSubmitNodeCommand(WorkFlowDto workFlowDto) throws Exception {
    ...
    public Object executeCommand() throws Exception{
        ...
        Method method = loaderClass.getMethod("submitNode",paramTypes);
