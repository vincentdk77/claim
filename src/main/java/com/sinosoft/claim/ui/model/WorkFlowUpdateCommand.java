 ...
 */
public class WorkFlowUpdateCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个WorkFlowUpdateCommand对象
     * @param workFlowDto 参数workFlowDto
     * @throws Exception
     */
    public WorkFlowUpdateCommand(WorkFlowDto workFlowDto) throws Exception {
