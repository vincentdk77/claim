 ...
 */
public class PrpLbackVisitTextFindByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitTextFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public PrpLbackVisitTextFindByConditionsCommand(String conditions) throws Exception {
     ...
     * @throws Exception
     */
    public PrpLbackVisitTextFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage) throws Exception {
