 ...
 */
public class PrpLbackVisitFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitFindByPrimaryKeyCommand对象
     * @param backVisitID 参数backVisitID
     * @param registNo 参数registNo
     * @param backVisitType 参数backVisitType
     * @throws Exception
     */
    public PrpLbackVisitFindByPrimaryKeyCommand(int backVisitID ,String registNo ,String backVisitType) throws Exception {
