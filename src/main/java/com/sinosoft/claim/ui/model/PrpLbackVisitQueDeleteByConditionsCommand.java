 ...
 */
public class PrpLbackVisitQueDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitQueDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public PrpLbackVisitQueDeleteByConditionsCommand(String conditions) throws Exception {
