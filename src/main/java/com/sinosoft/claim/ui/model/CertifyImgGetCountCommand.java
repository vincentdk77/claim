 ...
 */
public class CertifyImgGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLcertifyImgGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public CertifyImgGetCountCommand(String conditions) throws Exception {
