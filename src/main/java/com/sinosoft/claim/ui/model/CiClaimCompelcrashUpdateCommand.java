 ...
 */
public class CiClaimCompelcrashUpdateCommand extends BaseCommand{
    private CiClaimCompelcrashDto ciClaimCompelcrashDtoCiClaimCompelcrashDto;
    /**
     * 构造方法,构造一个CiClaimCompelcrashUpdateCommand对象
     * @param ciClaimCompelcrashDto 参数ciClaimCompelcrashDto
     * @throws Exception
     */
    public CiClaimCompelcrashUpdateCommand(CiClaimCompelcrashDto ciClaimCompelcrashDto)
            throws Exception{
    ...
    private Object executeCommandCiClaimCompelcrashDtoImpl()
        ...
        facade.update(ciClaimCompelcrashDtoCiClaimCompelcrashDto);
        return null;
    }
    /**
