 ...
 */
public class ED_AGENT_INFOGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个ED_AGENT_INFOGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public ED_AGENT_INFOGetCountCommand(String conditions) throws Exception {
