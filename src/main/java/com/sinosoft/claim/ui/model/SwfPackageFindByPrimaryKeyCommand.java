 ...
 */
public class SwfPackageFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPackageFindByPrimaryKeyCommand对象
     * @param packageID 参数packageID
     * @param detailNo 参数detailNo
     * @throws Exception
     */
    public SwfPackageFindByPrimaryKeyCommand(String packageID ,int detailNo) throws Exception {
