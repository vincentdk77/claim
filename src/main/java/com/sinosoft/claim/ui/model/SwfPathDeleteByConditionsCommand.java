 ...
 */
public class SwfPathDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPathDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfPathDeleteByConditionsCommand(String conditions) throws Exception {
