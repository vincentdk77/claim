 ...
 */
public class SwfPathFindByConditionsCommand extends BaseCommand{
     ...
     * @throws Exception
     */
    public SwfPathFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage) throws Exception {
     ...
     * @throws Exception
     */
    public SwfPathFindByConditionsCommand(String conditions) throws Exception {
