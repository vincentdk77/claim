 ...
 */
public class PrpLbackVisitQueInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitQueInsertCommand对象
     * @param prpLbackVisitQueDto 参数prpLbackVisitQueDto
     * @throws Exception
     */
    public PrpLbackVisitQueInsertCommand(PrpLbackVisitQueDto prpLbackVisitQueDto) throws Exception {
