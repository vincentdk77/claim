 ...
 */
public class SwfPackageDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPackageDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfPackageDeleteByConditionsCommand(String conditions) throws Exception {
