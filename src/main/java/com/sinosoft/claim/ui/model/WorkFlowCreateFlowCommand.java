 ...
 */
public class WorkFlowCreateFlowCommand extends BaseCommand{
     ...
     * @throws Exception
     */
    public WorkFlowCreateFlowCommand(WorkFlowDto workFlowDto) throws Exception {
    ...
    public Object executeCommand() throws Exception{
       ...
       String strRet = bLWorkFlowFacade.createFlow(workFlowDto); 
       return strRet;
