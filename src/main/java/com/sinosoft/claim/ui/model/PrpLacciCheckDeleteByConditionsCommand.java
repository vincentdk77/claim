 ...
 */
public class PrpLacciCheckDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLacciCheckDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public PrpLacciCheckDeleteByConditionsCommand(String conditions) throws Exception {
