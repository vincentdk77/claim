 ...
 */
public class PrpLbackVisitTextDeleteCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitTextDeleteCommand对象
     ...
     * @throws Exception
     */
    public PrpLbackVisitTextDeleteCommand(int backVisitID ,String registNo ,String backVisitType ,int lineNo) throws Exception {
