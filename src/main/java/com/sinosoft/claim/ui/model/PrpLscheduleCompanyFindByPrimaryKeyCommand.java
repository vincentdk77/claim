 ...
 */
public class PrpLscheduleCompanyFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLscheduleCompanyFindByPrimaryKeyCommand对象
     * @param comCode 参数comCode
     * @throws Exception
     */
    public PrpLscheduleCompanyFindByPrimaryKeyCommand(String comCode) throws Exception {
