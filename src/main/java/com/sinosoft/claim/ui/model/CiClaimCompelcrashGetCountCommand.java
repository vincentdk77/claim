 ...
 */
public class CiClaimCompelcrashGetCountCommand extends BaseCommand{
    private String stringConditions;
    /**
     * 构造方法,构造一个CiClaimCompelcrashGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public CiClaimCompelcrashGetCountCommand(String conditions)
            throws Exception{
