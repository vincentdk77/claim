 ...
 */
public class WorkFlowModelDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个WorkFlowModelDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public WorkFlowModelDeleteByConditionsCommand(String conditions) throws Exception {
