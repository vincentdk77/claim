 ...
 */
public class SwfModelUseFindByPrimaryKeyCommand extends BaseCommand{
     ...
     * @throws Exception
     */
    public SwfModelUseFindByPrimaryKeyCommand(int modelNo ,String riskCode ,String comCode) throws Exception {
