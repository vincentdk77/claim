 ...
 */
public class PrpLbackVisitQueDeleteCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitQueDeleteCommand对象
     ...
     * @throws Exception
     */
    public PrpLbackVisitQueDeleteCommand(int backVisitID ,String registNo ,String backVisitType ,String questionCode) throws Exception {
