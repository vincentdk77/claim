 ...
 */
public class SwfFlowMainInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfFlowMainInsertCommand对象
     * @param wfFlowMainDto 参数wfFlowMainDto
     * @throws Exception
     */
    public SwfFlowMainInsertCommand(SwfFlowMainDto wfFlowMainDto) throws Exception {
