 ...
 */
public class CertifyImgFindByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLcertifyImgFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public CertifyImgFindByConditionsCommand(String conditions) throws Exception {
     ...
     * @throws Exception
     */
    public CertifyImgFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage) throws Exception {
