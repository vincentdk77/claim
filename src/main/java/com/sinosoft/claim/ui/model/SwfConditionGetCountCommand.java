 ...
 */
public class SwfConditionGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfConditionGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfConditionGetCountCommand(String conditions) throws Exception {
