 ...
 */
public class SwfPackageUpdateCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPackageUpdateCommand对象
     * @param wfPackageDto 参数wfPackageDto
     * @throws Exception
     */
    public SwfPackageUpdateCommand(SwfPackageDto wfPackageDto) throws Exception {
