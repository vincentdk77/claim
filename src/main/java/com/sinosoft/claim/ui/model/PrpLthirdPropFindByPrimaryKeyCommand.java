 ...
 */
public class PrpLthirdPropFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLthirdPropFindByPrimaryKeyCommand对象
     * @param registNo 参数registNo
     * @param serialNo 参数serialNo
     * @throws Exception
     */
    public PrpLthirdPropFindByPrimaryKeyCommand(String registNo ,int serialNo) throws Exception {
