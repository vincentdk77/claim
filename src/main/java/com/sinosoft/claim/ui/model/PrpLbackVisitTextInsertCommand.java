 ...
 */
public class PrpLbackVisitTextInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLbackVisitTextInsertCommand对象
     * @param prpLbackVisitTextDto 参数prpLbackVisitTextDto
     * @throws Exception
     */
    public PrpLbackVisitTextInsertCommand(PrpLbackVisitTextDto prpLbackVisitTextDto) throws Exception {
