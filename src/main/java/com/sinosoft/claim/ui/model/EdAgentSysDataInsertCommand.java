 ...
 */
public class EdAgentSysDataInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个EdAgentSysDataInsertCommand对象
     * @param edAgentSysDataDto 参数edAgentSysDataDto
     * @throws Exception
     */
    public EdAgentSysDataInsertCommand(EdAgentSysDataDto edAgentSysDataDto) throws Exception {
