 ...
 */
public class PrpLacciCheckUpdateCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLacciCheckUpdateCommand对象
     * @param prpLacciCheckDto 参数prpLacciCheckDto
     * @throws Exception
     */
    public PrpLacciCheckUpdateCommand(PrpLacciCheckDto prpLacciCheckDto) throws Exception {
