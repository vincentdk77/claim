 ...
 */
public class SwfNodeDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfNodeDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfNodeDeleteByConditionsCommand(String conditions) throws Exception {
