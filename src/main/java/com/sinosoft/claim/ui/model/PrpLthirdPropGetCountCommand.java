 ...
 */
public class PrpLthirdPropGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个PrpLthirdPropGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public PrpLthirdPropGetCountCommand(String conditions) throws Exception {
