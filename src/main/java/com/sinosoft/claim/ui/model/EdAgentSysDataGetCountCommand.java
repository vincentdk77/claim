 ...
 */
public class EdAgentSysDataGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个EdAgentSysDataGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public EdAgentSysDataGetCountCommand(String conditions) throws Exception {
