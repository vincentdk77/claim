 ...
 */
public class EdaUserInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个EdaUserInsertCommand对象
     * @param edaUserDto 参数edaUserDto
     * @throws Exception
     */
    public EdaUserInsertCommand(EdaUserDto edaUserDto) throws Exception {
