 ...
 */
public class SwfPathLogGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPathLogGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfPathLogGetCountCommand(String conditions) throws Exception {
