 ...
 */
public class CiClaimCrashFindByConditionsCommand extends BaseCommand{
    private String type; //用于标识方法类型
    private int intRowsPerPage;
    private int intPageNo;
    private String stringConditions;
    /**
     * 构造方法,构造一个CiClaimCrashFindByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public CiClaimCrashFindByConditionsCommand(String conditions)
            throws Exception{
     ...
     * @throws Exception
     */
    public CiClaimCrashFindByConditionsCommand(String conditions ,int pageNo ,int rowsPerPage)
            throws Exception{
