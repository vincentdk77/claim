 ...
 */
public class PrplcompensatehouseFindByPrimaryKeyCommand extends BaseCommand{
    private String stringBusinessno;
    private String stringIdcard;
    private String stringNodetype;
    private String stringRegistno;
    /**
     * 构造方法,构造一个PrplcompensatehouseFindByPrimaryKeyCommand对象
     ...
     * @throws Exception
     */
    public PrplcompensatehouseFindByPrimaryKeyCommand(String idcard ,String registno ,String nodetype ,String businessno)
            throws Exception{
    ...
    private Object executeCommandStringStringStringStringImpl()
        ...
        return facade.findByPrimaryKey(stringIdcard ,stringRegistno ,stringNodetype ,stringBusinessno);
    }
    /**
