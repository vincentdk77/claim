 ...
 */
public class SwfModelMainUpdateCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfModelMainUpdateCommand对象
     * @param wfModelMainDto 参数wfModelMainDto
     * @throws Exception
     */
    public SwfModelMainUpdateCommand(SwfModelMainDto wfModelMainDto) throws Exception {
