 ...
 */
public class SwfConditionDeleteCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfConditionDeleteCommand对象
     ...
     * @throws Exception
     */
    public SwfConditionDeleteCommand(int modelNo ,int pathNo ,int conditionNo ,int serialNo) throws Exception {
