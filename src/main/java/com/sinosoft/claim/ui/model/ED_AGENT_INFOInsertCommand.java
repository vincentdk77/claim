 ...
 */
public class ED_AGENT_INFOInsertCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个ED_AGENT_INFOInsertCommand对象
     * @param eD_AGENT_INFODto 参数eD_AGENT_INFODto
     * @throws Exception
     */
    public ED_AGENT_INFOInsertCommand(ED_AGENT_INFODto eD_AGENT_INFODto) throws Exception {
