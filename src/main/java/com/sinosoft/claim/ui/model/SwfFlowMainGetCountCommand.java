 ...
 */
public class SwfFlowMainGetCountCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfFlowMainGetCountCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfFlowMainGetCountCommand(String conditions) throws Exception {
