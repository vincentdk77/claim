 ...
 */
public class SwfFlowMainDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfFlowMainDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfFlowMainDeleteByConditionsCommand(String conditions) throws Exception {
