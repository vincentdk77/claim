 ...
 */
public class SwfConditionFindByPrimaryKeyCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfConditionFindByPrimaryKeyCommand对象
     ...
     * @throws Exception
     */
    public SwfConditionFindByPrimaryKeyCommand(int modelNo ,int pathNo ,int conditionNo ,int serialNo) throws Exception {
