 ...
 */
public class CiClaimCompelcrashFindByPrimaryKeyCommand extends BaseCommand{
    private String stringRegistNo;
    private String stringPolicyNo;
    /**
     * 构造方法,构造一个CiClaimCompelcrashFindByPrimaryKeyCommand对象
     * @param registNo 参数registNo
     * @param policyNo 参数policyNo
     * @throws Exception
     */
    public CiClaimCompelcrashFindByPrimaryKeyCommand(String registNo ,String policyNo)
            throws Exception{
    ...
    private Object executeCommandStringStringImpl()
        ...
        return facade.findByPrimaryKey(stringRegistNo ,stringPolicyNo);
    }
    /**
