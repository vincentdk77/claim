 ...
 */
public class ED_AGENT_INFODeleteCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个ED_AGENT_INFODeleteCommand对象
     * @param aGENTID 参数aGENTID
     * @throws Exception
     */
    public ED_AGENT_INFODeleteCommand(String aGENTID) throws Exception {
