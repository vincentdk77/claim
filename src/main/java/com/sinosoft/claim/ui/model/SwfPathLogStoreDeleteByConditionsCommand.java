 ...
 */
public class SwfPathLogStoreDeleteByConditionsCommand extends BaseCommand{
    private Class[] paramTypes;
    private Object[] params;
    /**
     *  构造方法,构造一个SwfPathLogStoreDeleteByConditionsCommand对象
     * @param conditions 参数conditions
     * @throws Exception
     */
    public SwfPathLogStoreDeleteByConditionsCommand(String conditions)
            throws Exception{
