 ...
 */
public class DBPrpLpayNoticetgBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpLpayNoticetgBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpayNoticetgBase(DBManager dbManager){
    ...
    public void insert(PrpLpayNoticeDto prpLpayNoticeDto)
        ...
        buffer.append("INSERT INTO PrpLpayNoticetg (");
    ...
    public void delete(String noticeNo)
        ...
        buffer.append("DELETE FROM PrpLpayNoticetg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpLpayNoticeDto prpLpayNoticeDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpLpayNoticetg SET ");
        buffer.append("NoticeType = ?, ");
        buffer.append("OpreateDate = ?, ");
        buffer.append("OpreateCode = ?, ");
        buffer.append("ReceiverFullName = ? ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpLpayNoticetg SET ");
    ...
    public PrpLpayNoticeDto findByPrimaryKey(String noticeNo)
        ...
        buffer.append("OpreateCode,");
        buffer.append("ReceiverFullName ");
        buffer.append("FROM PrpLpayNoticetg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("OpreateCode,");
        buffer.append("ReceiverFullName ");
        buffer.append("FROM PrpLpayNoticetg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpLpayNoticetg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM (SELECT * FROM PrpLpayNoticetg WHERE ");
        buffer.append(conditions);
        buffer.append(")");
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
