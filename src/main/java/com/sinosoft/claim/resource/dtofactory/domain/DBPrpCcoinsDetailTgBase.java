 ...
 */
public class DBPrpCcoinsDetailTgBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpCcoinsDetailTgBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCcoinsDetailTgBase(DBManager dbManager){
    ...
    public void insert(PrpCcoinsDetailDto prpCcoinsDetailDto)
        ...
        buffer.append("INSERT INTO PrpCcoinsDetailTg (");
    ...
    public void delete(String policyNo,long serialNo,String currency)
        ...
        buffer.append("DELETE FROM PrpCcoinsDetailTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpCcoinsDetailDto prpCcoinsDetailDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpCcoinsDetailTg SET ");
        buffer.append("coinsCode = ?, ");
        buffer.append("coinsName = ?, ");
        buffer.append("coinsAmount = ?, ");
        buffer.append("coinsPremium = ?, ");
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpCcoinsDetailTg SET ");
    ...
    public PrpCcoinsDetailDto findByPrimaryKey(String policyNo,long serialNo,String currency)
        ...
        buffer.append("flag,");
        buffer.append("middleCostFee ");
        buffer.append("FROM PrpCcoinsDetailTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("flag,");
        buffer.append("middleCostFee ");
        buffer.append("FROM PrpCcoinsDetailTg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpCcoinsDetailTg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM PrpCcoinsDetailTg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
