 ...
 */
public class DBPrpCmainTg extends DBPrpCmainTgBase{
    private static Log log = LogFactory.getLog(DBPrpCmainTg.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCmainTg(DBManager dbManager){
        super(dbManager);
    }
