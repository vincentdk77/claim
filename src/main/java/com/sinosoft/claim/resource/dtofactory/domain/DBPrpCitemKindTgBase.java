 ...
 */
public class DBPrpCitemKindTgBase{
    private DBManager dbManager = null; //资源管理类
    private static Log log = LogFactory.getLog(DBPrpCitemKindTgBase.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCitemKindTgBase(DBManager dbManager){
    ...
    public void insert(PrpCitemKindDto prpCitemKindDto) throws Exception{
        String statement = " Insert Into PrpCitemKindtg(" + 
                           " PolicyNo," + 
                           " RiskCode," + 
                           " ItemKindNo," + 
                           " FamilyNo," + 
    ...
    public void delete(String policyNo,int itemKindNo) throws Exception{
        String statement = " Delete From PrpCitemKindtg Where " +
                           " PolicyNo = ? And " + 
                           " ItemKindNo = ?";
        log.debug(statement);
        dbManager.prepareStatement(statement);
    ...
    public void update(PrpCitemKindDto prpCitemKindDto) throws Exception{
        String statement = " Update PrpCitemKindtg Set RiskCode = ?," + 
                           " FamilyNo = ?," + 
                           " FamilyName = ?," + 
                           " KindCode = ?," + 
                           " KindName = ?," + 
    ...
    public PrpCitemKindDto findByPrimaryKey(String policyNo,int itemKindNo) throws Exception{
        String statement = " Select PolicyNo," + 
                           ...
                           " DeductibleRate," + 
                           " Deductible," + 
                           " Flag From PrpCitemKindtg Where " +
                           " PolicyNo = ? And " + 
                           " ItemKindNo = ?";
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " TotalLossRatio," + 
                           " TriggerPoint," + 
                           " Flag From PrpCitemKindtg Where " + conditions;
        log.debug(statement);
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCitemKindtg Where " + conditions;
        log.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCitemKindtg Where " + conditions;
        log.debug(statement);
        ResultSet resultSet = dbManager.executeQuery(statement);
        resultSet.next();
