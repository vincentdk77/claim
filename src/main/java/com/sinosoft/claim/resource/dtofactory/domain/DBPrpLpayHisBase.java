 ...
 */
public class DBPrpLpayHisBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpLpayHisBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpayHisBase(DBManager dbManager){
    ...
    public void insert(PrpLpayHisDto prpLpayHisDto)
        ...
        buffer.append("INSERT INTO PrpLpayHis (");
        ...
        dbManager.setString(53,prpLpayHisDto.getRealPayWay());
    ...
    public void delete(String serialNo,String serialNo2)
        ...
        buffer.append("DELETE FROM PrpLpayHis ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpLpayHisDto prpLpayHisDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpLpayHis SET ");
        buffer.append("claimNo = ?, ");
        buffer.append("compensateNo = ?, ");
        buffer.append("classCode = ?, ");
        buffer.append("riskCode = ?, ");
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpLpayHis SET ");
        ...
        dbManager.setString(51,prpLpayHisDto.getRealPayWay());
        //设置条件字段;
        dbManager.setString(52,prpLpayHisDto.getSerialNo());
        dbManager.setString(53,prpLpayHisDto.getSerialNo2());
        dbManager.executePreparedUpdate();
    ...
    public PrpLpayHisDto findByPrimaryKey(String serialNo,String serialNo2)
        ...
        if(resultSet.next()){
            ...
            prpLpayHisDto.setRealPayWay(dbManager.getString(resultSet, 53));
        }
        resultSet.close();
        return prpLpayHisDto;
    }
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpLpayHis WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM PrpLpayHis WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
