 ...
 */
public class DBPrpCengageBase{
    protected DBManager dbManager = null; //资源管理类
    private static Log logger = LogFactory.getLog(DBPrpCengageBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCengageBase(DBManager dbManager){
    ...
    public void insert(PrpCengageDto prpCengageDto) throws Exception{
        String mainStatement = " Insert Into PrpCengage (" + 
                           " PolicyNo," + 
                           " RiskCode," + 
                           " SerialNo," + 
                           " LineNo," + 
    ...
    public void delete(String policyNo,int serialNo,int lineNo) throws Exception{
        String statement = " Delete From PrpCengage" + 
	            		   " Where " +
                           " PolicyNo = ? And " + 
                           " SerialNo = ? And " + 
                           " LineNo = ?";
        if(logger.isDebugEnabled()){
            String debugStatement = "Delete From PrpCengage Where " +
    ...
    public void update(PrpCengageDto prpCengageDto) throws Exception{
        String statement = " Update PrpCengage Set RiskCode = ?," + 
                           " ClauseCode = ?," + 
                           " Clauses = ?," + 
                           " TitleFlag = ?," + 
                           " Flag = ?" + 
                           ...
                           " LineNo = ?";
        if(logger.isDebugEnabled()){
            String debugStatement = "Update PrpCengage Set " + 
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " Clauses," + 
                           " TitleFlag," + 
                           " Flag From PrpCengage Where " + conditions;
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCengage Where " + conditions;
        logger.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCengage Where " + conditions;
