 ...
 */
public class DBPrpCitemKind extends DBPrpCitemKindBase{
    private static Log log = LogFactory.getLog(DBPrpCitemKind.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCitemKind(DBManager dbManager){
        super(dbManager);
    }
    /**
     * 按条件汇总 总保额
    ...
    public double getSumAmount(DBManager dbManager,String conditions) throws Exception{
        String statement = " Select sum(Amount) as Amount From prpcvirturlitem Where " + conditions;
    ...
    public int getItemKindNo(DBManager dbManager,String conditions) throws Exception{
        String statement = " Select itemkindno as itemkindno From prpcitemkind Where " + conditions;
        int itemkindno = 0;
        ResultSet resultSet = dbManager.executeQuery(statement);
    ...
    public String getItemDetailName(DBManager dbManager,String conditions) throws Exception{
        String statement = " Select ItemDetailName as ItemDetailName From prpcitemkind Where " + conditions;
