 ...
 */
public class DBPrpCmainLoanTgBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Log logger = LogFactory.getLog(DBPrpCmainLoanTgBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCmainLoanTgBase(DBManager dbManager){
    ...
    public void insert(PrpCmainLoanDto prpCmainLoanDto)
        ...
        buffer.append("INSERT INTO PrpCmainLoanTg (");
    ...
    public void delete(String policyNo)
        ...
        buffer.append("DELETE FROM PrpCmainLoanTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpCmainLoanDto prpCmainLoanDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpCmainLoanTg SET ");
        buffer.append("RiskCode = ?, ");
        buffer.append("RiskKind = ?, ");
        buffer.append("GuaranteeType = ?, ");
        buffer.append("GuaranteeName = ?, ");
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpCmainLoanTg SET ");
    ...
    public PrpCmainLoanDto findByPrimaryKey(String policyNo)
        ...
        buffer.append("Remark,");
        buffer.append("flag ");
        buffer.append("FROM PrpCmainLoanTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("Remark,");
        buffer.append("flag ");
        buffer.append("FROM PrpCmainLoanTg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpCmainLoanTg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        StringBuffer buffer = new StringBuffer(100);
        String statement;
        statement="SELECT count(1) FROM PrpCmainLoanTg WHERE ";
