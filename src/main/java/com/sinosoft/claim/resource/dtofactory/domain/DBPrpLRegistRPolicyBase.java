 ...
 */
public class DBPrpLRegistRPolicyBase{
    protected DBManager dbManager = null; //资源管理类
    private static Log logger = LogFactory.getLog(DBPrpLRegistRPolicyBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLRegistRPolicyBase(DBManager dbManager){
    ...
    public void insert(PrpLRegistRPolicyDto prpLRegistRPolicyDto) throws Exception{
        String mainStatement = " Insert Into PrpLRegistRPolicy (" + 
                           " RegistNo," + 
                           " PolicyNo," + 
                           " ClaimNo," + 
                           " PolicyType," + 
    ...
    public void delete(String registNo,String policyNo) throws Exception{
        String statement = " Delete From PrpLRegistRPolicy" + 
	            		   " Where " +
                           " RegistNo = ? And " + 
                           " PolicyNo = ?";
        if(logger.isDebugEnabled()){
            String debugStatement = "Delete From PrpLRegistRPolicy Where " +
    ...
    public void update(PrpLRegistRPolicyDto prpLRegistRPolicyDto) throws Exception{
        String statement = " Update PrpLRegistRPolicy Set ClaimNo = ?," + 
                           " PolicyType = ?," + 
                           " FlowId = ?," + 
                           " Remark = ?," + 
                           " ValidStatus = ?," + 
                           ...
                           " PolicyNo = ?";
        if(logger.isDebugEnabled()){
            String debugStatement = "Update PrpLRegistRPolicy Set " + 
    ...
    public PrpLRegistRPolicyDto findByPrimaryKey(String registNo,String policyNo) throws Exception{
        String mainStatement = " Select RegistNo," + 
                           ...
                           " registComCode,"+
                           " CancelReason,"+
                           " CancelReasonName From PrpLRegistRPolicy";
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select RegistNo," + 
                           ...
                           " registComCode,"+ 
                           " CancelReason," +
                           " CancelReasonName From PrpLRegistRPolicy Where " + conditions;
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpLRegistRPolicy Where " + conditions;
        logger.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpLRegistRPolicy Where " + conditions;
