 ...
 */
public class DBPrpLpaymain extends DBPrpLpaymainBase{
    private static Logger logger = Logger.getLogger(DBPrpLpaymain.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpaymain(DBManager dbManager){
        super(dbManager);
    }
	...
	* 审核占用必须是待审核状态
    ...
    public void updateByKeyFor6(String paymentNo,String vflag)throws Exception{
        ...
        buffer.append("WHERE ");
        buffer.append("PaymentNo = ? and vflag='6' ");
    ...
    public Collection findPayQueryByConditionsNew(String conditions,int pageNo,int rowsPerPage)
        ...
        StringBuffer buffer = new StringBuffer(200);
        //拼SQL语句
        buffer.append("Select a.*,m.realpayway from (");
        buffer.append("SELECT DISTINCT ");
        buffer.append("decode(prplpaybill.billno,null,PrpLpaymain.PaymentNo,'',PrpLpaymain.PaymentNo,'') as PaymentNo,");
        buffer.append("decode(prplpaybill.billno,null,PrpLpaymain.PayType,'',PrpLpaymain.PayType,'') as PayType,");
        buffer.append("decode(prplpaybill.billno,null,PrpLpaymain.PayAmount,'',PrpLpaymain.PayAmount,kk.payamount ) as PayAmount,");
        ...
        buffer.append("decode(prplpaybill.billNo,null,'0','',0,'1')");
        buffer.append(" order by min(prplpaymain.inputdate) desc ");
        buffer.append(" )a Left Join prplpaymain m On m.paymentno=a.paymentno  ");
        buffer.append(" Order By a.inputdate Desc ");
        boolean supportPaging = false;//数据库是否支持分页
        if (pageNo > 0){
            //目前只对Oracle优化
            if(dbManager.getConnection().getMetaData().getDatabaseProductName().equalsIgnoreCase("Oracle")){
        ...
        while(resultSet.next()){
            ...
            prpLpaymainDto.setRealPayWay(dbManager.getString(resultSet, 55));
	...
	public int getPayQueryCountBack(String conditions,String conditions1,String conditions2) throws Exception {
		int count = -1;
        StringBuffer buffer = new StringBuffer(100);
//        buffer.append("SELECT count(1) FROM (");
//        buffer.append("SELECT DISTINCT ");
...
//        buffer.append(")");
        buffer.append("SELECT count(1) FROM (");
        buffer.append("	SELECT DISTINCT																	");													
        buffer.append("	kk.billNo      														      ");
        buffer.append("	FROM PrpLpaymain,														    ");
        buffer.append("	prplpay,       														      ");
        buffer.append("	prplregist,    														      ");
        buffer.append("	(select billno, sum(payAmount) as payAmount			");											
        buffer.append("	from prplpaybill														    ");
        buffer.append("	group by billno) kk												  ");
        buffer.append("	WHERE         														      ");
        buffer.append(conditions);
        buffer.append("	group by                                        ");
        buffer.append("	KK.billNo                                       ");
        buffer.append("	union all                                       ");
        buffer.append("	SELECT DISTINCT                                 ");
        buffer.append("	PrpLpaymain.PaymentNo as billNo                 ");
        buffer.append("	FROM PrpLpaymain,                               ");
        buffer.append("	prplpay,                                        ");
        buffer.append("	prplregist                                      ");
        buffer.append("	WHERE                                           ");
        buffer.append(conditions2);
        buffer.append("	group by       PrpLpaymain.PaymentNo            ");
        buffer.append("	union all                                       ");
        buffer.append("	SELECT DISTINCT PrpLfiscalpaymain.fiscalno      ");
        buffer.append("	FROM PrpLfiscalpaymain,                         ");
        buffer.append("	prplfiscalpaydetail,                            ");
        buffer.append("	prplregist                                      ");
        buffer.append("	WHERE                                           ");
        buffer.append(conditions1);
        buffer.append(")");
	...
	public Collection findPayQueryByConditionsBack(String conditions,String conditions1,String conditions2,
			int pageNo, int rowsPerPage) throws Exception {
		StringBuffer buffer = new StringBuffer(200);
        //拼SQL语句
//		buffer.append("select * from (");
...
//    	buffer.append(") order by inputdate desc ");
		buffer.append("select * from (");
		buffer.append("		SELECT DISTINCT																					  ");					
		buffer.append("		'' as PaymentNo,                                          ");
		buffer.append("		'' as PayType,                                            ");
		buffer.append("		SUM(prplpay.PayAmount )as PayAmount,                      ");
		buffer.append("		'' as BankType,                                           ");
		buffer.append("		'' as Bank,                                               ");
		buffer.append("		'' as BankSite,                                           ");
		buffer.append("		'' as AccountType,                                        ");
		buffer.append("		'' as ReceiverFullName,                                   ");
		buffer.append("		'' as ReceiverFullCode,                                   ");
		buffer.append("		'' as CertifType,                                         ");
		buffer.append("		'' as Address,                                            ");
		buffer.append("		'' as CertifNo,                                           ");
		buffer.append("		'' as FamilyPhone,                                        ");
		buffer.append("		'' as OfficePhone,                                        ");
		buffer.append("		'' as MobilePhone,                                        ");
		buffer.append("		''as PayRemark,                                           ");
		buffer.append("		''as OperatorCode,                                        ");
		buffer.append("		min(prplpaymain.inputdate) as InputDate,                  ");
		buffer.append("		null as PayDate,                                          ");
		buffer.append("		'' as PayCode,                                            ");
		buffer.append("		'' as PayFlag,                                            ");
		buffer.append("	'' as PaymentType,                                          ");
		buffer.append("	'' as BankAccount,                                          ");
		...
		buffer.append("	PrpLpaymain.ComCode,                                        ");
		buffer.append("	'' as MergerFlag,                                           ");
		buffer.append("	0 as PayTotalAmount,                                        ");
		buffer.append("	'' as UrgentType,                                           ");
		buffer.append("	'' as ReceiverTypeOther,                                    ");
		buffer.append("	'' as ReceiverTypeOtherName,                                ");
		buffer.append("	'' as QqNumber,                                             ");
		...
		buffer.append("	'' as routeNum,                                             ");
		buffer.append("	PrpLpaymain.thirdPayType,                                   ");
		buffer.append("	kk.payamount as payAmountSub,                               ");
		buffer.append("	PrpLpaymain.billFlag,                                       ");
		buffer.append("	KK.billNo,                                                  ");
		buffer.append("	'1'                                                         ");
		buffer.append("	FROM PrpLpaymain,                                           ");
		...
		buffer.append("	PrpLpaymain.thirdPayFlag,                                   ");
		buffer.append("	PrpLpaymain.thirdPayType,                                   ");
		buffer.append("	kk.payamount,                                               ");
		buffer.append("	PrpLpaymain.billFlag,                                       ");
		buffer.append("	KK.billNo                                                   ");
		buffer.append("	union all                                                   ");
		buffer.append("	SELECT DISTINCT                                             ");
		buffer.append("	PrpLpaymain.PaymentNo as PaymentNo,                         ");
		buffer.append("	PrpLpaymain.PayType as PayType,                             ");
		buffer.append("	prplpaymain.PayAmount as PayAmount,                         ");
		buffer.append("	PrpLpaymain.BankType as BankType,                           ");
		buffer.append("	PrpLpaymain.Bank as Bank,                                   ");
		buffer.append("	PrpLpaymain.BankSite as BankSite,                           ");
		buffer.append("	PrpLpaymain.AccountType as AccountType,                     ");
		buffer.append("	PrpLpaymain.ReceiverFullName as ReceiverFullName,           ");
		buffer.append("	PrpLpaymain.ReceiverFullCode as ReceiverFullCode,           ");
		buffer.append("	PrpLpaymain.CertifType as CertifType,                       ");
		buffer.append("	PrpLpaymain.Address as Address,                             ");
		buffer.append("	PrpLpaymain.CertifNo as CertifNo,                           ");
		buffer.append("	PrpLpaymain.FamilyPhone as FamilyPhone,                     ");
		buffer.append("	PrpLpaymain.OfficePhone as OfficePhone,                     ");
		buffer.append("	PrpLpaymain.MobilePhone as MobilePhone,                     ");
		buffer.append("	PrpLpaymain.PayRemark as PayRemark,                         ");
		buffer.append("	PrpLpaymain.OperatorCode as OperatorCode,                   ");
		buffer.append("	min(PrpLpaymain.InputDate) as InputDate,                    ");
		buffer.append("	PrpLpaymain.PayDate as PayDate,                             ");
		buffer.append("	PrpLpaymain.PayCode as PayCode,                             ");
		buffer.append("	PrpLpay.PayFlag as PayFlag,                                 ");
		buffer.append("	PrpLpaymain.PaymentType as PaymentType,                     ");
		buffer.append("	PrpLpaymain.BankAccount as BankAccount,                     ");
		buffer.append("	PrpLpaymain.Node as Node,                                   ");
		buffer.append("	PrpLpaymain.UpLoadSerialNo as UpLoadSerialNo,               ");
		buffer.append("	PrpLpaymain.Vflag,                                          ");
		buffer.append("	PrpLpaymain.ComCode,                                        ");
		buffer.append("	PrpLpaymain.MergerFlag as MergerFlag,                       ");
		buffer.append("	PrpLpaymain.PayTotalAmount as PayTotalAmount,               ");
		buffer.append("	PrpLpaymain.UrgentType as UrgentType,                       ");
		buffer.append("	PrpLpaymain.ReceiverTypeOther as ReceiverTypeOther,         ");
		buffer.append("	PrpLpaymain.ReceiverTypeOtherName as ReceiverTypeOtherName, ");
		buffer.append("	PrpLpaymain.QqNumber as QqNumber,                           ");
		buffer.append("	PrpLpaymain.Email as Email,                                 ");
		buffer.append("	PrpLpaymain.UnitLink as UnitLink,                           ");
		buffer.append("	PrpLpaymain.PostCode as PostCode,                           ");
		buffer.append("	PrpLpaymain.VerifyFlag as VerifyFlag,                       ");
		buffer.append("	PrpLpaymain.NoticeNo as NoticeNo,                           ");
		buffer.append("	prplregist.registNo,                                        ");
		buffer.append("	prplregist.policyNo,                                        ");
		buffer.append("	prplregist.insuredName,                                     ");
		buffer.append("	prplregist.licenseNo,                                       ");
		buffer.append("	PrpLpaymain.thirdPayFlag,                                   ");
		buffer.append("	PrpLpaymain.payWay as payWay,                               ");
		buffer.append("	PrpLpaymain.payReason  as payReason,                        ");
		buffer.append("	PrpLpaymain.payPurpose as payPurpose,                       ");
		buffer.append("	PrpLpaymain.accountFlag as accountFlag,                     ");
		buffer.append("	PrpLpaymain.interType as interType,                         ");
		buffer.append("	PrpLpaymain.routeNum as routeNum,                           ");
		buffer.append("	PrpLpaymain.thirdPayType,                                   ");
		buffer.append("	PrpLpaymain.PayAmount as payAmountSub,                      ");
		buffer.append("	PrpLpaymain.billFlag,                                       ");
		buffer.append("	PrpLpaymain.PaymentNo as billNo,                            ");
		buffer.append("	'0'                                                         ");
		buffer.append("	FROM PrpLpaymain,                                           ");
		...
		buffer.append("	PrpLpaymain.billFlag                                        ");
		buffer.append("	union all                                                   ");
		buffer.append("	SELECT DISTINCT PrpLfiscalpaymain.fiscalno as PaymentNo,    ");
		buffer.append("	'' as PayType,                                              ");
		buffer.append("	Prplfiscalpaydetail.payamount,                              ");
		buffer.append("	'' as BankType,                                             ");
		buffer.append("	'' as Bank,                                                 ");
...
//        buffer.append(" PRPLPAYMAIN.paydate,");
        buffer.append(" to_date(thirdpay_platform.prpqpackdetail.paydate,'yyyy-mm-dd hh24:mi:ss'),");
        buffer.append(" PRPLPAYMAIN.PayCode,");
...
/*        buffer.append(" prplpay.compensateno, ");
       // buffer.append(" prplpay.bank bank2, ");
        ...
        buffer.append(" FROM PrpLpaymain,thirdpay_platform.prpqpackdetail    WHERE ");
        buffer.append(conditions);
        buffer.append(" and PrpLpaymain.PaymentNo=thirdpay_platform.prpqpackdetail.visaserialno ");
...
/*            prpLpaymainDto.setCompensateNo(dbManager.getString(resultSet, 50));
    ...
    public Collection findPayStatisticsByConditions(String conditions,int pageNo,int rowsPerPage)throws Exception{
        ...
        while(resultSet.next()){
            ...
            payStatisticsDto.setReceiverfullname(dbManager.getString(resultSet, 17));
            payStatisticsDto.setCertifno(dbManager.getString(resultSet, 18));
	...
	private void getPayStatisticsSql(StringBuffer buffer,String conditions) {
        ...
        buffer.append("'支付中心待处理','4','支付中心退回','5','已打包待审核','6','打包审核通过待发送','7','已发往银行 在途','8','银行打回','9','支付成功','m','默认成功','n','银行退回支付中心','10','同步资金成功','11','重复数据','12','同步资金失败','13','资金支付成功','14','资金支付退票','15','资金退回') payStatusName, ");
        buffer.append(" statis.paymentNo, ");
        buffer.append(" statis.receiverfullname, ");
        buffer.append(" statis.certifno ");
        buffer.append(" from (");
        ...
        if(sqlPaid.indexOf("Thirdpayflag")>-1){
			...
			buffer.append("				Yy.receiverfullname,");
			buffer.append("				Yy.certifno ");
			buffer.append("				From Prplpay Yy,");
			buffer.append("             	Prplcompensate Ee,");
			buffer.append("             	(select PAYMENTNO as Visaserialno,max(Paydate) as Paydate from  (Select Ee.Paymentno , (Select Decode(To_Char(Cc.Payrefdatetime, 'yyyy-MM-dd'), '1970-1-1', Cc.Payrefdate,");
...
//			buffer.append("               		Order By Ll.Visaserialno Desc) Zz");
			buffer.append("             	From prpjpayplatformrefrec Ee ) group by Paymentno) Zz");
			...
			buffer.append("   And Not Exists (Select 1 from prpjpayplatformrefrec Rec Where Rec.Certino = Yy.Compensateno And Rec.Paymentno = Yy.Serialno And Rec.Payrefreason = Yy.Paymenttype)");
			buffer.append("   And Yy.Paymenttype In ('P50', 'P60')                                                  ");
			buffer.append(" 		And Ee.UnderWriteFlag IN ('1','3')");
			buffer.append(sqlPaid);
        }
