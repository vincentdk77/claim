 ...
 */
public class DBPrpLRegistTg extends DBPrpLRegistTgBase{
    private static Log log = LogFactory.getLog(DBPrpLRegistTg.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLRegistTg(DBManager dbManager){
        super(dbManager);
    }
    ...
    public Collection findByQueryConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
    	...
    	String statement = "";
    	conditions = conditions.replaceAll("prplregisttg","a");
       ...
       "b.OperateDate, "+
        "b.RiskCode, "+
        "a.LicenseNo, " +
        "a.InsuredName,a.canceldate From  PrpLClaimStatustg b Right JOIN prpLregisttg a  ON a.RegistNo = b.BusinessNo , prplregistrpolicytg c " +
        ...
        while(resultSet.next()){
            ...
            prpLregistDto = new PrpLRegistTgDto();
        ...
        {
        	prpLregistDto=(PrpLRegistTgDto)it.next();
			...
			//add by zhouliu end at 2006-6-9
        log.info("DBPrpLregistTg.findByConditions() success!");
        return collection;
    }
      ...
      String statement = "Select Prplregist.damageStartDate,"+
        ...
        */                  
        String statement =" Select Prplregist.registNo," +
        				...
        				"t.personinjured1, "+
        				"Prplregist.riskcode" +
                        " From Prplregisttg Prplregist ,prplexttg t where t.certino(+)=Prplregist.registno and "+conditions;
    ...
    public Collection getWorkFlowList(String conditions,int pageNo,int rowsPerPage) throws Exception{
       String statement = "Select DISTINCT a.RegistNo," +
                           ...
                           "a.ReportDate, "+
                           "a.LicenseNo, "+
                           "b.FlowID,b.HandlerName From prpLregisttg a Right JOIN (Select * from swflog where nodetype='regis') b ON a.RegistNo = b.BusinessNo where"+conditions ;
        log.debug(statement);
        Collection collection = new ArrayList();
        PrpLRegistTgDto prpLregistDto = null;
        ResultSet resultSet = dbManager.executeQuery(statement);
    ...
    {
    	int count = -1;
        String statement = "Select count(DISTINCT a.RegistNo) from PrpLClaimStatustg b Right JOIN prpLregisttg a  ON a.RegistNo = b.BusinessNo , prplregistrpolicytg c " +
        "where  (c.registno=a.registno) and b.nodetype='regis' and "+conditions;
        ...
        resultSet.close();
        log.info("DBPrpLregisttg.getCount1() success!");
        return count;
        ...
        throws Exception
	{
    	...
    	String statement = " Update PrpLregisttg Set " + condition;
    	log.debug(statement);
		dbManager.prepareStatement(statement);
		dbManager.executePreparedUpdate();
		log.info("DBPrpLregisttg.updateByCondition() success!");
    }
    ...
    public Collection findByQueryConditionsForPolicyno(String conditions,int pageNo,int rowsPerPage) throws Exception{
    	  String statement = "SELECT  "
              ...
              + " from prplregisttg PrpLregist, prplclaimtg prplclaim, prplcompensatetg prplcompensate "
        ...
        resultSet.close();
        log.info("prpLregisttgDto.findByConditions() success!");
        return collection;
    }
    /**
     * 按条件查询多条数据
    ...
    public Collection findByConditionsNew1(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("  Left Join PrpLscheduleMainWFtg b ");
        buffer.append(" Left Join PrpLscheduleMainWFtg b ");
        buffer.append(" on a.registno = b.registno ");
        buffer.append(" Left Join prplregisttg c ");
  ...
  " from swflogstore a "+
  " Left Join PrpLscheduleMainWFtg b "+
  " on a.registno = b.registno "+
  " Left Join prplregisttg c "+
