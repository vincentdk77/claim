 ...
 */
public class DBPrpCinsuredTg extends DBPrpCinsuredTgBase{
    private static Log log = LogFactory.getLog(DBPrpCinsuredTg.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCinsuredTg(DBManager dbManager){
        super(dbManager);
    }
...
//modify by liuyanmei add 20051108 start
    public String  getIdentifyNumber(String conditions) throws Exception{
    	 ...
    	 String statement = "Select DISTINCT identifyNumber From PrpCinsuredtg where  " +conditions ;
         log.debug(statement);
