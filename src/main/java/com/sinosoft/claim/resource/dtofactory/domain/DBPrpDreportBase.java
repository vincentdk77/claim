...
public class DBPrpDreportBase{
    ...
    public void insert(PrpDreportDto prpDreportDto) throws Exception{
        ...
        dbManager.setInt(4,prpDreportDto.getRow());
        dbManager.setInt(5,prpDreportDto.getCol());
    ...
    public void update(PrpDreportDto prpDreportDto) throws Exception{
        ...
        dbManager.setInt(2,prpDreportDto.getRow());
        dbManager.setInt(3,prpDreportDto.getCol());
    ...
    public PrpDreportDto findByPrimaryKey(String reportCode,int serialNo) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDreportDto.setRow(dbManager.getInt(resultSet,4));
            prpDreportDto.setCol(dbManager.getInt(resultSet,5));
