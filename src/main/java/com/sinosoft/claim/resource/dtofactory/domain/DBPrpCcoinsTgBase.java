 ...
 */
public class DBPrpCcoinsTgBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Log logger = LogFactory.getLog(DBPrpCcoinsTgBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCcoinsTgBase(DBManager dbManager){
    ...
    public void insert(PrpCcoinsDto prpCcoinsDto)
        ...
        buffer.append("INSERT INTO PrpCcoinsTg (");
    ...
    public void delete(String policyNo,int serialNo)
        ...
        buffer.append("DELETE FROM PrpCcoinsTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpCcoinsDto prpCcoinsDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpCcoinsTg SET ");
        buffer.append("MainPolicyNo = ?, ");
        buffer.append("CoinsCode = ?, ");
        buffer.append("CoinsName = ?, ");
        buffer.append("CoinsType = ?, ");
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpCcoinsTg SET ");
    ...
    public PrpCcoinsDto findByPrimaryKey(String policyNo,int serialNo)
        ...
        buffer.append("ChiefFlag,");
        buffer.append("ProportionFlag ");
        buffer.append("FROM PrpCcoinsTg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("ChiefFlag,");
        buffer.append("ProportionFlag ");
        buffer.append("FROM PrpCcoinsTg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpCcoinsTg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM PrpCcoinsTg WHERE ");
