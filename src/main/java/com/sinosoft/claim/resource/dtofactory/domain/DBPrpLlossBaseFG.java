 ...
 */
public class DBPrpLlossBaseFG{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Log logger = LogFactory.getLog(DBPrpLlossBaseFG.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLlossBaseFG(DBManager dbManager){
    ...
    public void update(PrpLlossDto prpLlossDto)
        ...
        //设置条件字段;
        dbManager.setString(45,prpLlossDto.getCompensateNo());
        dbManager.setInt(46,prpLlossDto.getSerialNo());
        dbManager.executePreparedUpdate();
    ...
    public PrpLlossDto findByPrimaryKey(String compensateNo,int serialNo)
        ...
        if(resultSet.next()){
            ...
            prpLlossDto.setKindCode(CodeTransfer.FGKindKodeOut.covrentPlatFormCode(dbManager.getString(resultSet,8)));
