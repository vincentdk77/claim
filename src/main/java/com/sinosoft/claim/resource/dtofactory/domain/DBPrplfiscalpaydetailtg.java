 ...
 */
public class DBPrplfiscalpaydetailtg extends DBPrplfiscalpaydetailtgBase{
    private static Logger logger = Logger.getLogger(DBPrplfiscalpaydetailtg.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrplfiscalpaydetailtg(DBManager dbManager){
        super(dbManager);
    }
