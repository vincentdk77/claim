 ...
 */
public class DBPrpLpayNoticeListBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpLpayNoticeListBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpayNoticeListBase(DBManager dbManager){
    ...
    public void insert(PrpLpayNoticeListDto prpLpayNoticeListDto)
        ...
        buffer.append("INSERT INTO PrpLpayNoticeList (");
    ...
    public void delete(String noticeNo,String paymentNo)
        ...
        buffer.append("DELETE FROM PrpLpayNoticeList ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpLpayNoticeListDto prpLpayNoticeListDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE PrpLpayNoticeList SET ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpLpayNoticeList SET ");
            debugBuffer.append("WHERE ");
    ...
    public PrpLpayNoticeListDto findByPrimaryKey(String noticeNo,String paymentNo)
        ...
        buffer.append("NoticeNo,");
        buffer.append("PaymentNo ");
        buffer.append("FROM PrpLpayNoticeList ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("NoticeNo,");
        buffer.append("PaymentNo ");
        buffer.append("FROM PrpLpayNoticeList WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpLpayNoticeList WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM (SELECT * FROM PrpLpayNoticeList WHERE ");
        buffer.append(conditions);
        buffer.append(")");
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
