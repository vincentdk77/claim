 ...
 */
public class DBPrpCaddressTgBase{
    private DBManager dbManager = null; //资源管理类
    private static Log log = LogFactory.getLog(DBPrpCaddressTgBase.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCaddressTgBase(DBManager dbManager){
    ...
    public void insert(PrpCaddressDto prpCaddressDto) throws Exception{
        String statement = " Insert Into PrpCaddressTg(" + 
                           " PolicyNo," + 
                           " RiskCode," + 
                           " AddressNo," + 
                           " AddressCode," + 
    ...
    public void delete(String policyNo,int addressNo) throws Exception{
        String statement = " Delete From PrpCaddressTg Where " +
                           " PolicyNo = ? And " + 
                           " AddressNo = ?";
        log.debug(statement);
        dbManager.prepareStatement(statement);
    ...
    public void update(PrpCaddressDto prpCaddressDto) throws Exception{
        String statement = " Update PrpCaddressTg Set RiskCode = ?," + 
                           " AddressCode = ?," + 
                           " AddressName = ?," + 
                           " Flag = ? Where " +
                           " PolicyNo = ? And " + 
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " AddressCode," + 
                           " AddressName," + 
                           " Flag From PrpCaddressTg Where " + conditions;
        log.debug(statement);
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCaddressTg Where " + conditions;
        log.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCaddressTg Where " + conditions;
