 ...
 */
public class DBPrpLpayHistg extends DBPrpLpayHistgBase{
    private static Logger logger = Logger.getLogger(DBPrpLpayHistg.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpayHistg(DBManager dbManager){
        super(dbManager);
    }
