 ...
 *
 */
public class DBPrpLpayShowtg {
	 /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpLpayShowtg.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpayShowtg(DBManager dbManager){
    ...
    public ArrayList<PrpLpayShowDto> getShowList(String payType,String paymentType,String comCode,String paymentNo,boolean judgeFlag,
        ...
        buffer.append(" and prplpay.paymenttype = 'P98' ");
        ...
        buffer.append(" 'P98' as payrefreason,  ");
        buffer.append(" pay.vFlag   ");
        buffer.append(" from prplcompensatetg t, prplclaimtg c, prplregisttg r ");
        buffer.append(" ,(select distinct payamount, compensateno, '1' as exist,vFlag ");
        buffer.append(" from prplpaytg prplpay ");
        buffer.append(" where serialno = '"+paymentNo+"'");
        buffer.append(" and paymenttype='P98' ) pay ");
        ...
        if(paymentType!=null&&!"".equals(paymentType)&&!"P6".equals(paymentType)&&!"P98".equals(paymentType)){
        ...
        buffer.append("   t.underwriteenddate, ");
        buffer.append("  '代付共保赔款' as payType, ");
        buffer.append(" r.comcode, ");
        buffer.append(" '' as comcname, ");
    	buffer.append(" (select sum(payamount) ");
        buffer.append(" from prplpaytg prplpay ");
        ...
        buffer.append(" and prplpay.policyno = t.policyno ");
        buffer.append(" and prplpay.paymenttype = 'GS60' ");
        if(payType != null &&!"".equals(payType)&&!"P3".equals(payType)&&!"P5".equals(payType)){
        	buffer.append(" and prplpay.paytype = 'P3' ");
        }
        if(paymentNo!=null&&!"".equals(paymentNo)){
        ...
        buffer.append(" pay.exist ,   ");//--是否勾选
        buffer.append(" 'C' as certitype,  ");
        buffer.append(" 'GS60' as payrefreason,  ");
        buffer.append(" pay.vFlag   ");
        buffer.append(" from prplcompensatetg t, prplclaimtg c, prplregisttg r ,prplcfeecoinstg co");
        buffer.append(" ,(select distinct payamount, compensateno, '1' as exist,vFlag ,coinscode");
        buffer.append(" from prplpaytg prplpay ");
        buffer.append(" where serialno = '"+paymentNo+"'");
        buffer.append(" and paymenttype='GS60' ) pay ");
		...
		buffer.append(" from prplclaimtg c, prplregisttg r ,  prplcompensatetg t ");
		buffer.append(" join ");
		buffer.append(" (select compensateno, chargecode, sum(nvl(chargeamount,0)-nvl(prechargeamount,0)) as chargeamount ");
		buffer.append(" from prplchargetg prplcharge where  chargecode<>'14' group by compensateno, chargecode) ch ");
        ...
        buffer.append(" from prplpaytg prplpay ");
        buffer.append(" where serialno = '"+paymentNo+"' " );
        buffer.append(" and paymentType not in ('P98','P50') and paymentType  like 'P%'"); 
        ...
        */
        ...
        buffer.append(" pay.vFlag  ");
		buffer.append(" from prplprepaytg pre, prplclaimtg c, prplregisttg r ");
		buffer.append(" ,(select distinct payamount, compensateno, '1' as exist,vFlag ");
        buffer.append(" from prplpaytg prplpay ");
        buffer.append(" where serialno = '"+paymentNo+"' " );
		...
		buffer.append(" from  prplclaimtg c, prplregisttg r,prplprepaytg pre ");
		buffer.append(" join ");
		buffer.append("(select claimno,precompensateno,chargecode, ");
		buffer.append(" sum(sumprepaid) as sumprepaid ");
		buffer.append(" from prplprechargetg prplprecharge ");
        ...
        buffer.append(" from prplpaytg prplpay ");
        buffer.append(" where serialno = '"+paymentNo+"' " );
        buffer.append(" and paymenttype  not in ('P50','P98') and paymenttype like 'Y%' ) pay ");
...
//			buffer.append("  from prpjplanfee rf  ");
			 ...
			 buffer.append("  Where Certitype = 'C' And Payrefreason = 'GS60'                   ");
			 buffer.append("  union all                                                         ");
			 ...
			 buffer.append("  vatax            ,                                                ");
			 buffer.append("  ntplanfee        ,                                                ");
			 buffer.append("  dutyratio     from prpjplanfeetg prpjplanfee                      ");
...
//				buffer.append("  from prpjpayrefrec ff  ");
		        ...
		        buffer.append( "  Personalfee,Constructionfee,Educationfee,Paycommissionflag,Payrefstate,              ");
		        buffer.append( "  Recoveryserialno,Handlepayrefdate,Update_By,Update_Date,Vatax,                       ");
		        buffer.append( "  Ntplanfee,Dutyratio,Localeducationfee From prpjpayrefrectg Prpjpayrefrec             ");
...
//    	}
    	...
    	PrpLpayShowDto prpLpayShowtgDto =null;
    	while(resultSet.next()){
    		prpLpayShowtgDto = new PrpLpayShowDto();
    		prpLpayShowtgDto.setRegistNo(dbManager.getString(resultSet,"RegistNo"));
    		prpLpayShowtgDto.setPolicyNo(dbManager.getString(resultSet,"PolicyNo"));
    		prpLpayShowtgDto.setPolicyType(dbManager.getString(resultSet,"PolicyType"));
    		prpLpayShowtgDto.setCertiNo(dbManager.getString(resultSet,"CertiNo"));
    		prpLpayShowtgDto.setClaimNo(dbManager.getString(resultSet,"ClaimNo"));
    		prpLpayShowtgDto.setCoinsCode(dbManager.getString(resultSet,"coinscode"));
    		prpLpayShowtgDto.setInsuredName(dbManager.getString(resultSet,"InsuredName"));
    		prpLpayShowtgDto.setLicenseNo(dbManager.getString(resultSet,"LicenseNo"));
    		prpLpayShowtgDto.setSumPaid(dbManager.getDouble(resultSet,"sumthispaid"));
    		prpLpayShowtgDto.setUnderWriteEndDate(dbManager.getDateTime(resultSet,DateTime.YEAR_TO_SECOND,"UnderWriteEndDate").toString(DateTime.YEAR_TO_SECOND));
    		prpLpayShowtgDto.setPayType(dbManager.getString(resultSet,"PayType"));
    		prpLpayShowtgDto.setComCode(dbManager.getString(resultSet,"ComCode"));
    		prpLpayShowtgDto.setComCodeName(dbManager.getString(resultSet,"ComCName"));
    		prpLpayShowtgDto.setHavPaid(dbManager.getDouble(resultSet,"HavPay"));
    		prpLpayShowtgDto.setNowPaid(dbManager.getDouble(resultSet,"NowPay"));
    		prpLpayShowtgDto.setExist(dbManager.getString(resultSet,"Exist"));
    		prpLpayShowtgDto.setVflag(dbManager.getString(resultSet, "vFlag"));
    		prpLpayShowtgDto.setPayrefreason(dbManager.getString(resultSet, "payrefreason"));
    		prpLpayShowtgDto.setClassCode(dbManager.getString(resultSet,"RegistNo"));
    		list.add(prpLpayShowtgDto);
    	}
    	resultSet.close();
    	return list;
    }
    ...
    public ArrayList<PrpLpayShowDto> getNewQueryShowList(String payType,String paymentType,String conditions,int pageNo,int rowsPerPage)throws Exception{
        ...
        */
        ...
        if(paymentType!=null&&!"".equals(paymentType)&&!"P6".equals(paymentType)&&!"P98".equals(paymentType)){//为空表示赔款费用都查询出来
        	buffer.append(" and  1<> 1 ");//支付类型只有赔付，当勾选不是赔付时，直接拼接 and 1 <> 1
        }
        buffer.append(" and t.underwriteflag in ('0', '2', '1', '3', '9') ");
...
//		buffer.append("  from prpjplanfee rf  ");
    	...
    	while(resultSet.next()){
    		...
    		prpLpayShowtgDto.setLicenseNo(dbManager.getString(resultSet,"LicenseNo"));
    		prpLpayShowtgDto.setSumPaid(dbManager.getDouble(resultSet,"sumthispaid"));
    		prpLpayShowtgDto.setUnderWriteEndDate(dbManager.getString(resultSet,"UnderWriteEndDate"));
    		prpLpayShowtgDto.setPayType(dbManager.getString(resultSet,"PayType"));
    		prpLpayShowtgDto.setComCode(dbManager.getString(resultSet,"ComCode"));
    		prpLpayShowtgDto.setComCodeName(dbManager.getString(resultSet,"ComCName"));
    		prpLpayShowtgDto.setHavPaid(dbManager.getDouble(resultSet,"HavPay"));
    		prpLpayShowtgDto.setFlowId(dbManager.getString(resultSet, "flowid"));
    		prpLpayShowtgDto.setPayrefreason(dbManager.getString(resultSet, "payrefreason"));
    		//prpLpayShowtgDto.setNowPaid(dbManager.getDouble(resultSet,"NowPay"));
    		//prpLpayShowtgDto.setExist(dbManager.getString(resultSet,"Exist"));
    		list.add(prpLpayShowtgDto);
	...
	buffer.append(" and 3=3 ");   
        ...
        buffer.append("  changechargecodetopaymenttype(Ch.Chargecode) as payrefreason,  ");
   		...
   		buffer.append(" from (select compensateno, chargecode, sum(nvl(chargeamount,0)-nvl(prechargeamount,0)) as chargeamount ");
...
//   		buffer.append("          from prpjpayrefrec rec ");
        ...
        buffer.append( "   Where Certitype In ('C', 'Y', 'Z'))           rec                                   ");
       	...
       	while(resultSet.next()){
       		...
       		prpLpayShowtgDto.setFlowId(dbManager.getString(resultSet, "flowid"));
       		prpLpayShowtgDto.setPayrefreason(dbManager.getString(resultSet, "payrefreason"));
       		prpLpayShowtgDto.setRiskCode(dbManager.getString(resultSet,"CertiNo"));
       		prpLpayShowtgDto.setClassCode(dbManager.getString(resultSet,"CertiNo"));
       		prpLpayShowtgDto.setClaimRelationNo(dbManager.getString(resultSet,"claimrelationno"));
       		//prpLpayShowtgDto.setNowPaid(dbManager.getDouble(resultSet,"NowPay"));
       		//prpLpayShowtgDto.setExist(dbManager.getString(resultSet,"Exist"));
       		list.add(prpLpayShowtgDto);
       	}
            ...
            buffer.append( "   Where Certitype In ('C', 'Y', 'Z'))           rec                                   ");
     		...
     		buffer.append("         Where Nn.Relationregistno = C.Registno) ");
          	...
          	while(resultSet.next()){
          		...
          		prpLpayShowtgDto.setRegistNo(dbManager.getString(resultSet,"registno"));
          		prpLpayShowtgDto.setPolicyNo(dbManager.getString(resultSet,"policyno"));
          		prpLpayShowtgDto.setDamageDate(dbManager.getDateTime(resultSet,"damageenddate").toString());
          		prpLpayShowtgDto.setStartDate(dbManager.getDateTime(resultSet,"startdate").toString());
          		prpLpayShowtgDto.setEndDate(dbManager.getDateTime(resultSet, "enddate").toString());
          		prpLpayShowtgDto.setInsuredName(dbManager.getString(resultSet,"insuredname"));
          		prpLpayShowtgDto.setComCode(dbManager.getString(resultSet,"comcode"));
          		prpLpayShowtgDto.setComCodeName(dbManager.getString(resultSet,"comcname"));
          		list.add(prpLpayShowtgDto);
...
//    		buffer.append("  and rf.planfee > 0)  ");
	...
	public ArrayList<PrpLpayShowDto> getShowBillList(String payType,
    	...
    	while(resultSet.next()){
    		...
    		prpLpayShowtgDto.setClassCode(dbManager.getString(resultSet,"RegistNo"));
    		prpLpayShowtgDto.setClaimRelationNo(dbManager.getString(resultSet, "claimrelationno"));
    		prpLpayShowtgDto.setFkSerialNo(dbManager.getString(resultSet, "fkSerialNo"));
    		prpLpayShowtgDto.setBillPaid(dbManager.getDouble(resultSet, "billPaid"));
    		prpLpayShowtgDto.setBillHavPay(dbManager.getDouble(resultSet, "billHavPay"));
    		list.add(prpLpayShowtgDto);
    	}
    	resultSet.close();
    	return list;
...
//  		buffer.append(" where grp.policyno = r.policyno) as policyType, ");
		...
		buffer.append("  prplprepay pre, prplclaim c, prplregist r ");
  		...
  		if(back!=null && "1".equals(back)){
   			...
   			buffer.append("                  when prplpay.paymenttype = 'P98' then                                    ");
...
//  		buffer.append(" where grp.policyno = r.policyno) as policyType, ");
  		...
  		buffer.append("  end as payrefreason  ");*/
          buffer.append("  changechargecodetopaymenttype(ch.chargecode) as payrefreason  ");
  		buffer.append(" from (select ph.compensateno, ph.chargecode,sum(nvl(ph.chargeamount,0)-nvl(ph.prechargeamount,0)) as chargeamount ");
          ...
          //新增代付共保赔款
            ...
            buffer.append(" select r.registno, ");
              ...
              */
              ...
              buffer.append(" 'GS60' as payrefreason,  ");
              buffer.append(" '0' as flowid ");
              buffer.append(" from prplcompensatetg t, prplclaimtg c, prplregisttg r ,prplcfeecoins co");
              /**
              buffer.append(" ,pay.payamount as nowPay,  ");//--本次支付金额
              buffer.append(" pay.exist    ");//--是否勾选
