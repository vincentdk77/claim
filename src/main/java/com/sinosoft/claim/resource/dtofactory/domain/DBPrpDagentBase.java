...
public class DBPrpDagentBase{
    ...
    public void update(PrpDagentDto prpDagentDto) throws Exception{
        ...
        dbManager.setString(11,prpDagentDto.getUpperAgentCode());
        dbManager.setString(12,prpDagentDto.getNewAgentCode());
        dbManager.setString(13,prpDagentDto.getValidStatus());
        dbManager.setString(14,prpDagentDto.getArticleCode());
        dbManager.setString(15,prpDagentDto.getFlag());
        //设置条件字段;
        dbManager.setString(16,prpDagentDto.getAgentCode());
        dbManager.executePreparedUpdate();
    ...
    public PrpDagentDto findByPrimaryKey(String agentCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDagentDto.setUpperAgentCode(dbManager.getString(resultSet,12));
            prpDagentDto.setNewAgentCode(dbManager.getString(resultSet,13));
            prpDagentDto.setValidStatus(dbManager.getString(resultSet,14));
            prpDagentDto.setArticleCode(dbManager.getString(resultSet,15));
            prpDagentDto.setFlag(dbManager.getString(resultSet,16));
        }
        resultSet.close();
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpDagent Where " + conditions;
