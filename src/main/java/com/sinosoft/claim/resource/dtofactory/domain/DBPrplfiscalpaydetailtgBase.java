...
public class DBPrplfiscalpaydetailtgBase {
    /**
     * 资源管理类的实例，处理数据库操作.
     */
     ...
     */
    public DBPrplfiscalpaydetailtgBase(DBManager dbManager){
    ...
    public void insert(PrplfiscalpaydetailDto prplfiscalpaydetailDto)
        ...
        buffer.append("INSERT INTO Prplfiscalpaydetailtg (");
    ...
    public void delete(String fiscalno,String serialno)
        ...
        buffer.append("DELETE FROM Prplfiscalpaydetailtg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrplfiscalpaydetailDto prplfiscalpaydetailDto)
            throws Exception{
        StringBuffer buffer = new StringBuffer(200);
        buffer.append("UPDATE Prplfiscalpaydetailtg SET ");
        buffer.append("Registno = ?, ");
        buffer.append("Classcode = ?, ");
        buffer.append("Riskcode = ?, ");
        buffer.append("Policyno = ?, ");
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE Prplfiscalpaydetailtg SET ");
    ...
    public PrplfiscalpaydetailDto findByPrimaryKey(String fiscalno,String serialno)
        ...
        buffer.append("Routenum, ");
        buffer.append("Comcode ");
        buffer.append("FROM Prplfiscalpaydetailtg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("Routenum, ");
        buffer.append("Comcode ");
        buffer.append("FROM Prplfiscalpaydetailtg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM Prplfiscalpaydetailtg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM Prplfiscalpaydetailtg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
