...
public class DBPrpDclassBase{
    ...
    public void insert(PrpDclassDto prpDclassDto) throws Exception{
        ...
        dbManager.setString(3,prpDclassDto.getNewClassCode());
        dbManager.setString(4,prpDclassDto.getValidStatus());
        dbManager.setString(5,prpDclassDto.getFlag());
    ...
    public void update(PrpDclassDto prpDclassDto) throws Exception{
        ...
        dbManager.setString(2,prpDclassDto.getNewClassCode());
        dbManager.setString(3,prpDclassDto.getValidStatus());
        dbManager.setString(4,prpDclassDto.getFlag());
        //设置条件字段;
        dbManager.setString(5,prpDclassDto.getClassCode());
        dbManager.executePreparedUpdate();
    ...
    public PrpDclassDto findByPrimaryKey(String classCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDclassDto.setNewClassCode(dbManager.getString(resultSet,3));
            prpDclassDto.setValidStatus(dbManager.getString(resultSet,4));
            prpDclassDto.setFlag(dbManager.getString(resultSet,5));
        }
        resultSet.close();
