 ...
 */
public class DBPrpCmainSubTgBase{
    private DBManager dbManager = null; //资源管理类
    private static Log log = LogFactory.getLog(DBPrpCmainSubTgBase.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCmainSubTgBase(DBManager dbManager){
    ...
    public void insert(PrpCmainSubDto prpCmainSubDto) throws Exception{
        String statement = " Insert Into PrpCmainSubTg(" + 
                           " PolicyNo," + 
                           " MainPolicyNo," + 
                           " EndorseNo," + 
                           " Flag) values(?,?,?,?)";
    ...
    public void delete(String policyNo,String mainPolicyNo) throws Exception{
        String statement = " Delete From PrpCmainSubTg Where " +
                           " PolicyNo = ? And " + 
                           " MainPolicyNo = ?";
        log.debug(statement);
        dbManager.prepareStatement(statement);
    ...
    public void update(PrpCmainSubDto prpCmainSubDto) throws Exception{
        String statement = " Update PrpCmainSubTg Set EndorseNo = ?," + 
                           " Flag = ? Where " +
                           " PolicyNo = ? And " + 
                           " MainPolicyNo = ?";
        log.debug(statement);
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " Flag," +
                           " startDate," +
                           " endDate From PrpCmainSubTg Where " + conditions;
        log.debug(statement);
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCmainSubTg Where " + conditions;
        log.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCmainSubTg Where " + conditions;
