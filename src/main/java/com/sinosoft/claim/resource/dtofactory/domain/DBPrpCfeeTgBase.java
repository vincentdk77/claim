 ...
 */
public class DBPrpCfeeTgBase{
    private DBManager dbManager = null; //资源管理类
    private static Log log = LogFactory.getLog(DBPrpCfeeTgBase.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCfeeTgBase(DBManager dbManager){
    ...
    public void insert(PrpCfeeDto prpCfeeDto) throws Exception{
        String statement = " Insert Into PrpCfeeTg(" + 
                           " PolicyNo," + 
                           " RiskCode," + 
                           " Currency," + 
                           " Amount," + 
    ...
    public void delete(String policyNo,String currency) throws Exception{
        String statement = " Delete From PrpCfeeTg Where " +
                           " PolicyNo = ? And " + 
                           " Currency = ?";
        log.debug(statement);
        dbManager.prepareStatement(statement);
    ...
    public void update(PrpCfeeDto prpCfeeDto) throws Exception{
        String statement = " Update PrpCfeeTg Set RiskCode = ?," + 
                           " Amount = ?," + 
                           " Premium = ?," + 
                           " Flag = ? Where " +
                           " PolicyNo = ? And " + 
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " Amount," + 
                           " Premium," + 
                           " Flag From PrpCfeeTg Where " + conditions;
        log.debug(statement);
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCfeeTg Where " + conditions;
        log.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCfeeTg Where " + conditions;
