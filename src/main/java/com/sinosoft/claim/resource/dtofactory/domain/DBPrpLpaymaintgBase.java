 ...
 */
public class DBPrpLpaymaintgBase{
    /**
     * 资源管理类的实例，处理数据库操作.
     */
    protected DBManager dbManager = null;
    private static Logger logger = Logger.getLogger(DBPrpLpaymaintgBase.class);

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpLpaymaintgBase(DBManager dbManager){
    ...
    public void insert(PrpLpaymainDto prpLpaymainDto)
        ...
        buffer.append("INSERT INTO PrpLpaymaintg (");
    ...
    public void delete(String paymentNo)
        ...
        buffer.append("DELETE FROM PrpLpaymaintg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
    ...
    public void update(PrpLpaymainDto prpLpaymainDto)
        ...
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append("UPDATE PrpLpaymaintg SET ");
        ...
        dbManager.setString(52,prpLpaymainDto.getThirdPayType());
        //设置条件字段;
        dbManager.setString(53,prpLpaymainDto.getPaymentNo());
        dbManager.executePreparedUpdate();
    ...
    public PrpLpaymainDto findByPrimaryKey(String paymentNo)
        ...
        buffer.append("nobillFlag, ");
        buffer.append("thirdPayType ");
        buffer.append("FROM PrpLpaymaintg ");
        if(logger.isDebugEnabled()){
            StringBuffer debugBuffer =  new StringBuffer(buffer.length()*4);
            debugBuffer.append(buffer.toString());
            debugBuffer.append("WHERE ");
        ...
        if(resultSet.next()){
            ...
            prpLpaymainDto.setThirdPayType(dbManager.getString(resultSet, 53));
        }
        resultSet.close();
        return prpLpaymainDto;
    }
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage)
        ...
        buffer.append("nobillFlag, ");
        buffer.append("thirdPayType ");
        buffer.append("FROM PrpLpaymaintg WHERE ");
    ...
    public int deleteByConditions(String conditions)
            throws Exception{
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("DELETE FROM PrpLpaymaintg WHERE ");
        buffer.append(conditions);
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
        }
    ...
    public int getCount(String conditions) 
        ...
        int count = -1;
        StringBuffer buffer = new StringBuffer(100);
        buffer.append("SELECT count(1) FROM (SELECT * FROM PrpLpaymaintg WHERE ");
        buffer.append(conditions);
        buffer.append(")");
        if(logger.isDebugEnabled()){
            logger.debug(buffer.toString());
