...
/**
 * 这是prpdrationlimit定额保单限额免赔对照表的数据访问对象类<br>
...
public class DBPrpDrationLimitBase{
    ...
    public void insert(PrpDrationLimitDto prpDrationLimitDto) throws Exception{
        ...
        dbManager.setString(5,prpDrationLimitDto.getItemCode());
        dbManager.setString(6,prpDrationLimitDto.getKindCode());
     ...
     * @throws Exception
     */
    public void delete(String riskCode,String limitCode,String rationType,String itemCode,String kindCode) throws Exception{
        ...
        dbManager.setString(5,kindCode);
        dbManager.executePreparedUpdate();
    ...
    public void update(PrpDrationLimitDto prpDrationLimitDto) throws Exception{
        ...
        dbManager.setString(9,prpDrationLimitDto.getItemCode());
        dbManager.setString(10,prpDrationLimitDto.getKindCode());
        dbManager.executePreparedUpdate();
     ...
     * @throws Exception
     */
    public PrpDrationLimitDto findByPrimaryKey(String riskCode,String limitCode,String rationType,String itemCode,String kindCode) throws Exception{
        ...
        if(resultSet.next()){
            ...
            prpDrationLimitDto.setItemCode(dbManager.getString(resultSet,5));
            prpDrationLimitDto.setKindCode(dbManager.getString(resultSet,6));
