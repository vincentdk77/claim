 ...
 */
public class DBPrpCplanBase{
    private DBManager dbManager = null; //资源管理类
    private static Log log = LogFactory.getLog(DBPrpCplanBase.class.getName());

    /**
     * 构造函数
     * @param dbManager 资源管理类
     */
    public DBPrpCplanBase(DBManager dbManager){
    ...
    public void insert(PrpCplanDto prpCplanDto) throws Exception{
        String statement = " Insert Into PrpCplan(" + 
                           " PolicyNo," + 
                           " EndorseNo," + 
                           " SerialNo," + 
                           " PayNo," + 
    ...
    public void delete(String policyNo,int serialNo) throws Exception{
        String statement = " Delete From PrpCplan Where " +
                           " PolicyNo = ? And " + 
                           " SerialNo = ?";
        log.debug(statement);
        dbManager.prepareStatement(statement);
    ...
    public void update(PrpCplanDto prpCplanDto) throws Exception{
        String statement = " Update PrpCplan Set EndorseNo = ?," + 
                           " PayNo = ?," + 
                           " PayReason = ?," + 
                           " PlanDate = ?," + 
                           " Currency = ?," + 
    ...
    public Collection findByConditions(String conditions,int pageNo,int rowsPerPage) throws Exception{
        String statement = "Select PolicyNo," + 
                           ...
                           " PlanFee," + 
                           " DelinquentFee," + 
                           " Flag From PrpCplan Where " + conditions;
        log.debug(statement);
    ...
    public int deleteByConditions(String conditions) throws Exception{
        String statement = "Delete From PrpCplan Where " + conditions;
        log.debug(statement);
    ...
    public int getCount(String conditions) 
        throws Exception{
        int count = -1;
        String statement = "Select count(1) from PrpCplan Where " + conditions;
