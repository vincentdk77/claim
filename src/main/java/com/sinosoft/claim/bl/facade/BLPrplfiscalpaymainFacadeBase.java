 ...
 * 这是支付信息主表的业务逻辑对象Facade基类<br>
 * 创建于 JToolpad(1.5.1) Vendor:zhouxianli1978@msn.com
 */
public class BLPrplfiscalpaymainFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrplfiscalpaymainFacadeBase.class);

    /**
     * 构造函数
     */
    public BLPrplfiscalpaymainFacadeBase(){
    }
