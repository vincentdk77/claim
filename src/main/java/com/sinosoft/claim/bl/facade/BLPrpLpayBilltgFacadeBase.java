 ...
 * 这是prpLpayBill的业务逻辑对象tgFacade基类<br>
 * 创建于 JToolpad(1.5.1) Vendor:zhouxianli1978@msn.com
 */
public class BLPrpLpayBilltgFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayBilltgFacadeBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayBilltgFacadeBase(){
    }
