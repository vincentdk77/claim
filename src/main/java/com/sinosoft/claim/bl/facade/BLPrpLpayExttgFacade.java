...
/**
 * 这是支付处理意见表的业务对象tgFacade类<br>
 * 创建于 JToolpad(1.6.0) Vendor:zhouxianli1978@msn.com
 */
public class BLPrpLpayExttgFacade extends BLPrpLpayExttgFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayExttgFacade.class);

    /**
     * 构造函数
     */
    public BLPrpLpayExttgFacade(){
        super();
    }
    /**
     * 更新日志暂存状态为完成
