...
/**
 * 这是prpLpayHis的业务对象Facade类<br>
 * 创建于 JToolpad(1.5.1) Vendor:zhouxianli1978@msn.com
 */
public class BLPrpLpayHisFacade extends BLPrpLpayHisFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayHisFacade.class);

    /**
     * 构造函数
     */
    public BLPrpLpayHisFacade(){
        super();
    }
