...
import com.sinosoft.claim.bl.action.domain.BLPrpLpayNoticetgAction;

/**
 * ★★★★★警告：本文件不允许手工修改！！！请使用JToolpad生成！<br>
 * 这是通知单表的业务逻辑对象tgFacade基类<br>
 * 创建于 JToolpad(1.5.1) Vendor:zhouxianli1978@msn.com
 */
public class BLPrpLpayNoticetgFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticetgFacadeBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticetgFacadeBase(){
    }
    ...
    public void insert(PrpLpayNoticeDto prpLpayNoticeDto)
        ...
        BLPrpLpayNoticetgAction blPrpLpayNoticeAction = new BLPrpLpayNoticetgAction();
        try{
