 ...
 */
public class BLPrplfiscalpaydetailFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrplfiscalpaydetailFacadeBase.class);

    /**
     * 构造函数
     */
    public BLPrplfiscalpaydetailFacadeBase(){
    }
