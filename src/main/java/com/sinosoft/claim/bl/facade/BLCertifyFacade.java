...
public class BLCertifyFacade
{
  ...
  public void delete(String certifyNo) throws SQLException,Exception
  {
    ...
    try
    {
      new BLCertifyAction().delete(dbManager,certifyNo);
      //提交事务
      dbManager.commitTransaction();
    }
    catch(SQLException sqle)
  ...
  public CertifyDto findByPrimaryKey(String registNo) throws SQLException,Exception
  {
    ...
    try
    {
      certifyDto = new BLCertifyAction().findByPrimaryKey(dbManager,registNo);
    }
    catch(SQLException sqle)
    {
      throw sqle;
  ...
  public boolean isExist(String certifyNo) throws SQLException,Exception
  {
    ...
    try
    {
      exist = new BLCertifyAction().isExist(dbManager,certifyNo);
    }
    catch(SQLException sqle)
    {
      throw sqle;
