...
//modify by liuyanmei add 20051102 end 
        ...
        * @throws Exception
        */
       public void update(ArrayList swfLogDtoList) throws Exception{
           DBManager dbManager = new DBManager();
           BLSwfLogAction blSwfLogAction = new BLSwfLogAction();
           try{
               dbManager.open(AppConfig.get("sysconst.DBJNDI"));
               ...
               blSwfLogAction.update(dbManager,(SwfLogDto)swfLogDtoList.get(i));
               dbManager.commitTransaction();
           }catch(Exception exception){
               dbManager.rollbackTransaction();
               throw exception;
       ...
       public void updateNodeStatus(String nodeStatus,String str) throws Exception{
           DBManager dbManager = new DBManager();
           BLSwfLogAction blSwfLogAction = new BLSwfLogAction();
           try{
               dbManager.open(AppConfig.get("sysconst.DBJNDI"));
               dbManager.beginTransaction();
               //更新记录
               blSwfLogAction.updateNodeStatus(dbManager,nodeStatus,str);
               dbManager.commitTransaction();
           }catch(Exception exception){
               dbManager.rollbackTransaction();
               throw exception;
