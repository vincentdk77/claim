 ...
 * 这是通知单关联表的业务逻辑对象tgFacade基类<br>
 * 创建于 JToolpad(1.5.1) Vendor:zhouxianli1978@msn.com
 */
public class BLPrpLpayNoticeListtgFacadeBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticeListtgFacadeBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticeListtgFacadeBase(){
    }
