...
import com.sinosoft.claim.resource.dtofactory.custom.DBPolicytg;
 ...
 * @version 1.0
 */
public class BLPolicytgAction
{
	public BLPolicytgAction()
	{
	}
	...
	throws SQLException,Exception
	{
		...
		if(tgywRisk.contains(policyNo.substring(1, 5))){
			tgFlag = true;
		}
		if(tgFlag){
			policyDto = new DBPolicytg().findTGByPrimaryKey(dbManager,policyNo);
		}else{
