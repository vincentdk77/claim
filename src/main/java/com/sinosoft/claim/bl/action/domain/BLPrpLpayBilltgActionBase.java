 ...
 */
public class BLPrpLpayBilltgActionBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayBilltgActionBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayBilltgActionBase(){
    }
    ...
    public void insert(DBManager dbManager,PrpLpayBillDto prpLpayBillDto)
            throws Exception{
        DBPrpLpayBilltg dbPrpLpayBill = new DBPrpLpayBilltg(dbManager);
        //插入记录
