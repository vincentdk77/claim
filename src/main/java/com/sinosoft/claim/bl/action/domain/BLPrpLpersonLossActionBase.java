 ...
 */
public class BLPrpLpersonLossActionBase{
    private static Log logger = LogFactory.getLog(BLPrpLpersonLossActionBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpersonLossActionBase(){
    }
     ...
     * @throws Exception
     */
    public Collection findByRecase(DBManager dbManager,String conditions) throws Exception{
        DBPrpLpersonLoss dbPrpLpersonLoss = new DBPrpLpersonLoss(dbManager);
        Collection collection = new ArrayList();
        ...
        collection = dbPrpLpersonLoss.findByRecase(conditions);
        return collection;
    }
}
