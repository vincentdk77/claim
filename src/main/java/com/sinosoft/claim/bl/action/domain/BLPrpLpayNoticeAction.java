 ...
 */
public class BLPrpLpayNoticeAction extends BLPrpLpayNoticeActionBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticeAction.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticeAction(){
        super();
    }
