...
import com.sinosoft.claim.resource.dtofactory.domain.DBPrpLpayNoticeListtg;
 ...
 */
public class BLPrpLpayNoticeListtgActionBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticeListtgActionBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticeListtgActionBase(){
    }
    ...
    public void insert(DBManager dbManager,PrpLpayNoticeListDto prpLpayNoticeListDto)
            throws Exception{
        DBPrpLpayNoticeListtg dbPrpLpayNoticeList = new DBPrpLpayNoticeListtg(dbManager);
        //插入记录
