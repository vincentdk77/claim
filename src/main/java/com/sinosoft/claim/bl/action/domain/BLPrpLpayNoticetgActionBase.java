...
import com.sinosoft.claim.resource.dtofactory.domain.DBPrpLpayNoticetg;
 ...
 */
public class BLPrpLpayNoticetgActionBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticetgActionBase.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticetgActionBase(){
    }
    ...
    public void insert(DBManager dbManager,PrpLpayNoticeDto prpLpayNoticeDto)
            throws Exception{
        DBPrpLpayNoticetg dbPrpLpayNotice = new DBPrpLpayNoticetg(dbManager);
        //插入记录
