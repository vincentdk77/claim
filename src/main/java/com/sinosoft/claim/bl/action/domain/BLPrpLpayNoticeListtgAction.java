 ...
 */
public class BLPrpLpayNoticeListtgAction extends BLPrpLpayNoticeListtgActionBase{
    private static Logger logger = Logger.getLogger(BLPrpLpayNoticeListtgAction.class);

    /**
     * 构造函数
     */
    public BLPrpLpayNoticeListtgAction(){
        super();
    }
