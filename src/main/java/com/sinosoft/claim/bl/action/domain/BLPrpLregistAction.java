 ...
 */
public class BLPrpLregistAction extends BLPrpLregistActionBase{
    private static Log logger = LogFactory.getLog(BLPrpLregistAction.class);

    /**
     * 构造函数
     */
    public BLPrpLregistAction(){
        super();
    }
