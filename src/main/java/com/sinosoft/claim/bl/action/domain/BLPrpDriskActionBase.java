...
public class BLPrpDriskActionBase{
     ...
     * @throws Exception
     */
    public Collection findRiskCodeByConditions(DBManager dbManager,String conditions) throws Exception{
        DBPrpDrisk dbPrpDrisk = new DBPrpDrisk(dbManager);
        Collection collection = new ArrayList();
        ...
        collection = dbPrpDrisk.findRiskCodeByConditions(conditions);
        return collection;
    }
    /**
     * 按条件查询多条数据
    ...
    public Collection findByConditions(DBManager dbManager,String conditions) throws Exception{
        ...
        collection = dbPrpDrisk.findByConditions(conditions,0,0);
        return collection;
    }
