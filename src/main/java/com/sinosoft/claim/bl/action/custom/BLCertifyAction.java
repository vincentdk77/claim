 ...
 * @version 1.0
 */
public class BLCertifyAction
{
  public BLCertifyAction()
  {
  }
  ...
  {
      DBCertify dbCertify = null;
      //业务操作
      dbCertify = new DBCertify();
      //if (this.isExist(certifyDto.getPrpLcertifyDto().getPrpLcertifyCertifyNo()))
      //{
        //dbCertify.delete(certifyDto.getPrpLcertifyDto().getPrpLcertifyCertifyNo());
      //}
      dbCertify.insert(dbManager,certifyDto);
