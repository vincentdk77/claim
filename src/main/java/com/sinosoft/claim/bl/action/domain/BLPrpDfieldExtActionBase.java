...
import com.sinosoft.claim.resource.dtofactory.domain.DBPrpDfieldExt;
import com.sinosoft.sysframework.reference.DBManager;

/**
 * 这是prpdfieldext扩展字段的业务逻辑对象类<br>
...
public class BLPrpDfieldExtActionBase{
     ...
     * @return Collection 包含prpDfieldExtDto的集合
     * @throws Exception
     */
    public Collection findByConditions(DBManager dbManager,String conditions,int pageNo,int rowsPerPage) throws Exception{
        ...
        rowCount = dbPrpDfieldExt.getCount(conditions);
